...
You know, you work to be very fair in the book and that's something I really like about it. I mean, you don't just heap praise though on the **engineering state**. You make a point of calling out the downsides.
**And they're very real. Can we talk about some of those? What the problems are of the engineering state? What does it get wrong?** You sort of channel the **James Scott scene** like a state thing and a lot of the excesses of that thinking.
...
There had been some political suppression of bad news up until the state really tried to react and try to tamp it down.
A big way. And so that was the great first act when a lot of commentators from the **U.S.** and parts of the **West** were sometimes even gleefully saying that this might be **China's Chernobyl moment** in which a disaster triggers the political downfall of the entire regime. And so that was the first act.
...
Right. I mean, this possibility, this hypothetical that you float of an Apple producing in Cleveland, that seems to place a little too much of the onus on Apple. It's not as though that decision could have been undertaken in a vacuum. There were other factors that it had to consider rather than just simply the cost of labor. It was, as you say, you know, there was a policy...
**Environment.** You know, there are other reasons they chose not to do that. And surely you would agree that it's not just on **Apple**.
...
I wonder if there's something deeper in China's history, maybe the **imperial civil service examination system**, or this, you know, **oriental despotism** idea of **Karl Wittfogel** in his hydraulic theory of civilization. You know, he posits that...
The **technical demands of water management in China** created both the opportunity and the necessity for **centralized political control**. So you have engineers sort of running the state. These were the things that I was exploring and I was wondering what you think about this. What are the historical and maybe cultural roots of the **engineering state**?
...
So I mean, at all points, there is this sort of a paradigm of what is true. And there is some canonical set of texts. They could be the **Confucian classics** or they could be, you know, engineering texts. And if you have demonstrable knowledge of that, somehow that qualifies you for office. I mean, that seems to be sort of the common...
**Thread.** Yeah. So something that I, so, you know, the **U.S. obsession with process**, in its best form, protects the weak, which is really good. But, as we've discussed, it can impede the provision of public goods, the building of infrastructure that can really hurt the weak.
...
It's really good. She's always solid. And this is a particularly, I think,
Excellent view into the **Chinese mind** on this. I also want to plug a book I'm reading right now. It's called **Revolutionary Spring** by **Christopher Clarke**, who is one of my favorite historians. It's just an amazing work of history.
...
<script>window.tocIndex = {"index": [{"index_sentences": "This episode is brought to you by Progressive Commercial Insurance. As a business owner, you take on a lot of roles: Marketer, bookkeeper, CEO.", "section_level": 1, "section_title": "Sponsor: Progressive Commercial Insurance"}, {"index_sentences": "If you’ve used Babbel, you would. Babbel’s conversation-based techniques teach you useful words and phrases to get you speaking quickly about the things you actually talk about in the real world.", "section_level": 1, "section_title": "Sponsor: Babbel Language Learning"}, {"index_sentences": "Welcome to the Cineca Podcast, a weekly discussion of current affairs in China.", "section_level": 1, "section_title": "Introduction to The Cineca Podcast"}, {"index_sentences": "In this program, we'll look at: Books, Ideas, New research, Intellectual currents, Cultural trends that can help us better understand what's happening in China's: Politics, Foreign relations, Economics, Society.", "section_level": 2, "section_title": "Program Focus and Themes"}, {"index_sentences": "Cineca is supported this year by the Center for East Asian Studies at the University of Wisconsin-Madison, a national resource center for the study of East Asia.", "section_level": 2, "section_title": "Podcast Support and Subscriptions"}, {"index_sentences": "Dan Wong has been on the Cineca Podcast a couple of times before, and I am delighted to have him back today.", "section_level": 1, "section_title": "Introducing Guest Dan Wong"}, {"index_sentences": "He is one of the sharpest and most original observers of China's technology sector and manufacturing landscape, having won a certain level of fame for his annual letters and other essays — writings that somehow managed to combine on-the-ground insights with big picture perspectives.", "section_level": 2, "section_title": "Dan Wong's Expertise and New Book: Breakneck"}, {"index_sentences": "We have to start with what, for me, was clearly the most important part of your entire book, which is that magical and totally improbable guitar-making hub in Guizhou that you stumbled upon as you and Christian Shepard from the Washington Post and another friend rode your bikes through that mountainous province toward Chongqing.", "section_level": 1, "section_title": "The Guizhou Guitar-Making Hub"}, {"index_sentences": "How indeed did kind of a third or fourth tier city in Guizhou become one of the great hubs of guitar making?", "section_level": 2, "section_title": "The Serendipitous Rise of Zhengan County"}, {"index_sentences": "And something that the local government in Zhengan did was that it found that, well, there's a lot of people making guitars here.", "section_level": 2, "section_title": "Government Incentives and Rural Revitalization"}, {"index_sentences": "I mean, it's amazing how good quality the Chinese guitars have. I mean, it's astonishing. And all of the major brands are actually making a lot of their guitars in China now.", "section_level": 2, "section_title": "Quality and Global Migration of Guitar Manufacturing"}, {"index_sentences": "Awesome. Dan, I know you're going to end up on every major podcast talking about this book, so I want to avoid just asking you about the main themes or going through chapter by chapter.", "section_level": 1, "section_title": "Engineering State vs. Lawyerly Society: Core Concepts"}, {"index_sentences": "I mean, we can all rattle off the obvious differences between an engineering state and a lawyerly society.", "section_level": 2, "section_title": "Subtle Trade-offs and Legitimacy"}, {"index_sentences": "What I'll say is that the engineering state, I think I came onto this framework in part due to these excellent articles I found in 2001, I believe, that was written by an interesting analyst at the time called Kaiser Kuo, who pointed out that there were quite a lot of engineers that were being promoted into the Central Committee and the Politburo.", "section_level": 2, "section_title": "Origins of the Framework"}, {"index_sentences": "I mean, do you pull that lever to sacrifice one life in order to save five? I've often wondered how this dilemma looks different through the lens, you know, like the one that you've drawn, whether it looks different between an engineering state and a lawyerly society.", "section_level": 2, "section_title": "The Trolley Problem and Philosophical Orientation"}, {"index_sentences": "I think the level that I was thinking a little bit more about was that I think part of the reason I wanted to come up with this framework of engineers and lawyers is that I think we've been reasoning about the US-China conflict in these 20th century terms like: Socialist or capitalist, Autocratic, Neoliberal, Democratic.", "section_level": 2, "section_title": "Beyond 20th Century Binaries"}, {"index_sentences": "I've often used a concept I kind of borrow from economics when I think about what a society values.", "section_level": 1, "section_title": "Elasticity of Values and American Dysfunction"}, {"index_sentences": "Do you think that that coefficient is changing? And if it is, does it change the way that you think about the lawyerly versus engineering states, especially if we start seeing each side borrowing from the other's value hierarchy?", "section_level": 2, "section_title": "Shifting American Priorities and the Cost of Proceduralism"}, {"index_sentences": "So, you know, we have broken mass transit. We have unaffordable housing. The pandemic revealed that the U.S. isn't able to manufacture a lot of pretty basic goods.", "section_level": 2, "section_title": "Critique of US Infrastructure and Manufacturing Shortcomings"}, {"index_sentences": "And that isn't even really a majoritarian demand for greater proceduralism. This was kind of an independent life force that grew upon itself and has a very vested interest of minoritarians that are really vested in trying to keep that system so they are able to block a new apartment building if it takes them with their light away, for example.", "section_level": 2, "section_title": "Proceduralism as a Barrier to Progress"}, {"index_sentences": "You work to be very fair in the book and that's something I really like about it. I mean, you don't just heap praise though on the engineering state.", "section_level": 1, "section_title": "Downsides of the Engineering State: Social Engineering"}, {"index_sentences": "Um, so to be clear, I really want to articulate that the speed of construction of new housing in China, new roads, tall bridges, subway systems, nuclear, all sorts of construction in China, I would say is net positive.", "section_level": 2, "section_title": "Benefits and Costs of Chinese Infrastructure"}, {"index_sentences": "The problem, I think, is that the Chinese leadership is not only physical engineers. They're also fundamentally social engineers, and they cannot stop themselves from treating the population as just another building material to be remolded or torn down as the circumstances demand.", "section_level": 2, "section_title": "The One-Child Policy and Zero-COVID: Failures of Social Engineering"}, {"index_sentences": "And then the great denouement of the great dramatic act of China's COVID experience was when in 2022's December, Beijing decided to drop all COVID restrictions in the coldest month of the year, when people had very few fever reducers in stock to meet this great ending of the pandemic when zero COVID kind of became total COVID.", "section_level": 3, "section_title": "The Trajectory and Collapse of Zero-COVID"}, {"index_sentences": "Yeah, absolutely. But, you know, at the same time, I worry that there's a certain type of American copium smoker who is taking these failures of the engineering state, assuming them to be inevitable consequences of adopting the sorts of things that you would like them to say.", "section_level": 2, "section_title": "American 'Copium' and the Long US-China Struggle"}, {"index_sentences": "I think that both countries are going to be winning and losing. And when they're winning, they're going to be making a lot of mistakes. When they're losing, they're going to try to catch up. And that's just going to be a dynamic process over the next few decades.", "section_level": 3, "section_title": "A Dynamic and Protracted Conflict"}, {"index_sentences": "I do agree. I think the language of existential threat and the framing of zero sum is foolish when you see it on either side.", "section_level": 1, "section_title": "Learning from China: Process Knowledge and Deep Infrastructure"}, {"index_sentences": "Let me get to the things that we ought to be, we as Americans ought to be learning from China. One of the things that you really emphasize is process knowledge.", "section_level": 2, "section_title": "The Critical Role of Process Knowledge"}, {"index_sentences": "I think the most important part of technology has to be the process knowledge, which is all of this meta and tacit knowledge that exists more on a population level.", "section_level": 3, "section_title": "Defining Process Knowledge and its Global Migration"}, {"index_sentences": "Arthur and I wrote that piece in Foreign Affairs called The Real China Model, in part to try to rebut the sense that China has succeeded technologically simply because it has stolen all the IP from the US.", "section_level": 2, "section_title": "China's 'All-of-the-Above' Technology Strategy: Deep Infrastructure"}, {"index_sentences": "What we point out in this piece is that China has actually built a lot of what we call deep infrastructure to be able to have its success.", "section_level": 3, "section_title": "Elements of Deep Infrastructure: Power, Connectivity, and Process Knowledge"}, {"index_sentences": "Dan, I've often remarked on how China in the 21st century is a much less technophobic or techno-pessimistic society than America is today.", "section_level": 1, "section_title": "Technophilia and the Technocracy"}, {"index_sentences": "I think that the technocracy creates the technophilia. I'm willing to change my mind on this, but I think it is definitely the case that China's leadership uses mega projects, big prestige projects, really to try to rally the population into doing something better.", "section_level": 2, "section_title": "Technocracy as a Driver of Technophilia"}, {"index_sentences": "And I think the contrast is with the United States, which has had a pretty major tech clash.", "section_level": 2, "section_title": "US Technoskepticism vs. Chinese Optimism"}, {"index_sentences": "I think there is definitely a sense that Chinese parents prefer that their kids study STEM degrees. And that is definitely much more obvious that many more Chinese kids are studying math relative to American kids, which I think is a shame.", "section_level": 2, "section_title": "STEM Education and Social Incentives"}, {"index_sentences": "But I was in China in December of 2024. And one of these things that I become really cranky and annoyed by is just how much people are on their phones all the time.", "section_level": 2, "section_title": "The Pervasiveness of Smartphone Use"}, {"index_sentences": "Yeah. You know, actually, I want to dig into history here. I mean, you don't explore this so much in the book, but I'm sure you've given us a lot of thought, which is, you know, the question of what gave rise to the engineering state in China?", "section_level": 1, "section_title": "Historical and Cultural Roots of the Engineering State"}, {"index_sentences": "I think there are definitely deeper roots in both the engineering state as well as the lawyerly society. That was my next question.", "section_level": 2, "section_title": "Legal and Imperial Traditions"}, {"index_sentences": "And I think one of these differences I want to trace between the West and China is that I think the Chinese were practicing a source of a sense of absolutism starting from the first Qing dynasty with Qin Shi Huang, in which the state really tried to control quite a lot of things.", "section_level": 2, "section_title": "Absolutism, Confucianism, and the Imperial Examination System"}, {"index_sentences": "I think that you've put your finger on it right there. This cooptation of the entire literati class just by making their advancement contingent on their support for a state orthodoxy.", "section_level": 3, "section_title": "Co-optation of the Literati"}, {"index_sentences": "So I guess the big question is, how do you build or design institutions that kind of somehow bind outcomes to rights?", "section_level": 1, "section_title": "Binding Outcomes to Rights: Practical Reforms"}, {"index_sentences": "I think actually a lot of countries have hit the sweet spot in terms of constructing mass transit while protecting the public interest.", "section_level": 2, "section_title": "Learning from European and Japanese Models"}, {"index_sentences": "And do you see efforts now on either side to try to learn from these better examples?", "section_level": 2, "section_title": "Mutual Learning and Obstacles"}, {"index_sentences": "What lessons do you think China's leaders themselves drew from the experience?", "section_level": 2, "section_title": "Lessons from China's Zero-COVID Experience"}, {"index_sentences": "I think that's a pretty good example of maybe a lesson, if not a lesson learned, at least that they exercise a little bit of restraint.", "section_level": 3, "section_title": "Post-COVID Restraint and Muscle Memory"}, {"index_sentences": "Dan, you write about fortress capabilities, the kind of redundancy, the overcapacity that Western analysts often dismiss or disparage as wasteful.", "section_level": 1, "section_title": "Fortress Capabilities: Resilience and Inefficiency"}, {"index_sentences": "I think one of the things that the pandemic revealed was exactly how fragile a lot of America's supply chains really were.", "section_level": 2, "section_title": "Redundancy vs. Just-In-Time Efficiency"}, {"index_sentences": "So Dan, I mean, shame on me. I have not yet finished reading Derek Thompson and Ezra Klein's Abundance, but I think I get the gist of their argument.", "section_level": 1, "section_title": "The Abundance Movement and China's Model"}, {"index_sentences": "I would want to be a card-carrying member of the Abundance movement. I am slated to speak at the Abundance Conference in Washington, D.C. in the first week of September.", "section_level": 2, "section_title": "China as an Operating Model for Abundance"}, {"index_sentences": "You know, you close your book down by emphasizing lived experience, what ordinary citizens feel day to day in terms of dignity, of fairness, of security.", "section_level": 1, "section_title": "Moral Legitimacy and Conceptual Pluralism"}, {"index_sentences": "How much do you think legitimacy in China actually rests on what I would call the moral dimension, the state, you know, being just or upright and defending dignity?", "section_level": 2, "section_title": "Beyond Performance Legitimacy: The Moral Dimension"}, {"index_sentences": "I certainly agree that it has been a persistent fantasy in the U.S. and some parts of the West that China's political legitimacy depends entirely on economic growth.", "section_level": 2, "section_title": "Shifting Perceptions of Legitimacy in the US"}, {"index_sentences": "So in the end, and here, I mean, we'll kind of wrap up with this, but you know, the engineering mindset can be way too literal, right? And the lawyerly mindset can be way too formal.", "section_level": 2, "section_title": "Towards Conceptual Pluralism in Governance"}, {"index_sentences": "I think that the right profession to govern the population, if we had to choose but one, would be something like economists.", "section_level": 3, "section_title": "The Ideal Governing Profession"}, {"index_sentences": "Yeah, not so bad at all. Well, Dan, what a fantastically fun and wide-ranging conversation I've had.", "section_level": 1, "section_title": "Concluding Remarks"}, {"index_sentences": "Let's move on now, though, down to the segment I call 'Paying It Forward,' where I ask you to name-check a younger colleague, maybe somebody at Hoover.", "section_level": 1, "section_title": "Paying It Forward: Guest Recommendations"}, {"index_sentences": "I will offer two names: One is Afra Wong, who writes a sub-stack called Concurrent. I think she is a great new thing that is sharing some interesting Chinese perspectives.", "section_level": 2, "section_title": "Afra Wong and He Liu"}, {"index_sentences": "What about recommendations, Dan? Do you have a book you've read recently that you would like to recommend or anything, film, music, anything at all?", "section_level": 1, "section_title": "Reading and Listening Recommendations"}, {"index_sentences": "The first set are the Mozart's Italian operas written with Lorenzo da Ponte. These are: The Marriage of Figaro, Don Giovanni, Cosi Fan Tutte.", "section_level": 2, "section_title": "Dan Wong's Cultural Recommendations: Mozart Operas and Classic Novels"}, {"index_sentences": "I have a couple of recommendations. One is by Yun Sun from the Stimson Center. She heads their China practice.", "section_level": 2, "section_title": "Kaiser Guo's Book and Article Recommendations"}, {"index_sentences": "You've been listening to The Seneca Podcast. The show is produced, recorded, engineered, edited, and mastered by me, Kaiser Guo.", "section_level": 1, "section_title": "Podcast Outro"}]};
window.faq = {"qas": [{"answer": "The Cineca Podcast primarily focuses on a weekly discussion of current affairs in China, exploring books, ideas, new research, intellectual currents, and cultural trends to better understand what is happening in China's politics, foreign relations, economics, and society. The host is Kaiser Guo.", "index_of_source": "Welcome to the Cineca Podcast, a weekly discussion of current affairs in China.", "question": "What is the primary focus of the Cineca Podcast, and who is its host?"}, {"answer": "The Cineca Podcast is supported by the Center for East Asian Studies at the University of Wisconsin-Madison, and also encourages support from organizations and individual paying subscribers. Paying subscribers receive benefits such as the complete transcript of the show, essays from Kaiser, and writings and podcasts from other China-focused columnists and commentators.", "index_of_source": "Cineca is supported this year by the Center for East Asian Studies at the University of Wisconsin-Madison, a national resource center for the study of East Asia.", "question": "How is the Cineca Podcast supported financially, and what benefits do paying subscribers receive?"}, {"answer": "Dan Wong is recognized as one of the sharpest and most original observers of China's technology sector and manufacturing landscape. He has gained fame for his annual letters and essays that uniquely combine on-the-ground insights with broader perspectives.", "index_of_source": "He is one of the sharpest and most original observers of China's technology sector and manufacturing landscape, having won a certain level of fame for his annual letters and other essays — writings that somehow managed to combine on-the-ground insights with big picture perspectives.", "question": "Who is Dan Wong, and what makes him a notable observer of China?"}, {"answer": "Kaiser Guo describes the main thesis of Dan Wong's book, \"Breakneck: China’s Quest to Engineer the Future,\" as China being an \"engineering state\" ruled by engineers who build, in contrast to America, which is portrayed as a \"lawyerly society\" ruled by lawyers.", "index_of_source": "It’s a book that posits — and here I’m greatly oversimplifying — that China is ruled by engineers and they do what engineers like to do: they build.", "question": "What is the main thesis of Dan Wong's new book, \"Breakneck: China’s Quest to Engineer the Future,\" as described by Kaiser Guo?"}, {"answer": "Zhengan County in Guizhou became the world's largest guitar-making hub through a \"great accident.\" Many people from Guizhou who had moved to Guangdong to work in guitar factories were later enticed by the local Zhengan government to return home. The government offered incentives like infrastructure and tax breaks, aligning with a rural revitalization program, to establish this manufacturing cluster.", "index_of_source": "And that happened due to a great accident in which a lot of folks in Guizhou were moving to Guangdong.", "question": "How did Zhengan County in Guizhou become the world's largest guitar-making hub, and what role did the local government play in this development?"}, {"answer": "Beyond obvious differences like speed versus procedure, Dan Wong suggests that both the engineering state and the lawyerly society claim legitimacy. The lawyerly society derives legitimacy from established procedures and rules, while the engineering state, exemplified by the Communist Party, claims it from \"whole process, substantive democracy\" and delivering tangible improvements for the people.", "index_of_source": "Yeah. Well, I want to push you a little bit on this, Kaiser.", "question": "Beyond obvious differences, what are some subtle trade-offs between an \"engineering state\" and a \"lawyerly society,\" particularly regarding legitimacy?"}, {"answer": "Kaiser posits that an engineering-oriented society might approach the trolley problem as a technical optimization problem to minimize total loss (a utilitarian view). In contrast, a lawyerly society might insist on strict adherence to rules, rights, and procedures that cannot be violated, even for a greater good (a deontological view). This difference could reflect underlying communitarian versus individualistic values.", "index_of_source": "In the West, we often reach for the trolley problem as a kind of shorthand for thinking about moral tradeoffs.", "question": "How might an \"engineering state\" and a \"lawyerly society\" approach the philosophical \"trolley problem\" differently, and what underlying values might this reveal?"}, {"answer": "Dan Wong argues that a significant downside of the engineering state is the leadership's tendency to act as \"social engineers,\" treating the population as a resource to be molded or displaced. This is exemplified by policies like the repression of ethno-religious minorities (Tibet, Xinjiang), the hukou system, the one-child policy, and the zero-COVID policy. The zero-COVID policy, despite early successes, ultimately led to the severe eight-week Shanghai lockdown and a chaotic dropping of restrictions, causing widespread suffering and food insecurity.", "index_of_source": "The problem, I think, is that the Chinese leadership is not only physical engineers.", "question": "What are some of the significant downsides of the \"engineering state\" in China, beyond infrastructure and economic costs, as exemplified by social engineering projects?"}, {"answer": "Dan Wong defines \"process knowledge\" as meta and tacit knowledge that exists on a population level, rather than being easily written down in recipes, blueprints, or patents. He considers it the most important part of technology because it represents the accumulated, often uncodifiable, understanding and skills within a workforce necessary for the production of various goods.", "index_of_source": "I think the most important thing to grasp about technology is not the actual physical instruments or tools that we can see, anything like a robotic arm.", "question": "What is \"process knowledge,\" and why does Dan Wong consider it the most important aspect of technology, particularly in manufacturing?"}, {"answer": "Dan Wong believes that the technocracy creates the technophilia in China. The leadership uses large-scale, prestige engineering projects to rally the population and fosters an optimistic view of technology. This is further reinforced by cultural narratives (like \"Wandering Earth\" and \"Three-Body Problem\") that emphasize engineers solving humanity's problems, and by the observable improvement in people's lives that has occurred in lockstep with technological advancement.", "index_of_source": "I think that the technocracy creates the technophilia.", "question": "According to Dan Wong, what is the causal relationship between China's technocratic engineer-dominated polity and its technophilic society, and how does it manifest?"}]};
</script>
