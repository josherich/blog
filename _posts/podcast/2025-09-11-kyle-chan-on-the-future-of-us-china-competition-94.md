---
layout: post
title: "Kyle Chan on the Future of US-China Competition — #94"
...
[Kyle Chan on the Future of US-China Competition — #94](https://media.transistor.fm/f351deb8/42741e29.mp3)
...
Because honestly, the first time I traveled to China as an adult, I went to **Beijing**. It was like 2005 or 2006 or something as an adult. And I was like, this place is kind of chaotic. It's kind of like all over the place.
I remember getting a bunch of hacked-together **electronics on the cheap**, things like that. And that was kind of like my association with **China**.
...
Yeah, so the theory I offer is **the structure of the bureaucracies** in the two countries.
Yeah, that **China** sort of reformed its system from a system that looked more like **India's**, more top-down, more centralized, to this one that was based around, yeah, on the one hand, these **railway project companies**, these sort of specialized **state-owned enterprises** that were formed to manage railway projects.  
...
And I think right now, I think you're well positioned because I think **China** is providing an example where it seems like **industrial policy has worked out**.
And I think for the last few decades, people in the West have been, or at least an American, maybe **American economists** have, have been really conditioned to think that **that's just a recipe for failure, that governments can't really execute properly and can't get things done.**
...
So there are these bigger trends happening behind each of these individual sectors. And so, yeah, like, you know, I'm sure some of the people who you speak with and probably who listen to this podcast, they might be deep in the weeds on biotech in China and be like, "Wow, there's some big changes happening here. Some of the oncology treatments are really taking off. The pace of clinical trials is really incredible." But they might not have a view into the shipbuilding world, or it might be very light.
And so to kind of put it all together and just be like, look, **this is not just a single sector or a single industry or a single company**. It's not just **DeepSeek** or **BYD** or any of these ones that make the headlines. It's a much, much broader pattern. And that's why we need to wake up.
...
1. **Human capital** – They have just, you know, an extremely large population.  
2. **Engineers** – They sort of have their act together at the government level. Like I just said, the government can maybe not pick individual winners, but they do know what areas to pump resources into.  
3. They know enough to **get out of the way and let actual market forces determine which companies actually win** in the space.
...
It's, like, you can't just turn the knob all the way to 11 and expect that to work. You want to kind of like add the ingredients that you think will help.
You know, if there's some **key component** or key aspect that's missing, maybe the **government can backfill or contribute in that area**. And then especially looking at problems in the **supply chain** and trying to fill those in. So, that can be very useful.
...
Yeah. In the sociology world, are people hostile if you break out **human capital** as a separate factor for productivity or development?
I mean, certainly, **certainly you couldn't link it**. I mean, you couldn't link it to anything like **genetics**, but just even saying that this system produces more 22 year olds that can do **linear algebra per capita** than this other system.
...
And again, all these terms — even the word **tech transfer** — unfortunately, it is not about handing someone a piece of knowledge, right?
It is, I like the term actually sort of like **absorption capacity**, you know, in a way more because, and this comes back to sort of **China's scientific foundations** that you, it's one thing other countries have tried to lure foreign companies to build plants in their jurisdictions and train their workers. And then it's sort of just ends there.
...
And, episode of **Manifold**, I interviewed the author of the book, _Apple in China_, which is a really, really exhaustive look at the operations of Apple in China.
...
And then you look it up and you realize, yeah, in fact it did. And they never forgot that, right. That there was a period where they were at **technological embargo**.
**The thing pisses them off so much**, but they were under **technological embargo**. At the same time, **MacArthur was urging the U.S. to just drop nuclear weapons on Manchuria, nuclear bombs on Manchuria**.
...
I don’t see that leveling off for most of these KPIs for another decade or so.
Yeah, yeah. And they're making a **big bet**. I mean, they're betting that more investment in these **scientific fields**, more investment in these industries, is the long run, right thing to do. Yeah. And so it'll be very interesting. I mean, we will watch the experiment unfold before our eyes.
...
> Where do the original ideas come from?
If you see those two things together, like, then you can understand, like, **this ecosystem that's required for NERCA to compete**. But if you've only done one or the other, you could be wrong.

The **university guy** doesn't necessarily understand, like, most of the stuff people do at the university isn't that valuable and can't be commercialized. And the **applied guy** probably might not realize, like, _oh, this thing that I'm, oh, I can now think of 100 different uses of this thing_. That came 20 years ago that at the time it was considered a crazy idea and only **DARPA** or **NSF** would fund it. Nobody else would fund it.
...
But, you know, it is very hard. Like, if even some engineers who are more, like, they've only worked in industry, they've only worked very close to, like, the market and the customer shipping a product, even they have a hard time understanding, like, _what are you physics guys doing with the superconduct?_ What's the point of that, you know, besides, like, there are people in **Silicon Valley** who think all these academics are useless and, _oh, if you just give some smart, agentic engineer the problem, they can solve it_.
...
And, yeah, I actually look at a lot of stuff, too, about **China's interactions** with, you know, global South countries or China and Europe, which I think is like, you know, maybe Americans don't care as much, but Europeans really care.
And there are a lot of people who care about, you know, the rest of the world. So those are all things that are, I think, very dynamic, and there's a lot of things happening. So those are areas I'm following very closely.
...
Like, all these **technologists in China**, they're selling you their stuff at **rock-bottom prices**. They're making stuff efficiently. They're selling it to you. And they're actually starting to make **real fundamental breakthroughs**, like new battery technologies or new AI models. So what's not to love? 
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "I know this is sort of like a hackneyed term now these days, but I really believe that the areas that China is really focused on are the building blocks for the next generation of technologies, emerging sectors that are going to be not only sort of like the economic growth engines, the job engines of the future, but sort of broader progress is going to be built on that.",
      "section_title": "Introduction: China's Next-Gen Tech and Guest Introduction",
      "section_level": 1
    },
    {
      "index_sentences": "So, I know that you studied economics at the University of Chicago, and then you did your PhD at Princeton in sociology.",
      "section_title": "Kyle Chan's Intellectual Journey",
      "section_level": 1
    },
    {
      "index_sentences": "Yeah, so, one of the long-standing questions that drives my research that actually has gotten me motivated, like, for now, I guess, almost decades, is the question of development.",
      "section_title": "The Question of Development and Shift to Sociology",
      "section_level": 2
    },
    {
      "index_sentences": "I mean, now the funny thing is, questions that I was asking about China, which I think is still also the biggest story in development.",
      "section_title": "China as a Case Study and Comparative Lens",
      "section_level": 2
    },
    {
      "index_sentences": "Your dissertation work was on development of railways and comparing India to China, is that correct?",
      "section_title": "Dissertation Work: Railways in China and India",
      "section_level": 1
    },
    {
      "index_sentences": "My question was like, how did China build this high-speed rail system that is now larger than the rest of the world's bullet train systems combined?",
      "section_title": "China's High-Speed Rail Success vs. India's Struggles",
      "section_level": 2
    },
    {
      "index_sentences": "That whole project was trying to understand, at a meso level of analysis.",
      "section_title": "Meso-Level Analysis of Bureaucratic Structures",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, so the theory I offer is the structure of the bureaucracies in the two countries.",
      "section_title": "Conclusion: Bureaucracy Structure and Effectiveness",
      "section_level": 2
    },
    {
      "index_sentences": "Well, just that some of it is not as clear to me.",
      "section_title": "Financial Viability of Chinese Rail",
      "section_level": 2
    },
    {
      "index_sentences": "Now, after you finished your PhD, and you became a postdoctoral researcher, did you sort of consciously out that you would, you would be interested in?",
      "section_title": "Transition to Postdoctoral Work and Industrial Policy",
      "section_level": 1
    },
    {
      "index_sentences": "So I started to realize that there's a lot of overlap between infrastructure development and industrial policy, that both entail long term investments, and have massive coordination problems.",
      "section_title": "Overlap: Infrastructure, Industrial Policy, and China's Role",
      "section_level": 2
    },
    {
      "index_sentences": "And I think right now, I think you're well positioned because I think China is providing an example where it seems like industrial policy has worked out.",
      "section_title": "Western Skepticism vs. China's Example",
      "section_level": 2
    },
    {
      "index_sentences": "The other thing is China itself is a factor prompting a lot of countries to reconsider industrial policy.",
      "section_title": "China as a Factor Prompting Reconsideration of Industrial Policy",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, that's a really interesting question, because I have a number of different audiences in mind.",
      "section_title": "Target Audience for Research",
      "section_level": 1
    },
    {
      "index_sentences": "I just realized that there's actually a lot of knowledge and understanding that's kind of locked away by scholars and researchers who have been kind of interested in this stuff for a long time, but just talking to each other.",
      "section_title": "Bridging the Knowledge Gap between Experts and General Public",
      "section_level": 2
    },
    {
      "index_sentences": "Nice piece.",
      "section_title": "The New York Times Opinion Piece",
      "section_level": 1
    },
    {
      "index_sentences": "The title of the piece, it's a guest essay in the New York Times opinion section.",
      "section_title": "Controversial Title and Its Reception",
      "section_level": 2
    },
    {
      "index_sentences": "I felt that piece was totally reality based.",
      "section_title": "Reality-Based Content and Broader Impact",
      "section_level": 2
    },
    {
      "index_sentences": "But I just hadn't heard that many people in mainstream media talking about all of these different sectors, all these different scientific fields as well, sort of backing.",
      "section_title": "China's Broad Technological Advancements and Future Industries",
      "section_level": 2
    },
    {
      "index_sentences": "What's unique about China, and this is something I think both you and I have written about, is, you know, there are a few factors which affect verticals.",
      "section_title": "Factors Underlying China's Success: Human Capital, Government, Market Forces",
      "section_level": 2
    },
    {
      "index_sentences": "So, like, at a certain point, it's about, as you said, kind of shaping the market, shaping the ecosystem, like providing, you know.",
      "section_title": "Chinese Industrial Policy: Ecosystem Cultivation",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, one of the points I made in the wake of Mark Zuckerberg hiring with exorbitant salaries and comp packages, all of these top AI features from companies like OpenAI and elsewhere, is a big chunk of those people were actually educated in China, at least at the undergraduate level.",
      "section_title": "STEM Education and Its Importance",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, I think people still even today, underrate how big the gap is, because in almost every metric, if you look at in terms of human capital, if you look at China, it tends to dwarf the US and it tends to be more like China is roughly equivalent to rest of world combined.",
      "section_title": "Scale of Human Capital and Technical Capabilities in China",
      "section_level": 2
    },
    {
      "index_sentences": "Maybe we can move your Times piece to, um, it wasn't just you, I guess there were multiple authors, right?",
      "section_title": "Lu Feng and \"Industrial Maximalism\"",
      "section_level": 1
    },
    {
      "index_sentences": "Yeah. So Lu Feng, he is a very prominent, I don't know how to categorize him now, a political economist, economist.",
      "section_title": "Lu Feng's Argument and \"Guancha\" Publication",
      "section_level": 2
    },
    {
      "index_sentences": "But one of the biggest takeaways was just thinking about industrial capacity is not just something about building physical factories, but as sort of this, and this relates to my work, the organizational capacity that a society has to be able to do this.",
      "section_title": "Industrial Capacity and Tech Absorption",
      "section_level": 2
    },
    {
      "index_sentences": "Let me throw out a couple speculative things.",
      "section_title": "Western vs. Chinese Perspectives on Overcapacity",
      "section_level": 1
    },
    {
      "index_sentences": "So, so from the Western side where this term overcapacity comes from, the idea is something like.",
      "section_title": "Western View: Overcapacity and Race to the Bottom",
      "section_level": 2
    },
    {
      "index_sentences": "There is that throughout most of the 20th century, there were, or at least during the history of the People's Republic, there were American sanctions, Western sanctions on China.",
      "section_title": "Chinese Historical Context and Self-Reliance",
      "section_level": 2
    },
    {
      "index_sentences": "And then it turns out your fear was well-founded—you are afraid of a burglar entering your house, and people said it wouldn’t happen.",
      "section_title": "Validation of Fears through Sanctions and Export Controls",
      "section_level": 2
    },
    {
      "index_sentences": "I think it will be a while.",
      "section_title": "Long-Term Chinese Focus on Industrial Growth",
      "section_level": 2
    },
    {
      "index_sentences": "But in the future, for you, Kyle, the sort of U.S.-China competition or, you know, the biggest story of the last 100 years, which is probably China's development, or last 70 years at least, is where you intend to focus most of your energy going forward?",
      "section_title": "Future Focus and Speculative Topics",
      "section_level": 1
    },
    {
      "index_sentences": "Yeah, yeah.",
      "section_title": "Kyle's Continued Research Focus",
      "section_level": 2
    },
    {
      "index_sentences": "Fast takeoff in AGI led by Americans.",
      "section_title": "AGI as a \"Trump Card\" for the US",
      "section_level": 2
    },
    {
      "index_sentences": "Well, so one thing that's very interesting that I follow is the debate in China about the 0 to 1 versus 1 to 100 sort of innovation scale-up thing.",
      "section_title": "0 to 1 vs. 1 to 100 Innovation Debate and Paradigm Shifts",
      "section_level": 2
    },
    {
      "index_sentences": "You know, I like this optimistic perspective.",
      "section_title": "Optimistic Perspective: Global Scientific Collaboration",
      "section_level": 2
    },
    {
      "index_sentences": "I would point to GitHub as, like, just spend time on GitHub.",
      "section_title": "GitHub as an Example of Worldwide Collaboration",
      "section_level": 2
    },
    {
      "index_sentences": "That's a nice, optimistic place.",
      "section_title": "Conclusion of Conversation",
      "section_level": 1
    }
  ]
};
window.faq = {
  "qas": [
    {
      "question": "What is the long-standing question that drives Kyle Chan's research and has motivated him for almost decades?",
      "answer": "The long-standing question that drives Kyle Chan's research is \"development,\" specifically \"Why are some countries rich? Why are some countries poor?\" and how a person's life is deeply shaped by their place and country of birth.",
      "index_of_source": "Yeah, so, one of the long-standing questions that drives my research that actually has gotten me motivated, like, for now, I guess, almost decades, is the question of development."
    },
    {
      "question": "Why did Kyle Chan transition from studying economics at the University of Chicago to pursuing a PhD in sociology at Princeton, despite finding economic tools useful?",
      "answer": "He found that the questions economists asked were getting narrower and narrower, and felt that many of the biggest variables, though hard to measure, were not being considered. He shifted to sociology, which he views as a \"big tent discipline\" in terms of methodology and question types.",
      "index_of_source": "But I did find that the questions economists asked were getting narrower and narrower."
    },
    {
      "question": "In the context of \"development\" as the biggest question, what does Kyle Chan consider the \"biggest case\" and what specific aspect of it still begs to be explained?",
      "answer": "China is considered the \"biggest case,\" and the aspect that still begs to be explained is how the country transformed itself so dramatically, basically in a single generation, with huge consequences for the rest of the world.",
      "index_of_source": "I mean, now the funny thing is, questions that I was asking about China, which I think is still also the biggest story in development."
    },
    {
      "question": "What was the central question of Kyle Chan's dissertation work comparing railway development in India and China?",
      "answer": "His dissertation questioned how China built a high-speed rail system larger than the rest of the world's combined in such a short period, especially when Indian railways were on par with Chinese railways as late as the 90s, despite India having talented engineers.",
      "index_of_source": "My question was like, how did China build this high-speed rail system that is now larger than the rest of the world's bullet train systems combined?"
    },
    {
      "question": "What theory did Kyle Chan offer to explain China's success in railway development compared to India's, focusing on the meso-level organizational structures?",
      "answer": "He argued that China reformed its system from a more top-down, centralized model (like India's) to a \"nodal structure\" where power and responsibility are concentrated in key nodes, such as specialized state-owned railway project companies. India, conversely, had a more diffuse matrix structure, causing confusion and project delays.",
      "index_of_source": "Yeah, so the theory I offer is the structure of the bureaucracies in the two countries."
    },
    {
      "question": "How does Kyle Chan's perspective on the financial viability of China's high-speed rail system differ from typical Western analyses?",
      "answer": "He believes many Western analysts \"miss the forest for the trees\" by focusing strictly on the project's direct IRR. Instead, he views it as a broad investment in the entire country designed to generate economic spillovers, rather than just returning a profit on a single project or the railway system itself.",
      "index_of_source": "But overall, my take on the whole financial sustainability question is that I do think that a lot of sort of Western analysts are missing the forest for the trees when it comes to understanding this."
    },
    {
      "question": "What is \"industrial maximalism\" as discussed by Kyle Chan, and what was Lu Feng's main argument regarding China's economic strategy?",
      "answer": "\"Industrial maximalism\" refers to the idea that China should double down on manufacturing and industrial capacity, even arguing against notions of overcapacity in sectors like steel. Lu Feng's main argument was that China needs more industrial development and should continue to focus on it.",
      "index_of_source": "And this piece talked about what I called industrial maximalism. That is all the arguments that you hear, like from the West, the critiques, the criticisms about:"
    },
    {
      "question": "Beyond economic rationale, what historical and psychological factors does Kyle Chan suggest drive China's continued \"over-indexing\" or intense focus on industrial production and technology catch-up?",
      "answer": "China's historical experience with Western sanctions and technological embargoes (dating back to the People's Republic) and past threats (like the Korean War) have fostered a deep-seated paranoia and a desire for self-reliance. Recent export controls and sanctions have validated these fears, pushing them to sustain aggressive industrial development.",
      "index_of_source": "There is that throughout most of the 20th century, there were, or at least during the history of the People's Republic, there were American sanctions, Western sanctions on China."
    },
    {
      "question": "What three factors does the speaker identify as underlying China's ability to advance simultaneously and very fast across numerous different technological verticals?",
      "answer": "The three factors are: an extremely large population and a strong emphasis on human capital (especially engineers with solid math skills), a moderately competent government that knows what areas to pump resources into, and the ability of the government to step aside and let market forces determine which companies succeed within those areas.",
      "index_of_source": "And the factors that underlie that are: 1. Human capital – They have just, you know, an extremely large population."
    },
    {
      "question": "For technologists in Silicon Valley who acknowledge China's broad advancements across industries, what remains their primary hope for the U.S. to \"win\" or retain dominance?",
      "answer": "Their hope often retreats to the idea of a \"fast takeoff in AGI led by Americans,\" believing that a breakthrough in Artificial General Intelligence in the U.S. would be the \"Trump card\" that saves their position.",
      "index_of_source": "The usual place where the Silicon Valley people can still pin their hopes is the following: Fast takeoff in AGI led by Americans."
    }
  ]
};
</script>
