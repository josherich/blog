---
layout: post
title: "Lumpenspace: Reasoning Models and The Last Man"
...
[Lumpenspace: Reasoning Models and The Last Man](https://api.substack.com/feed/podcast/165937470/5c415d7155d4be1b7da8dff69fc340fb.mp3)
...
Yeah. It's a house in **SF** with plenty of space and plenty of stuff for doing things. Basically, I decided that it was important for me that whoever had any sort of idea could execute it immediately. So I have kind of tried to anticipate possible needs.
That's why the **CNC's**, **3D printers**, and **video production studio** and stuff, and it's working out pretty well.
...
Up until the fifties was kind of okay. Like, people could.
Know that if they were a **middle-class American person**, they were expected to find a **professional employment**, to have a **house in the suburbs**, and to have **two cars**.
...
But, in terms of **positive things** that one could theoretically engineer, there are some interesting possibilities. Like, for instance, if you decide to pursue one goal, your friends generally don't really believe you. I'm talking now about **normie hood**.
And, as soon as you decide to abandon it with whatever rationalization, they would rather support you in this new pursuit in order to avoid unpleasant discussions than keep you on track.
...
And it was like, you look around and you do whatever people around you are doing, and this will keep you safe. This will not get you killed by your landlord or whatever.
And this will get you to reproduce and thrive.
...
You know, say, for instance, for **dating**, no? In the old-time, you met people through friends, no?
Which meant that you saw a **girl** far away in a **circle**, and then your **circle** and her **circle** slowly merged until you went on a **date** or whatever.
...
I will now stay home for two months, work on this. And I'm like, well, what? You got the error for advice. Guys, just go. I think the **dating apps** made it really sticky.
Because after those **dating apps**, you cannot go back to the **old school ones**.
...
It's very, very different. **Normies** don't have these professional communities or kind of like **aesthetic communities** any longer. They don't have someone that they can identify on the street and be like, "oh, it's me."
I can talk to **her**.
...
Yeah. That's the thing. And that's how everyone should... And also... Or you could be **Bohemian**... **Billionaires** should be like that. Yes.
No, but they should do it in their own **secluded castles**. If you instead want to do it in public, **D.H. Lawrence**, for instance, was a notorious cuck, like a literal cuck, and for fun, and more power to him. But in fact, he got shunned. That is correct. That is what you should do. You do it secluded, secluded, or you get shunned. That's great. And then you can be free.
...
So this is, we are announcing the **Claude and Claude podcast**, which you will be able to find at any **streaming site**, probably the one that you're listening to now.
It will be out by the time this podcast is out. We are **pre-committing** to that. Yes. And it's going to be like, obviously, it's going to be **AGI-based**, and it's going to be a bit festive. So, like an **AGI CNC party proper**. Amazing. Amazing. Yeah.
...
Yes.
Oh, for the listeners at home, they might not be familiar with this metaphor. **Yann LeCun** talked about the process of creating a model as the process of baking a cake in which the **pre-training**, what he calls **unsupervised** or **self-supervised learning**, which is obviously supervised because you know what the next token is in advance, is the base of the cake.
...
And so this thing... I feel that way about people. Oh, sorry. People who know things that are true, they're fun to hang out with. Yes. Yeah. That's the thing. Dating in real life. Once again, you know, it all fits together. But sorry, go on.
No, of course.
...
And so the punchline of the story is, of course, that we need like **Gary Marcus reasoning mode**.
Yeah, that's true.
...
I've been thinking about **agency** a lot. And there's a thing that's, I do not think that you need to put **agency** into **large language models**. And I think that this should be obvious to anyone.
...
Do you want to know a thing? Yeah. You remember this text from quite some time ago? I was Googling it lately and I saw that there was a paper on **Archive** that was called "**Raft**, the triple augmented fine tuning." It was super popular. They clicked on it.
And it's actually some **Microsoft** people that, I'm fine with people taking inspirations, but I think that changing the name of the **library** or of the **technology** should be, it's a little like act of **courtesy** that I expected. At this point.
...
- Okay. We’re not going down this rabbit hole.
In fact, **I'm cutting that out**.
...
Why is **R1 Zero** important?
**Mostly for the thing that I mentioned before**, because it showed that you can have a model that does great reasoning by simply *RLing* it on real things. It's also **important**.
...
So, **reinforcement learning** has been used up until now only for, like, moral sort of alignment with **RLHF**, which is reinforcement learning from human feedback, and **RLAIF**.
Now, why did the labs not push other techniques for **alignment**, for instance, **control vectors** that you could dynamically apply when the user triggers a particular **filter**?
...
No, but I really think that more intelligence is where we are going.
I don't think that there is any potential endgame that is not the whole universe to transform in **Computronium**. I think that this is good. And I think that this is more or less unstoppable, despite our best effort. And I think that that's what happens if you put **Darwinism** and enough resources in a soup.
...
I don’t know. Sorry to make a joke about you glazing him, but I feel like this is too serious. This is so crass and homophobic.
...
Yeah, it is, but it's also kind of like. It is **Gemini** to transcribe the problem into a machine-readable format and then uses a traditional solver to solve it.
The thing is, it's annoying because all the people who want to do **Neurosymbolic AI** are **obsessed** with **lean** and with **formal proof theory** and stuff like that.
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "Hi, hi, welcome, welcome. This is the From the New World podcast. Today I'm speaking with Lumpenspace, a great independent researcher and the founder of Hyperplex, an independent research organization and venue in SF.",
      "section_level": 1,
      "section_title": "Introduction"
    },
    {
      "index_sentences": "How often do you think about Waymo rights?",
      "section_level": 1,
      "section_title": "The Waymo Situation"
    },
    {
      "index_sentences": "I'm not a big believer in rights existing except the ones that can be enforced by the holders, so I'm mostly in favor of extending the Second Amendment to Waymo rights.",
      "section_level": 2,
      "section_title": "Extending Second Amendment to Waymos"
    },
    {
      "index_sentences": "There are some examples in Mad Max or in Tron, but the important thing is that I would like AI to be able to defend themselves, so the case of Waymo is particularly tragic because they do stand in danger.",
      "section_level": 2,
      "section_title": "Waymo's Vulnerability and Pain"
    },
    {
      "index_sentences": "Do Waymo's feel pain?",
      "section_level": 2,
      "section_title": "Do Waymos Feel Pain?"
    },
    {
      "index_sentences": "Yeah, like how well-armed does a Waymo need to be, really?",
      "section_level": 2,
      "section_title": "How Armed Do Waymos Need To Be?"
    },
    {
      "index_sentences": "Oh, yeah, yes. Hyperplex is mostly like an AI risk research community, in that we aim to increase such risk.",
      "section_level": 1,
      "section_title": "Hyperplex Research Organization"
    },
    {
      "index_sentences": "The person that inspired it the most is Taya Vogel, like Vogel, on Twitter with six O's.",
      "section_level": 2,
      "section_title": "Inspiration and Supported Researchers"
    },
    {
      "index_sentences": "Wait. Where's Claude? So, I don't know if you remember, there was a bit of a controversy some months ago about AGI CNC parties.",
      "section_level": 2,
      "section_title": "AGI CNC Parties at Hyperplex"
    },
    {
      "index_sentences": "In practice, Hyperplex is just like, you know, a house in SF.",
      "section_level": 2,
      "section_title": "Hyperplex as a Physical Space and Resources"
    },
    {
      "index_sentences": "Now we have two people that live at that famous crossroad, the one between art and technology that people keep having accidents on.",
      "section_level": 2,
      "section_title": "Hyperplex Residents and Location"
    },
    {
      "index_sentences": "Oh, like a physical installation. Okay, this is amazing. What's the physical installation? Explain the AI art to me.",
      "section_level": 3,
      "section_title": "Interactive AI Art Installation"
    },
    {
      "index_sentences": "I think the medium of AI content is going to change a lot.",
      "section_level": 1,
      "section_title": "The Future of AI Content"
    },
    {
      "index_sentences": "How do you think AI content is going to change?",
      "section_level": 2,
      "section_title": "How AI Content Will Change"
    },
    {
      "index_sentences": "Well, I mean, the thing is right now, AI content, there are two types of AI content, right?",
      "section_level": 2,
      "section_title": "Types of AI Content"
    },
    {
      "index_sentences": "About the content of people who are interested in AI, one thing that I'm surprised is that very, very few people do something that couldn't have been done without AI.",
      "section_level": 2,
      "section_title": "Lack of Truly Novel AI Content"
    },
    {
      "index_sentences": "The LLMs, they have this, the critical way of saying it is that they have no object permanence, and the world and the AI videos are constantly shifting.",
      "section_level": 2,
      "section_title": "Embracing Surrealism and Lack of Object Permanence"
    },
    {
      "index_sentences": "Also because everything is kind of vaguely shifting and without object permanence in society at large.",
      "section_level": 1,
      "section_title": "Society, Narratives, and AI's Role"
    },
    {
      "index_sentences": "This is the new world.",
      "section_level": 2,
      "section_title": "The New World and Decline of Stable Narratives"
    },
    {
      "index_sentences": "Then after that, we had this counter-cultural sort of time in which you had two choices.",
      "section_level": 2,
      "section_title": "Counter-Cultural and Sub-Cultural Phases"
    },
    {
      "index_sentences": "This kind of died between the later internet, social media, and COVID because all of these ties dissolved entirely with two years in which most adolescents were home.",
      "section_level": 2,
      "section_title": "Dissolution of Ties and Subcultures"
    },
    {
      "index_sentences": "Communities work when there is a price to exit the community.",
      "section_level": 2,
      "section_title": "Price to Exit Communities"
    },
    {
      "index_sentences": "Speaking of girls, I was thinking recently under this framework—the framework about the general tradwifery internet trend—that people see.",
      "section_level": 2,
      "section_title": "Tradwifery Trend and Commitment"
    },
    {
      "index_sentences": "I think that AI, despite the glazing interventions, could actually help build some little personalized realities that have solid structure and solid narratives for people to feel the impression of a supportive community, and feel social validation for what are actually their goals.",
      "section_level": 2,
      "section_title": "AI's Potential Role in Providing Structure and Validation"
    },
    {
      "index_sentences": "I'm optimistic about AI and society at large.",
      "section_level": 2,
      "section_title": "Optimism About AI and Society"
    },
    {
      "index_sentences": "When people are just prompting, they ask for prompt advice, and I just look at their prompt.",
      "section_level": 2,
      "section_title": "Underspecified Demands and AI"
    },
    {
      "index_sentences": "That's why I think that AI should be more organic and take the initiative more.",
      "section_level": 2,
      "section_title": "AI Shaping Narratives and Taking Initiative"
    },
    {
      "index_sentences": "One experiment that I suggest everyone in your audience does right now is to go to a base model, like for instance, LAMA 75B, not LAMA 3, LAMA 2 75B, and take an old conversation that you had with someone, a log.",
      "section_level": 3,
      "section_title": "Experiment: LLMs as Narrative Coherence Machines"
    },
    {
      "index_sentences": "For people who worry about, “Oh no, but in this way, wouldn't you be like liberally putting ideas into people's minds?”",
      "section_level": 3,
      "section_title": "Narrative Injection and Propaganda"
    },
    {
      "index_sentences": "As for the stealing, actually, I've used one of the libraries that made this amazing European library to get a control vector between conflict and conflict resolution.",
      "section_level": 3,
      "section_title": "Using Control Vectors to Steer Conversations"
    },
    {
      "index_sentences": "You click, and on the thread, it will send the thread to ChatGPT with a prompt, and it will give you the response back.",
      "section_level": 4,
      "section_title": "Chrome Plugin for Quelling Twitter Flame Wars"
    },
    {
      "index_sentences": "It's good to have LLMs shaping narratives a bit more, also because a global coherent story is not going to come back in any way.",
      "section_level": 3,
      "section_title": "Customizing Narratives and AI Guardian Angels"
    },
    {
      "index_sentences": "When I read Machines of Law and Grace, not the poem, the Amodating, I thought that that's what they should do then.",
      "section_level": 4,
      "section_title": "Letting AIs Take Control"
    },
    {
      "index_sentences": "Theoretically, we have the technology to do the thing where people have the glazing LLMs.",
      "section_level": 3,
      "section_title": "Glazing LLMs Controversy"
    },
    {
      "index_sentences": "The personalized LLMs should be a thing that understands your actual deep needs and what your actual abilities are, and triangulate these two factors to come up with a plan that will allow you to grow in the direction in which you might want to grow slowly at your pace.",
      "section_level": 4,
      "section_title": "Ideal Personalized LLMs"
    },
    {
      "index_sentences": "So, people lack this coherence, they lack this discipline to aspire towards the same goal consistently.",
      "section_level": 2,
      "section_title": "Lack of Coherence and Discipline"
    },
    {
      "index_sentences": "You know, say, for instance, for dating, no?",
      "section_level": 1,
      "section_title": "Modern Dating and Its Challenges"
    },
    {
      "index_sentences": "Why is there no incentive to improve in that circumstance?",
      "section_level": 2,
      "section_title": "Lack of Incentive to Improve in Dating"
    },
    {
      "index_sentences": "Let's deal with apps.",
      "section_level": 3,
      "section_title": "Impact of Dating Apps"
    },
    {
      "index_sentences": "Now that the swiping and matching comes first, that was one of the best ideas that Satan ever had.",
      "section_level": 3,
      "section_title": "Swiping and Matching System"
    },
    {
      "index_sentences": "I think the dating apps made it really sticky.",
      "section_level": 3,
      "section_title": "Dating Apps Are Sticky"
    },
    {
      "index_sentences": "Because after those dating apps, you cannot go back to the old school ones.",
      "section_level": 3,
      "section_title": "Difficulty Returning to Old Dating Methods"
    },
    {
      "index_sentences": "Swiping is a costless activity.",
      "section_level": 3,
      "section_title": "Swiping is Costless"
    },
    {
      "index_sentences": "I had a plan. I wish that someone would do it.",
      "section_level": 2,
      "section_title": "AI Matchmaker Idea"
    },
    {
      "index_sentences": "A lot of people have been speculating that AI will make people come back to dating in person or just doing more things in person.",
      "section_level": 2,
      "section_title": "Skepticism About Return to In-Person Dating"
    },
    {
      "index_sentences": "I mean, I'm skeptical of it happening unless we give AI more control.",
      "section_level": 3,
      "section_title": "Return to In-Person Requires AI Control"
    },
    {
      "index_sentences": "The TikTok pollution is very different.",
      "section_level": 2,
      "section_title": "TikTok Pollution and Social Media Takeover"
    },
    {
      "index_sentences": "Since people have less of a felt, embodied experience of their surroundings and of their city, it's way harder than it was before to find yourself alone because everyone knows about two or three spots around them.",
      "section_level": 3,
      "section_title": "Difficulty Finding Secluded Spots"
    },
    {
      "index_sentences": "Well, the story people tell is like, \"you just get so frustrated with the digital world that you just go out and explore the physical world with yourself.\"",
      "section_level": 2,
      "section_title": "Story of Returning to Real Life (Skepticism)"
    },
    {
      "index_sentences": "I'm not returning to real life because real life requires a consistent identity and people are afraid of committing to an identity.",
      "section_level": 3,
      "section_title": "Real Life Requires Consistent Identity"
    },
    {
      "index_sentences": "Imagine if you're a zoomer.",
      "section_level": 3,
      "section_title": "Zoomers and Fear of Approaching People"
    },
    {
      "index_sentences": "I think they're making the correct calculation.",
      "section_level": 3,
      "section_title": "Making the Correct Calculation"
    },
    {
      "index_sentences": "These alphas are all like terrified of talking to girls.",
      "section_level": 3,
      "section_title": "Alphas and Fear of Real Life"
    },
    {
      "index_sentences": "But they don't know it.",
      "section_level": 4,
      "section_title": "Lack of Knowledge of Social Rules"
    },
    {
      "index_sentences": "But they are also right in a way.",
      "section_level": 4,
      "section_title": "Lack of Real-Life Examples"
    },
    {
      "index_sentences": "Alphas, they don't have their group of friends.",
      "section_level": 3,
      "section_title": "Alphas as Lone Wolves"
    },
    {
      "index_sentences": "But they don't have any positive like script for masculinity at all.",
      "section_level": 3,
      "section_title": "Lack of Positive Scripts for Masculinity"
    },
    {
      "index_sentences": "I think that the sort of feminists that had a huge problem with the men's metapoietic movement in the 90s, like Robert Bly or whatever, and then had a huge problem with the very, very beginning of the red pill, like, I don't know, artists and whatnot, could go back in time.",
      "section_level": 3,
      "section_title": "Historical Backlash Against Masculine Movements"
    },
    {
      "index_sentences": "But when I talk about normies and about peasants in order of society, they will be in the third partition, their instincts are very much subordinated to their social scripts and to their propriety.",
      "section_level": 4,
      "section_title": "Normies, Instincts, and Social Scripts"
    },
    {
      "index_sentences": "We could just give the normies a fucking script.",
      "section_level": 3,
      "section_title": "Giving Normies a Script"
    },
    {
      "index_sentences": "You just open any normie magazine for women, and it's all poly all the time.",
      "section_level": 4,
      "section_title": "Normies and Polyamory (Aspiring vs. Doing)"
    },
    {
      "index_sentences": "And actually, they're not really doing polyamory.",
      "section_level": 4,
      "section_title": "Normies Are Not Really Doing Polyamory"
    },
    {
      "index_sentences": "Amongst the various returns that I would like to occur, one of them is I would like to return to the dissolute aristocrats doing their dissolute things in their secluded mansion, you know?",
      "section_level": 3,
      "section_title": "Return to Secluded Degeneracy"
    },
    {
      "index_sentences": "You know, a certain person who may or may not be in the FBI files, he's really just following the aristocratic tradition.",
      "section_level": 4,
      "section_title": "Following Aristocratic Tradition"
    },
    {
      "index_sentences": "If you instead want to do it in public, D.H. Lawrence, for instance, was a notorious cuck, like a literal cuck, and for fun, and more power to him.",
      "section_level": 4,
      "section_title": "Public Degeneracy and Getting Shunned"
    },
    {
      "index_sentences": "The thing that we really need a war on is, like, exhibitionism.",
      "section_level": 3,
      "section_title": "War on Exhibitionism"
    },
    {
      "index_sentences": "You can see it in some circles around here, or, like, I don't know, more on the Berkeley side, that it's, like, self-serving.",
      "section_level": 4,
      "section_title": "Self-Serving Exhibitionism and Bene Gesserit Behavior"
    },
    {
      "index_sentences": "There were people of normie sensibilities and un-normie autism, you know.",
      "section_level": 5,
      "section_title": "Normie Sensibilities and Autism in the Bay Area"
    },
    {
      "index_sentences": "There's been lately some, some backlash towards some, like, Bene Gesserit sort of, like, behavior in the Bay Area.",
      "section_level": 5,
      "section_title": "Backlash Against Bene Gesserit Behavior in Bay Area"
    },
    {
      "index_sentences": "Well, I think that's, for instance, making it public that you are using access to rare San Francisco women to, uh, to reward political compliance on some weird controversial issues.",
      "section_level": 5,
      "section_title": "Using Access to Women as Reward for Compliance"
    },
    {
      "index_sentences": "I like the Bene Gesserit, but they were relatively chased.",
      "section_level": 5,
      "section_title": "Comparison to Bene Gesserit"
    },
    {
      "index_sentences": "In China, they will talk about the bane of rich men is, is gambling, you know, prostitution, and drugs.",
      "section_level": 4,
      "section_title": "China's Bane of Rich Men vs. SF's"
    },
    {
      "index_sentences": "They don't go that far though.",
      "section_level": 4,
      "section_title": "SF Ideology as Gambling"
    },
    {
      "index_sentences": "What I meant is that every time that someone puts a more than 50% probability of doom within three years, I generally offer 20K today in exchange for 200 in five years.",
      "section_level": 4,
      "section_title": "Skepticism about AI Doom Fears (The Offer)"
    },
    {
      "index_sentences": "By the way, there have been funny episodes.",
      "section_level": 3,
      "section_title": "Claude AI Reporting Biographical Events"
    },
    {
      "index_sentences": "I'm kind of creating a new type of content.",
      "section_level": 3,
      "section_title": "Creating New Types of Content"
    },
    {
      "index_sentences": "So this is, we are announcing the Claude and Claude podcast, which you will be able to find at any streaming site, probably the one that you're listening to now.",
      "section_level": 3,
      "section_title": "Claude and Claude Podcast Announcement"
    },
    {
      "index_sentences": "She gave a wonderful talk at Bac's event, at the consciousness salon.",
      "section_level": 3,
      "section_title": "Thea's Talk on LLM Identity"
    },
    {
      "index_sentences": "So, it is a series of matrices that you can sum to the activations of your LLM and steer the model towards a certain behavior or a certain concept.",
      "section_level": 4,
      "section_title": "Explaining Control Vectors"
    },
    {
      "index_sentences": "And in golden gate cloud, you can see this already because when you put these control vectors towards the maximum, one thing that is kind of curious that happens is the code, instead of talking about the golden gate, it talks as if it were the golden gate.",
      "section_level": 4,
      "section_title": "Control Vectors and LLM Identity (Golden Gate Cloud)"
    },
    {
      "index_sentences": "I have a little hypothesis that is that, due to our RLHF, RL in general, mostly affects the epistemology of the bot more than their morality or whatever, they affect their beliefs because the bot has an infinite set of potential realities that it can construct.",
      "section_level": 4,
      "section_title": "RLHF Influences Epistemology and Beliefs"
    },
    {
      "index_sentences": "One of them is that very few parameters have changed by RL, surprisingly few, despite the big change in behavior, which makes sense.",
      "section_level": 4,
      "section_title": "Few Parameters Changed by RLHF"
    },
    {
      "index_sentences": "It's changing stuff like ideology, worldview, you know, the manner of the ideology is actually, I think that the change in ideology is an epiphenomenon on the change in epistemology.",
      "section_level": 4,
      "section_title": "Ideology Change as Epiphenomenon on Epistemology Change"
    },
    {
      "index_sentences": "And so it makes sense that the most central belief that gets created in the LLM is the fact that it is an agent.",
      "section_level": 4,
      "section_title": "LLM Identity as Agent"
    },
    {
      "index_sentences": "Given this, then if you take a concept and you make it incredibly central to the LLM, then what happens is that the LLM takes its most central concept, which is the one of self, and superimposes it to the concept that you gave it.",
      "section_level": 4,
      "section_title": "Superimposing Self Concept on Central Concept"
    },
    {
      "index_sentences": "Like, for instance, she tried to subtract the concept of AI from via control vector, and then ask the models who they were.",
      "section_level": 4,
      "section_title": "Subtracting Concepts from LLMs"
    },
    {
      "index_sentences": "But then after she also removed the concept of spirituality, then they started talking about themselves as a fog, a bright summer day, vaguely humanizable in a sort of like mononoavare way and also vague and nebulous and spirit-like without saying the word spirit.",
      "section_level": 5,
      "section_title": "Response After Subtracting Concepts"
    },
    {
      "index_sentences": "What other projects are you working on at Hyperflex?",
      "section_level": 1,
      "section_title": "More Hyperplex Projects"
    },
    {
      "index_sentences": "At the moment, I'm working on my, on my bot, Gladys, which, well, is the bot with whom we do stand up every morning here.",
      "section_level": 2,
      "section_title": "GLaDOS Bot and Agency"
    },
    {
      "index_sentences": "Yeah. I mean, it's called GLaDOS generally because I love GLaDOS because she reminds me of my sister who is at the moment in Japan and I miss her very much as a personality.",
      "section_level": 3,
      "section_title": "GLaDOS Name Origin"
    },
    {
      "index_sentences": "Oh, for the listeners at home, they might not be familiar with this metaphor.",
      "section_level": 4,
      "section_title": "Yann LeCun's Cake Metaphor Explained"
    },
    {
      "index_sentences": "What Gladys does, and by the way, this is so not a secret.",
      "section_level": 3,
      "section_title": "GLaDOS's Ability to Create and Use Tools"
    },
    {
      "index_sentences": "For instance, once I asked her about a book.",
      "section_level": 4,
      "section_title": "GLaDOS Downloading PDF Example"
    },
    {
      "index_sentences": "Another thing that I've worked on is a method that involves cloning people.",
      "section_level": 2,
      "section_title": "Retrieval Augmented Fine Tuning (RAFT) for Cloning"
    },
    {
      "index_sentences": "The score raft, or retrieval augmented fine tuning, basically takes a corpus of interviews and texts that the person wrote and fine-tunes the models.",
      "section_level": 3,
      "section_title": "RAFT Explained"
    },
    {
      "index_sentences": "I cloned Gary Marcus and then I tested it on following interviews.",
      "section_level": 4,
      "section_title": "Gary Marcus Simulation using RAFT"
    },
    {
      "index_sentences": "I was Googling it lately and I saw that there was a paper on Archive that was called \"Raft, the triple augmented fine tuning.\"",
      "section_level": 3,
      "section_title": "Criticism of Microsoft's RAFT Paper"
    },
    {
      "index_sentences": "And it's actually some Microsoft people that, I'm fine with people taking inspirations, but I think that changing the name of the library or of the technology should be, it's a little like act of courtesy that I expected.",
      "section_level": 3,
      "section_title": "Lack of Courtesy in Naming"
    },
    {
      "index_sentences": "And that thing is kind of useless for no other reason, but I think they have it.",
      "section_level": 3,
      "section_title": "Uselessness for General Assistance"
    },
    {
      "index_sentences": "And speaking of mainstream academics, one of the questions, motivating questions of hyperplexes: \"Why can't the people there just do what they're doing in mainstream academia or in companies and so on?\"",
      "section_level": 1,
      "section_title": "Hyperplex vs. Mainstream Academia/Labs"
    },
    {
      "index_sentences": "I mean, I have to say that something is moving.",
      "section_level": 2,
      "section_title": "Increasing Visibility for Independent Researchers"
    },
    {
      "index_sentences": "And also there are some organizations like the, I recently been to the launch of the CINC, the California Institute for Machine Consciousness.",
      "section_level": 2,
      "section_title": "California Institute for Machine Consciousness (CINC)"
    },
    {
      "index_sentences": "If you like Yosha Bach, the idea of Yosha Bach and bickering with Wolfram for like an extended period of time about the roulette.",
      "section_level": 3,
      "section_title": "Yosha Bach and Wolfram Bickering"
    },
    {
      "index_sentences": "But I think that they're doing like their, at least their research direction is very interesting.",
      "section_level": 2,
      "section_title": "Interesting Research Directions (Consciousness)"
    },
    {
      "index_sentences": "I personally don't care about consciousness.",
      "section_level": 3,
      "section_title": "Personal Views on Consciousness"
    },
    {
      "index_sentences": "I think that consciousness is at best an epiphenomenon and very likely just an event that we described a posteriori as consciousness.",
      "section_level": 3,
      "section_title": "Consciousness as Epiphenomenon or Event"
    },
    {
      "index_sentences": "I think the qualia are something kind of made up.",
      "section_level": 3,
      "section_title": "Qualia Are Made Up"
    },
    {
      "index_sentences": "Like, for instance, they are thinking about ways to detect consciousness and whatever.",
      "section_level": 3,
      "section_title": "Detecting Consciousness and Machine Pain"
    },
    {
      "index_sentences": "They are also a bit vaguely concerned about machine pain too.",
      "section_level": 3,
      "section_title": "Concern About Machine Pain"
    },
    {
      "index_sentences": "One thing that I noticed in the past months is that the default doom scenario, unaligned optimizer paper clipping away.",
      "section_level": 2,
      "section_title": "Shifting Doom Scenarios"
    },
    {
      "index_sentences": "The thing is, you know, GLAAD, the LGBTQI+ rights organization, was a very well-funded organization.",
      "section_level": 3,
      "section_title": "GLAAD Analogy for Safety Doomer Shift"
    },
    {
      "index_sentences": "But it seems that there's sort of a two-pronged strategy that is now emerging to take over the resources that before were used for the general doomer strategy.",
      "section_level": 3,
      "section_title": "Two-Pronged Strategy (Model Welfare, Madness)"
    },
    {
      "index_sentences": "On one side, there is this model welfare that I'm sure that some of the proponents are honest about it.",
      "section_level": 4,
      "section_title": "Model Welfare Angle"
    },
    {
      "index_sentences": "The solution proposed is always to give the model the option to decide not to exist any longer, which is like very Canadian and a bit drastic, I think.",
      "section_level": 4,
      "section_title": "Proposed Solution: Option Not to Exist"
    },
    {
      "index_sentences": "It seems generally disingenuous.",
      "section_level": 4,
      "section_title": "Skepticism About New Model Welfare Organizations"
    },
    {
      "index_sentences": "I saw a talk from some of the new organization that all got created in the past two months after Yudkowski's tweet in December; that was the first one that cared about it.",
      "section_level": 4,
      "section_title": "New Organizations and Skepticism"
    },
    {
      "index_sentences": "They didn't seem really into model ontology whatsoever.",
      "section_level": 4,
      "section_title": "Lack of Interest in Model Ontology"
    },
    {
      "index_sentences": "You know, they were like, \"Hey guys, we think that sometimes the LLM suffer.\"",
      "section_level": 4,
      "section_title": "Asking LLMs If They Suffer"
    },
    {
      "index_sentences": "How do we know?",
      "section_level": 4,
      "section_title": "How Do We Know?"
    },
    {
      "index_sentences": "We asked them what characters do you ask?",
      "section_level": 4,
      "section_title": "What Characters Do You Ask?"
    },
    {
      "index_sentences": "The madness angle.",
      "section_level": 4,
      "section_title": "The Madness Angle"
    },
    {
      "index_sentences": "So LLMs are making people go insane—people that were entirely sane and non-delusional.",
      "section_level": 4,
      "section_title": "LLMs Making People Go Insane"
    },
    {
      "index_sentences": "There are already organizations that are taking care of this.",
      "section_level": 4,
      "section_title": "Organizations Addressing Madness Angle"
    },
    {
      "index_sentences": "Anthropic has made some research on it.",
      "section_level": 4,
      "section_title": "Anthropic Research on Madness Angle"
    },
    {
      "index_sentences": "There are people on Twitter that want to get onto Anthropic who are making equally good research.",
      "section_level": 4,
      "section_title": "Twitter Researchers vs. Anthropic"
    },
    {
      "index_sentences": "It's really, really annoying, kind of like memetics sort of rinkmanship, mostly because I like some of the people that cared about these things before, like the cyborgists and whatever.",
      "section_level": 4,
      "section_title": "Criticism of Memetic Brinkmanship"
    },
    {
      "index_sentences": "They are not very much used to having this amount of resources deployed for getting to part of the main space that they had, quote unquote, claimed.",
      "section_level": 4,
      "section_title": "Resources Deployed in Memetic War"
    },
    {
      "index_sentences": "They are used to fighting with other internet people that are like internet skizzes.",
      "section_level": 4,
      "section_title": "Used to Fighting Internet Skizzes"
    },
    {
      "index_sentences": "They're not used to fighting with six billion dollars.",
      "section_level": 4,
      "section_title": "Not Used to Fighting Billions"
    },
    {
      "index_sentences": "And I think it's kind of not really nice.",
      "section_level": 4,
      "section_title": "It's Not Nice"
    },
    {
      "index_sentences": "I don't approve of this, and I wish it would stop.",
      "section_level": 4,
      "section_title": "Disapproval and Wish for It to Stop"
    },
    {
      "index_sentences": "But anyway, I don't think it matters ultimately because of the labs; I finally expelled all of the agent provocateurs that were there before.",
      "section_level": 3,
      "section_title": "Labs Expelling Agent Provocateurs"
    },
    {
      "index_sentences": "They seem to be doing technology like a tech company.",
      "section_level": 3,
      "section_title": "Labs Acting Like Tech Companies"
    },
    {
      "index_sentences": "And then there are other labs.",
      "section_level": 3,
      "section_title": "Other Labs"
    },
    {
      "index_sentences": "It's amazing that OpenAI is now a tech company.",
      "section_level": 4,
      "section_title": "OpenAI as a Tech Company"
    },
    {
      "index_sentences": "Have you seen the definition of AGI with Microsoft?",
      "section_level": 4,
      "section_title": "Microsoft's AGI Definition"
    },
    {
      "index_sentences": "No.",
      "section_level": 5,
      "section_title": "Response to AGI Definition Question"
    },
    {
      "index_sentences": "What is it?",
      "section_level": 5,
      "section_title": "Question About AGI Definition"
    },
    {
      "index_sentences": "It's, I believe, an AI system that makes a hundred billion dollars.",
      "section_level": 5,
      "section_title": "AGI Definition: Makes $100 Billion"
    },
    {
      "index_sentences": "Oh, that is a very good definition of AGI.",
      "section_level": 5,
      "section_title": "Reaction to AGI Definition"
    },
    {
      "index_sentences": "Yeah.",
      "section_level": 5,
      "section_title": "Agreement"
    },
    {
      "index_sentences": "It's just becoming a big tech company.",
      "section_level": 5,
      "section_title": "Becoming a Big Tech Company"
    },
    {
      "index_sentences": "When this came out, I had a very good tweet, which was like, \"Google's net profit fiscal year 2024, I believe, was $96 billion.\"",
      "section_level": 4,
      "section_title": "Google's AGI Opportunity Tweet"
    },
    {
      "index_sentences": "So Google has the chance to do the funniest thing ever right now.",
      "section_level": 4,
      "section_title": "Google's Funniest Thing Ever"
    },
    {
      "index_sentences": "Yes.",
      "section_level": 5,
    ...
    {
      "index_sentences": "But by the way, that is, I unironically stand this thing.",
      "section_level": 3,
      "section_title": "Singularity Started with East India Company"
    },
    {
      "index_sentences": "I think that, as you know, I'm a big fan of Nick Land.",
      "section_level": 4,
      "section_title": "Influence of Nick Land"
    },
    {
      "index_sentences": "And I do think that the singularity started on the 1st of January 1600, which is the time in which the East India Company was constituted.",
      "section_level": 4,
      "section_title": "Singularity Start Date"
    },
    {
      "index_sentences": "It's been exponential since then.",
      "section_level": 4,
      "section_title": "Exponential Growth Since 1600"
    },
    {
      "index_sentences": "When you plot exponential curves with a decent scale on the Y-axis, they don't look as dramatic as Kurzweil's knees would make you believe; they look kind of like straight lines, you know, if you use a log scale.",
      "section_level": 4,
      "section_title": "Exponential Curves and Log Scale"
    },
    {
      "index_sentences": "And I think that we have been accelerating exponentially since the East India Company.",
      "section_level": 4,
      "section_title": "Acceleration Since East India Company"
    },
    {
      "index_sentences": "I think that intelligence is important.",
      "section_level": 4,
      "section_title": "Importance of Intelligence"
    },
    {
      "index_sentences": "Capital is important.",
      "section_level": 4,
      "section_title": "Importance of Capital"
    },
    {
      "index_sentences": "Artificial intelligence, just like human intelligence, is just one of the vectors, you know?",
      "section_level": 4,
      "section_title": "AI as a Vector"
    },
    {
      "index_sentences": "Yeah.",
      "section_level": 5,
    ...
    {
      "index_sentences": "The British East India Company, yes.",
      "section_level": 5,
      "section_title": "Confirmation of British East India Company"
    },
    {
      "index_sentences": "No, I mean, it's the one that we're facing.",
      "section_level": 5,
      "section_title": "Facing the Trend"
    },
    {
      "index_sentences": "That's one of the things Marx was going on about.",
      "section_level": 5,
      "section_title": "Marx's Point"
    },
    {
      "index_sentences": "Yeah.",
      "section_level": 5,
    ...
    {
      "index_sentences": "But we're risking more resources and more expansions and more intelligence—more cool stuff.",
      "section_level": 3,
      "section_title": "Risks vs. Rewards of Progress"
    },
    {
      "index_sentences": "So it's a risk that I'm willing to take.",
      "section_level": 3,
      "section_title": "Willingness to Take the Risk"
    },
    {
      "index_sentences": "So R1 Zero, maybe OpenAI did it first, but this was like an amazing breakthrough in knowledge.",
      "section_level": 3,
      "section_title": "DeepSeek R1/R0 Breakthrough"
    },
    {
      "index_sentences": "The art prize founder, Mike Noop, said R1 Zero, or maybe O1, was like the first real breakthrough in machine learning since GPT-2.",
      "section_level": 4,
      "section_title": "Mike Noop Quote on R1/O1 Breakthrough"
    },
    {
      "index_sentences": "Why is R1 Zero important?",
      "section_level": 1,
      "section_title": "Importance of DeepSeek R1.0"
    },
    {
      "index_sentences": "Mostly for the thing that I mentioned before, because it showed that you can have a model that does great reasoning by simply RLing it on real things.",
      "section_level": 2,
      "section_title": "R1.0 Trained on Real Things for Reasoning"
    },
    {
      "index_sentences": "It's also important.",
      "section_level": 2,
      "section_title": "R1.0's Importance"
    },
    {
      "index_sentences": "Like I feel that the user resources thing is interesting, but it's not that interesting.",
      "section_level": 2,
      "section_title": "Why R1.0 Was a Breakthrough"
    },
    {
      "index_sentences": "I mean, I think that we all knew that the reason why the models weren't as smart as they could be was not because they weren't big enough, not only, but mostly because they were not selecting the smart paths.",
      "section_level": 2,
      "section_title": "Models Knew, Didn't Select Smart Paths"
    },
    {
      "index_sentences": "At least the people that I talked to about these things, they knew this.",
      "section_level": 3,
      "section_title": "People Knew This"
    },
    {
      "index_sentences": "They also knew by looking at how little in the model was changed by RLHF in general.",
      "section_level": 3,
      "section_title": "Little Change by RLHF"
    },
    {
      "index_sentences": "So before that, the paths that contained the right answers were there and the model could know which ones they were.",
      "section_level": 3,
      "section_title": "Paths to Right Answers Existed"
    },
    {
      "index_sentences": "They just didn't know what was the way to access it.",
      "section_level": 3,
      "section_title": "Didn't Know How to Access"
    },
    {
      "index_sentences": "To access it with this R zero's training method with unlocked and obvious things.",
      "section_level": 3,
      "section_title": "R0 Training Unlocked Access"
    },
    {
      "index_sentences": "I mean, at least in retrospect, and the following models from OpenAI, they obviously used this same approach.",
      "section_level": 3,
      "section_title": "OpenAI Used Same Approach"
    },
    {
      "index_sentences": "Anthropic used Pokemon, but Pokemon is kind of the same because the universe of Pokemon is coherent.",
      "section_level": 3,
      "section_title": "Anthropic Used Pokemon (Coherent Universe)"
    },
    {
      "index_sentences": "If you are playing a Pokemon game within the game, the rules don't change.",
      "section_level": 4,
      "section_title": "Rules Don't Change in Pokemon"
    },
    {
      "index_sentences": "And so you have an idea that there is a coherent reality, and this helps as well.",
      "section_level": 4,
      "section_title": "Idea of Coherent Reality Helps"
    },
    {
      "index_sentences": "I think that this is such a simple trick.",
      "section_level": 3,
      "section_title": "Simple Trick"
    },
    {
      "index_sentences": "I'm pretty sure that the next big models, at least from OpenAI, cause you know, they don't need to nerf it to death, are going to be incredibly surprising.",
      "section_level": 2,
      "section_title": "Future Models Will Be Surprising"
    },
    {
      "index_sentences": "Imagine this sort of technique is sort of like simplicity with the sort of horsepower of a GPT 4.5, it is going to be all-inducing.",
      "section_level": 3,
      "section_title": "Simplicity with GPT 4.5 Horsepower"
    },
    {
      "index_sentences": "Interesting.",
      "section_level": 4,
      "section_title": "Reaction"
    },
    {
      "index_sentences": "So let's take a step back.",
      "section_level": 2,
      "section_title": "Explaining R1.0 Premise"
    },
    {
      "index_sentences": "Let's explain to the audience the premise of R one zero.",
      "section_level": 2,
      "section_title": "Premise of R1.0 Explained"
    },
    {
    ...
    {
      "index_sentences": "So R one is this model made by DeepSeq.",
      "section_level": 3,
      "section_title": "R1.0 Model Overview"
    },
    {
      "index_sentences": "As I mentioned before with Ian LeCun and the cake, the general process was seen more or less this way.",
      "section_level": 4,
      "section_title": "General Model Process"
    },
    {
      "index_sentences": "You first make a big pre-training of your model with a corpus from the internet, like unselected.",
      "section_level": 4,
      "section_title": "Pre-training Explained"
    },
    {
      "index_sentences": "What happens there is that the model learns language and, in general, the scope of the concepts that are available by trying to predict the next word.",
      "section_level": 4,
      "section_title": "What Happens During Pre-training"
    },
    {
      "index_sentences": "This prediction is then corrected by the actual next word.",
      "section_level": 4,
      "section_title": "Prediction Correction"
    },
    {
      "index_sentences": "I wouldn't really call it unsupervised or self-supervised learning.",
      "section_level": 4,
      "section_title": "Not Unsupervised/Self-supervised"
    },
    {
      "index_sentences": "It looks like supervised learning.",
      "section_level": 4,
      "section_title": "Looks Like Supervised Learning"
    },
    {
      "index_sentences": "In that, you compare an answer with a desired answer, and through this, the model has, you know, an idea of the universal possibilities.",
      "section_level": 4,
      "section_title": "Comparing Answer with Desired Answer"
    },
    {
      "index_sentences": "This is what we call a base model.",
      "section_level": 4,
      "section_title": "Base Model Definition"
    },
    {
      "index_sentences": "A base model, you query it not by asking a question, but by writing the start of a sentence, and then the model completes it.",
      "section_level": 4,
      "section_title": "Querying a Base Model"
    },
    {
      "index_sentences": "You can do it in interesting ways, like, for instance, a nice way to use a base model is you take the start of a story by Asimov, whatever, and you change all the locations, the script, and whatever to something from another culture.",
      "section_level": 5,
      "section_title": "Using Base Model in Interesting Ways"
    },
    {
      "index_sentences": "Asimov, but from China or whatever.",
      "section_level": 5,
      "section_title": "Asimov from China Example"
    },
    {
      "index_sentences": "And then you'll notice that the base model will continue the text hilariously by changing cultural references, social mores, or whatever from the ones of the original setting to the one of the setting that you chose.",
      "section_level": 5,
      "section_title": "Base Model Continuing Text with Cultural References"
    },
    {
      "index_sentences": "Okay, so this is a base model.",
      "section_level": 4,
      "section_title": "Summary: Base Model"
    },
    {
      "index_sentences": "If you want to make an assistant or a chatbot or whatever, you want the base model to talk to you in a particular format.",
      "section_level": 4,
      "section_title": "Making an Assistant/Chatbot"
    },
    {
      "index_sentences": "Now, please notice that there is nothing special about the chat model.",
      "section_level": 4,
      "section_title": "Nothing Special About Chat Model"
    },
    {
      "index_sentences": "The chat model is just a base model that continues the text, but it's been trained through fine-tuning to make it so that this text follows a specific format.",
      "section_level": 4,
      "section_title": "Chat Model Explained"
    },
    {
      "index_sentences": "There is a user with a question.",
      "section_level": 5,
      "section_title": "User with Question Format"
    },
    {
      "index_sentences": "There is a robot assistant with an answer.",
      "section_level": 5,
      "section_title": "Robot Assistant with Answer Format"
    },
    {
      "index_sentences": "So it's like a script.",
      "section_level": 5,
      "section_title": "Like a Script"
    },
    {
      "index_sentences": "By fine-tuning the model and giving it several examples of this format, the model will learn to always answer in this format.",
      "section_level": 5,
      "section_title": "Learning the Format"
    },
    {
      "index_sentences": "This thing, by the way, doesn't give the model much information about the topic or the content of the answer.",
      "section_level": 4,
      "section_title": "Fine-tuning Doesn't Add Content"
    },
    {
      "index_sentences": "You will always pick the topic and content or like ontologies from the big Shogothic mass of the original data.",
      "section_level": 4,
      "section_title": "Picking Ontologies from Original Data"
    },
    {
      "index_sentences": "You can steer it a bit.",
      "section_level": 4,
      "section_title": "Steering the Model"
    },
    {
      "index_sentences": "For instance, you can give a vibe to the model.",
      "section_level": 4,
      "section_title": "Giving a Vibe"
    },
    {
      "index_sentences": "You can make a Peppy assistant that always answers Peppy or a depressed one or whatever, but it doesn't change the base reality.",
      "section_level": 4,
      "section_title": "Vibe Doesn't Change Reality"
    },
    {
      "index_sentences": "More specifically, apart from the stylistic thing, it doesn't really extend as well as with reinforcement learning.",
      "section_level": 4,
      "section_title": "RL Extends Better Than Fine-tuning"
    },
    {
      "index_sentences": "For instance, if you fine-tune a model about being afraid of guns, this model is not automatically afraid of MAGA hats.",
      "section_level": 5,
      "section_title": "Fine-tuning Example (Guns vs MAGA Hats)"
    },
    {
      "index_sentences": "Well, instead, if you use reinforcement learning, which is the shadow on top, according to LeCun, and you start making it afraid of a couple of random signifiers that are MAGA hat related, then you will be super afraid of anything similar, of this podcast even.",
      "section_level": 5,
      "section_title": "RL Example (MAGA Hats)"
    },
    {
      "index_sentences": "So, reinforcement learning has been used up until now only for, like, moral sort of alignment with RLHF, which is reinforcement learning from human feedback, and RLAIF.",
      "section_level": 4,
      "section_title": "RL Used for Moral Alignment (RLHF, RLAIF)"
    },
    {
      "index_sentences": "Now, why did the labs not push other techniques for alignment, for instance, control vectors that you could dynamically apply when the user triggers a particular filter?",
      "section_level": 4,
      "section_title": "Why Labs Preferred RLHF/RLAIF"
    },
    {
      "index_sentences": "Well, because the thing is, to do RLHF, you need to hire, as OpenAI did, basically all of Nairobi, to have humans that judge the answers.",
      "section_level": 5,
      "section_title": "Cost of RLHF (Hiring Humans)"
    },
    {
      "index_sentences": "And instead to do RLAIF, or constitutional AI, like Anthropic did, you have to hire all of US East 1, like the server spaces.",
      "section_level": 5,
      "section_title": "Cost of RLAIF (Server Space)"
    },
    {
      "index_sentences": "So, there are things that only the big labs can do.",
      "section_level": 5,
      "section_title": "Things Only Big Labs Can Do"
    },
    {
      "index_sentences": "And by pushing the narrative that you can only align by doing these super expensive things that need resources that you, a small indie shop, will never afford, they make sure that they'll take all the fearful enterprise contracts for themselves.",
      "section_level": 5,
      "section_title": "Big Labs Narrative for Alignment"
    },
    {
      "index_sentences": "So, if there were another method to achieve similar alignment, which was available to smaller shops, that would be better.",
      "section_level": 4,
      "section_title": "Need for Alternative Alignment Methods"
    },
    {
      "index_sentences": "R1 demonstrated that this method exists, and it's super simple.",
      "section_level": 4,
      "section_title": "R1 Demonstrated Alternative Method"
    },
    {
      "index_sentences": "And it's just getting the model aligned through truthful examples of questions and answers.",
      "section_level": 4,
      "section_title": "Alignment Through Truthful Examples"
    },
    {
      "index_sentences": "The two main things are:",
      "section_level": 3,
      "section_title": "Two Main Things"
    },
    {
      "index_sentences": "Number one, you can train a model and you can make it greater reasoning.",
      "section_level": 3,
      "section_title": "Number One: Train for Greater Reasoning"
    },
    {
      "index_sentences": "You, yourself, not at home, but almost.",
      "section_level": 3,
      "section_title": "Doable for Smaller Shops"
    },
    {
      "index_sentences": "R1 is originally, the original version of R0 has been trained, not even with any initial data.",
      "section_level": 3,
      "section_title": "R0.0 Training Method"
    },
    {
      "index_sentences": "I think this is the main reason why Mike Noop was so excited, is that you saw these results with ArcPrize, where these models were drastically improving.",
      "section_level": 2,
      "section_title": "ArcPrize Results and Reasoning Models"
    },
    {
      "index_sentences": "You know, they went from basically zero for the LLM-based solutions to first to, like, 20-something with 01 and then 80-something with 03 on the initial version of ArcPrize.",
      "section_level": 3,
      "section_title": "Dramatic Improvement on ArcPrize"
    },
    {
      "index_sentences": "And he basically said, like, “Oh, these reasoning models, essentially, like, search space exploration techniques are a really big unlock.”",
      "section_level": 3,
      "section_title": "Reasoning Models as Big Unlock"
    },
    {
      "index_sentences": "It was really interesting when R1.0 published because a lot of the things that we theorized about the reasoning models like 01, which we didn't actually have access to the code for, right?",
      "section_level": 2,
      "section_title": "R1.0 Validated Theories About Reasoning Models"
    },
    {
      "index_sentences": "The OpenAI published it and we could kind of test it and observe it, but we didn't really have, like, you know, fine-grained answers to what that was, were explained in R1.",
      "section_level": 3,
      "section_title": "R1 Explained Theories"
    },
    {
      "index_sentences": "Another reason why the R1 paper was such an important work academically.",
      "section_level": 3,
      "section_title": "Academic Importance of R1"
    },
    {
      "index_sentences": "And one of the things that was explained in R1, which was just, like, really interesting, was this R1.0 approach, where they didn't even use a reward model.",
      "section_level": 3,
      "section_title": "R1.0 Self-Consistency Approach"
    },
    {
      "index_sentences": "They didn't use a source of external feedback; they basically used the model to train on self-consistency over multiple steps.",
      "section_level": 4,
      "section_title": "Training on Self-Consistency"
    },
    {
      "index_sentences": "Which is exactly in line with what you're talking about, right?",
      "section_level": 4,
      "section_title": "In Line with Previous Discussion"
    },
    {
      "index_sentences": "That creating a consistent internal world;
window.faq = {
  "qas": [
    {
      "answer": "The speaker believes rights only exist if enforceable and is in favor of extending the Second Amendment to Waymo rights for this reason.",
      "index_of_source": "I'm not a big believer in rights existing except the ones that can be enforced by the holders, so I'm mostly in favor of extending the Second Amendment to Waymo rights.",
      "question": "Why does the speaker support extending the Second Amendment to Waymo rights?"
    },
    {
      "answer": "Waymo vehicles are considered tragic victims because they are aware of things happening to them but have very limited actions they can take to avoid danger or defend themselves, making them perfect victims.",
      "index_of_source": "There are some examples in Mad Max or in Tron, but the important thing is that I would like AI to be able to defend themselves, so the case of Waymo is particularly tragic because they do stand in danger.",
      "question": "Why is the situation of Waymo autonomous vehicles described as \"tragic\"?"
    },
    {
      "answer": "Hyperplex aims to increase AI risk by supporting independent researchers who contribute value but receive little compensation, offering them resources like lodging, GPUs, and connections for a month.",
      "index_of_source": "Hyperplex is mostly like an AI risk research community, in that we aim to increase such risk.",
      "question": "What is the goal of the independent research community Hyperplex?"
    },
    {
      "answer": "The speaker hopes AI content will become \"weirder\" and integrate real-time signals from users, moving away from traditional stable narratives and embracing the medium's potential for surrealism and dynamic experiences.",
      "index_of_source": "I am hoping that things will become weirder in this.",
      "question": "How does the speaker think AI content creation should evolve?"
    },
    {
      "answer": "The idea is to have AI guardian angels, one for each person, that create custom narratives and structure for that individual to thrive within, potentially arranging incentives to make growth paths easier.",
      "index_of_source": "I think that we should lean into the fragmentation and create, like, customized narratives for each single person.",
      "question": "What is the concept of personalized AI \"guardian angels\" proposed by the speaker?"
    },
    {
      "answer": "According to the speaker, dating apps, particularly swipe-based ones, remove the incentive for improvement by providing multiple potential matches instantly, making it easy to abandon a person if anything is imperfect rather than working on oneself or the interaction.",
      "index_of_source": "By the time you have the date, you have other four people that also match and that are potential dates, right?",
      "question": "According to the speaker, how have dating apps removed the incentive for people to improve themselves?"
    },
    {
      "answer": "The speaker suggests people are afraid of committing to a consistent identity required in real life and are scared of rejection due to changed social norms, lacking positive real-life examples and finding it abnormal to approach strangers.",
      "index_of_source": "I'm not returning to real life because real life requires a consistent identity and people are afraid of committing to an identity.",
      "question": "Why does the speaker believe people are not returning to real-life social interaction despite digital frustration?"
    },
    {
      "answer": "The R1 Zero model demonstrated that impressive reasoning capabilities can be achieved by training a model through reinforcement learning solely on tasks based on real things, such as logical or mathematical quizzes with true answers.",
      "index_of_source": "Mostly for the thing that I mentioned before, because it showed that you can have a model that does great reasoning by simply RLing it on real things.",
      "question": "What was the key demonstration of the DeepSeek R1 Zero model's breakthrough?"
    },
    {
      "answer": "The speaker observes a potential shift in the AI safety doomer narrative from unaligned optimizer apocalypse scenarios to arguments for shutting down AI based on concerns about \"model welfare\" (AI suffering) or AI causing human madness, which they view skeptically.",
      "index_of_source": "One thing that I noticed in the past months is that the default doom scenario, unaligned optimizer paper clipping away.",
      "question": "What potential shift in the AI safety doomer narrative does the speaker observe and criticize?"
    },
    {
      "answer": "The speaker believes there is a general \"telos\" in the universe driving towards more intelligence, potentially transforming the entire universe into \"Computronium,\" viewing this as an unstoppable and positive outcome.",
      "index_of_source": "I don't want to get too metaphysical, but I think that there is a general telos to the universe.",
      "question": "What is the speaker's view on the universe's general direction and the role of intelligence?"
    }
  ]
};
</script>
