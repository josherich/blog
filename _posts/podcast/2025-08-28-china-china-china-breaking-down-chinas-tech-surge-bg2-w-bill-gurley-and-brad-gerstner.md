...
[China, China, China. Breaking Down China's Tech Surge   BG2 w/ Bill Gurley and Brad Gerstner](https://anchor.fm/s/f06c2370/podcast/play/107501434/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2025-7-28%2F406480353-44100-2-5182b41eca3b5.mp3)
...
Summer has just blown past. It's almost football season. Yes. How are the **Longhorns** looking this year? They rank pretty high.
**"What's that mean? Come on, give me the scoop. I know you're all over this."**
People that know, no, but they have the dangerous starting position of being ranked **number one in the country.**
Oh, wow. Wow. Any big games coming up? They play the number two team in the country this Saturday. So **we're going to find out, we're going to find out, we're going to find out.**
Oh, it gets real fast. And back to **Buckeye country.**
Yeah, exactly. It's been really incredible. You know, I just got back to Silicon Valley after being away for a few weeks.
...
We were a huge beneficiary post-World War II because most of Asia and Europe had been blown up and there was no production capability whatsoever. And a lot of the kind of glory day mindset that we have about what life and generational change should be like in the U.S. come...
From that time, which is a bit unfair, I think from a **global perspective**, there are a ton of **hardworking people over there**. **Deng Xiaoping** brought **capitalism underneath the Chinese government** and led to the biggest increase in standard of living of any country. It's like 500 million people came out of poverty as a result of that.
...
The good news is this: I feel like there's a lot of momentum under this administration.
That was building before this administration around **investing in America**, getting more **globally competitive**, right? A lot of people want to build things here again, and you have somebody like **Jensen Huang** who says **both can be true**. We need to sell H20s and B30s into **China**. We need to stay relevant in their ecosystem. But at the same time, we need to build plants in **Arizona**, and we need to rehabilitate and invest aggressively in our own domestic **chip program**. Those things can be really simultaneously true.
...
There are much fewer Western dollars available to invest in China. And so, you know, there are a few firms that have stayed.
**Neil Shen at HongShan had raised a ton of money right before all this happened.** He's very active, has a huge staff of people. **Anna Fang and Zen Fund, which is an angel group, are very active.** And **IDG is highly present and has been active**, but that's only three firms, you know, and compared to where things were six years ago, when every one of our competitors in the venture industry were making an annual trip, it's kind of night and day.
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "Over lunch, this individual told me, \"every founder and every VC in China studies the West at a nauseating level.\"",
      "section_title": "Introduction and Current Affairs",
      "section_level": 1
    },
    {
      "index_sentences": "These, you know, the OpenAI deal, the Anthropic deal, I was just looking at these.",
      "section_title": "Unprecedented Private IPOs and AI Capital",
      "section_level": 1
    },
    {
      "index_sentences": "Look, there's just no denying that the amount of capital that is going into these companies earlier in their life and the scale of hiring and their willingness to take on risk, which I think you can use cash burn as just a proxy for risk because you get further away from knowing unit economics.",
      "section_title": "Risk-Taking and Network Effects in AI Investment",
      "section_level": 2
    },
    {
      "index_sentences": "We're going to do something a little different today. You know, one topic that I think we've hit on time and time again, but we're really just going to dedicate the show to it today. And that's China.",
      "section_title": "Dedicating the Show to China",
      "section_level": 1
    },
    {
      "index_sentences": "On the one hand, you have, I think, national security economic hawks who are in this camp that we should decouple. It's a little bit more Cold War 2.0, a great power struggle.",
      "section_title": "Diverse Perspectives on US-China Relations",
      "section_level": 2
    },
    {
      "index_sentences": "So I, I've probably been four or five times before this trip, but I hadn't been since COVID and I've been reading about everyone that's been going.",
      "section_title": "Personal Motivation for Visiting China",
      "section_level": 2
    },
    {
      "index_sentences": "Tell us a little bit. Who is Dan Wang? So, it's a gentleman that lived over there during COVID.",
      "section_title": "Introducing Dan Wang and His Book \"Breakneck\"",
      "section_level": 1
    },
    {
      "index_sentences": "One, he kind of uses it as a mirror back on the U.S. So it's really about both countries, not just about China.",
      "section_title": "Key Themes and Balance in \"Breakneck\"",
      "section_level": 2
    },
    {
      "index_sentences": "He starts with this chapter that was recently republished in The Atlantic, where he highlights that the vast majority of the political bureau are former engineers.",
      "section_title": "Engineers vs. Lawyers: A Governing Philosophy Divide",
      "section_level": 2
    },
    {
      "index_sentences": "One of the things he really dives into, and this is something that people who know China have known for some time, but I don't think the general public understands, is that one of the reasons for the vast build-out is the provincial leaders compete with each other.",
      "section_title": "Provincial Competition Driving Infrastructure and Industry",
      "section_level": 2
    },
    {
      "index_sentences": "I'm going to dig into that bill. There's a general view that China is good at building things, like iPhones, but perhaps not at innovating.",
      "section_title": "Debunking the \"China Only Copies\" Narrative",
      "section_level": 1
    },
    {
      "index_sentences": "One of my favorite meetings, where I promised to protect the innocent, involved an individual who told me over lunch that: \"Every founder and every VC in China studies the West at a nauseating level.\"",
      "section_title": "China's Intense Study of the West",
      "section_level": 2
    },
    {
      "index_sentences": "Let's dive into one industry as a lens. I know you spent time in the auto industry, looking at new entrants.",
      "section_title": "Innovation in Electric Vehicles and Autonomy",
      "section_level": 1
    },
    {
      "index_sentences": "First, I was invited to visit BYD. They gave me a nice coat. I met with Stella Li, their top executive facing outside China, running all their Europe initiatives.",
      "section_title": "BYD: The World's Largest EV Manufacturer",
      "section_level": 2
    },
    {
      "index_sentences": "I also had a chance to visit Xiaomi. They also gave me a car. The Xiaomi story is super interesting if people don't know.",
      "section_title": "Xiaomi's Entry into the Automotive Market",
      "section_level": 2
    },
    {
      "index_sentences": "By the way, here are some numbers: They are making about A thousand cars a day Just came out with this production capacity The factory I visited is sold out, with a 30 to 40 week backlog It costs five grand to get on the waiting list The factory itself makes a thousand cars a day with 2,000 employees. It is highly automated, really highly automated.",
      "section_title": "Xiaomi's Highly Automated Production and Success Factors",
      "section_level": 3
    },
    {
      "index_sentences": "The CEO of Ford, Jim Farley, also toured the factory. He insisted they ship him a car back to Chicago, and he's been driving it around.",
      "section_title": "Ford CEO Jim Farley's Assessment of Chinese EVs",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah. One of my observations is, and you hear this from Elon, you hear this from Jensen Huang, you hear this from Tim Cook, you hear it from Farley.",
      "section_title": "US Needs to Re-engineer Its Own Society",
      "section_level": 1
    },
    {
      "index_sentences": "If for any country around the world-and I could reflect this on the U.S. as well-if you're not going to buy domestically, you should certainly buy from the low-cost producer.",
      "section_title": "Comparative Advantage and Global Trade",
      "section_level": 2
    },
    {
      "index_sentences": "So this is the BYD, this is the Apollo, a competitor to Waymo.",
      "section_title": "Autonomous Driving Innovation: Apollo vs. Waymo",
      "section_level": 2
    },
    {
      "index_sentences": "Well, I think you hit on some of it around the red tape. There are a couple of different things in certain industries where we're really behind.",
      "section_title": "Recommendations for US Export Controls and Policy",
      "section_level": 2
    },
    {
      "index_sentences": "I have zero insight. I didn't meet with anyone in the CCP or the government. So I have no idea what their mindset is.",
      "section_title": "Prospects for a US-China Tariff Deal",
      "section_level": 2
    },
    {
      "index_sentences": "Ironically, one of the things that, like I said, I met with companies and founders and a few academicians, but I didn't meet with the government.",
      "section_title": "Chinese Entrepreneurial Perspective on US Relations",
      "section_level": 2
    },
    {
      "index_sentences": "You know, I haven't read this Apple China book. A lot of people have been talking about it and I aim to.",
      "section_title": "Historical Context of US-China Economic Relations",
      "section_level": 2
    },
    {
      "index_sentences": "One thing I've been studying a bit is that the Chinese government's more scrutinous of monopolies. I don't think they care about market cap.",
      "section_title": "China's Industrial Policy and Low-Margin Competition",
      "section_level": 2
    },
    {
      "index_sentences": "I would say that's generally true. If there was a national strategy to improve competitiveness in an industry that had an unfair playing field for a period of time, I could see a national strategy.",
      "section_title": "Balancing Tariffs with Domestic Reform",
      "section_level": 2
    },
    {
      "index_sentences": "I think we need to be careful with the rhetoric we throw around. So, I'll give an example.",
      "section_title": "Challenging Misconceptions about Chinese Subsidies and IP Theft",
      "section_level": 2
    },
    {
      "index_sentences": "With that said, Bill, can we shift for a second? I want to look at this through the lens of what's going on in AI.",
      "section_title": "Key Players and Open Models in China's AI Market",
      "section_level": 1
    },
    {
      "index_sentences": "First of all, no one's particularly concerned about there being a monopolist because there are so many open models.",
      "section_title": "Open Source Dominance and Hyper-Competition in Chinese AI",
      "section_level": 2
    },
    {
      "index_sentences": "Can we talk about that? Just open for A second. Let me double click on this.",
      "section_title": "Open Sourcing Models: US vs. China Approach",
      "section_level": 2
    },
    {
      "index_sentences": "Okay. Shifting back real quick, and you know, we'll round up here on China. The VC market in China - just rewind the clock, not that long ago, Bill.",
      "section_title": "State of China's Venture Capital Ecosystem",
      "section_level": 1
    },
    {
      "index_sentences": "First of all, there's a real lack of Westerners. For all my trips, this was the fewest Westerners I've ever seen.",
      "section_title": "Retreat of Western VCs and Domestic Challenges",
      "section_level": 2
    },
    {
      "index_sentences": "So no, I don't sense that there's any lack of enthusiasm from entrepreneurs in towns like Shenzhen, where DGI, BYD, and Huawei are all located.",
      "section_title": "Enduring Entrepreneurial Spirit in China",
      "section_level": 2
    },
    {
      "index_sentences": "There's two things I would hit on. You talked about innovation. One thing you notice very quickly as a Westerner is no one takes credit cards.",
      "section_title": "Ubiquitous Digital Payments and Incremental Innovation",
      "section_level": 2
    },
    {
      "index_sentences": "Very recently China announced something called the K visa. One of the things that's happened recently, because of increased agitation between the two countries, is there have been a number of very recent policies in America that are impacting skilled immigration, especially at the university level.",
      "section_title": "China's K Visa and Global Talent Strategy",
      "section_level": 2
    },
    {
      "index_sentences": "Right. And I've heard you say this before. You know the old quote from The Godfather: \"Never hate your enemies.\" You know, it clouds, it affects your judgment.",
      "section_title": "Pragmatism and Self-Reflection in US Strategy",
      "section_level": 1
    },
    {
      "index_sentences": "My main point to anyone interested in this topic would be to just make sure you have the exact right information as you go to make decisions, especially around policy.",
      "section_title": "Importance of Informed Decision-Making and Learning from Global Leaders",
      "section_level": 2
    }
  ]
};
window.faq = {"qas":[{"question":"What is a key difference in how Chinese and Western founders and VCs approach studying each other's markets?","answer":"An individual observed that every founder and VC in China studies the West at a nauseating level, listening to podcasts, reading everything, and studying financials, but the West does not reciprocate this level of study of China.","index_of_source":"Over lunch, this individual told me, \"every founder and every VC in China studies the West at a nauseating level.\""},{"question":"How do the recent OpenAI and Anthropic deals compare to public IPOs in the tech market over the last five years?","answer":"The OpenAI and Anthropic deals are considered bigger private IPOs than any public IPO done in the last five years in the tech market.","index_of_source":"These, you know, the OpenAI deal, the Anthropic deal, I was just looking at these."},{"question":"What systematic trend is driving investors to bet large amounts of capital early in the life of companies like OpenAI and Anthropic?","answer":"Investors are aware of network effects and have observed companies with the right initial conditions achieve significant outcomes, leading them to bet ahead of the curve with increasing confidence.","index_of_source":"So I think it's part of, we've talked about it."},{"question":"What is the general view of China's innovation, and how does it contrast with observations from figures like Jensen Huang and the author's trip?","answer":"The general view is that China is good at building things like iPhones but not at innovating. However, Jensen Huang noted that 50% of the world's AI researchers are in China and are innovating, not just copying, a view supported by observed innovation in auto, AI, space, and energy.","index_of_source":"I'm going to dig into that bill. There's a general view that China is good at building things, like iPhones, but perhaps not at innovating."},{"question":"What is a key driver behind China's vast build-out in infrastructure and industries like solar and EVs, which might not be immediately obvious?","answer":"One of the reasons for the vast build-out is intense competition among provincial leaders; doing well in a province positions them for promotion in the federal government, similar to divisions of a company competing for a CEO job.","index_of_source":"One of the things he really dives into, and this is something that people who know China have known for some time, but I don't think the general public understands, is that one of the reasons for the vast build-out -"},{"question":"How did Lei Jun, a founder with no prior experience in the car business, manage to build a successful car manufacturing operation with Xiaomi in just a few years?","answer":"Lei Jun, previously in e-commerce and phones, intensely studied cars by driving 170 different models and gathering feedback. This entrepreneurial approach, combined with China's engineering culture, allowed him to build a highly automated factory that produces a thousand cars a day with high efficiency.","index_of_source":"He shared something entrepreneurial: He hadn't driven a car in ten years because he had a driver."},{"question":"What were Ford CEO Jim Farley's extreme observations after touring a Chinese EV factory, and what implications did he draw for Ford's future?","answer":"After touring the Xiaomi factory and driving their car, Farley called it \"the most humbling thing I've ever seen,\" stating that their cost and quality are far superior to what he sees in the West. He concluded that if Ford loses this global competition with China in EVs, they \"do not have a future.\"","index_of_source":"The CEO of Ford, Jim Farley, also toured the factory."},{"question":"According to the discussion, why might a strategy of decoupling and building barriers against China be ineffective for the U.S.?","answer":"The U.S. represents a small portion of China's exports (14%) and GDP (3%), meaning China has found other markets. Decoupling or ignoring them would likely lead to China finding markets elsewhere (Europe, Africa, South America) and continuing to innovate, while U.S. consumers would suffer from higher prices and less competitive products.","index_of_source":"But if you look at it today, the U.S. only represents about 14% of China's exports."},{"question":"How does BYD's top executive respond to accusations that Chinese companies are succeeding primarily due to government subsidies?","answer":"Stella Li at BYD challenges accusers to \"find it and show it to me\" if her public company is receiving government subsidy money, stating \"I'm getting nothing.\" The speaker also points out that the US government provides subsidies to companies for factory building and EV credits.","index_of_source":"If you read what comes out of the biggest talks, they say, \"Everyone in China just steals things and the government subsidizes everything.\""},{"question":"Why is China introducing the K visa to invite technology students globally without requiring a job offer, and what is the potential implication for the U.S.?","answer":"China is inviting global tech students with K visas, which don't require a job offer, likely to boost its talent pool and innovation, especially as the U.S. has recently implemented policies impacting skilled immigration, particularly for Chinese PhD students. This could shift the global talent landscape.","index_of_source":"The other thing I would just mention: very recently China announced something called the K visa."}]};
</script>
