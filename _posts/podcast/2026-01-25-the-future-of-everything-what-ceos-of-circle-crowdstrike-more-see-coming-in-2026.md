...
Regarding interest rates dropping to zero, that could pose challenges. When interest rates were very low previously, we saw a **1000% year-over-year growth** two years ago.
**Straight. So growth was off the charts. When interest rates actually started to rise, we actually saw declines in circulation.**
...
But again, level playing field. If you want to comply and build a product...
Under that **regulatory framework**, you can do that. And I think many people will. This is like when **net neutrality** happened and **common carrier rules** came. Anybody can get into providing data services to the internet. Anyone can build these things. So that's great. And so **free market**, clear rules, love it.
...
We don't have operations there. We don’t have any revenue. We don’t sell to China.
**Never have, never have, from the start of the start of the company.**
...
We're able to do this because those batteries were in electric vehicles — maybe the range was originally 300 miles, now it's 250 miles. The owner trades in the car, considering it done, but there's still a lot of **juice left in those batteries**.
Yeah, of course. There's a lot of useful life in those **batteries**. So we're able to really make use of them in a **second life** to power these **AI data centers**.
...
On our **AI cloud platform** and our **infrastructure as a service platform**, we offer managed clusters of **high performance GPUs** and we're a very large partner with **NVIDIA**. And that's really critical infrastructure for the startups that you're talking about.
...
**Sheldon and his team** are an incredible group of energy developers. They're doing that because they know they need to build the **energy infrastructure** that's going to support their compute needs in the future.
...
window.faq = {
  "qas": [
    {
      "question": "What is the fundamental concept behind stablecoins, and how do they aim to address the historical absence of native money protocols on the internet?",
      "answer": "Stablecoins are envisioned as a foundational infrastructure layer for the internet, similar to how data, media, audio, video, and software are represented. The basic idea is to create a general-purpose, digital form of money, like \"HTTP for dollars,\" that can move peer-to-peer and is programmable. They provide a stable alternative to volatile cryptocurrencies, making it possible to transact with a reliable digital dollar value.",
      "index_of_source": "I mean, look, when I got started working on this almost 13 years ago, Bitcoin had emerged."
    },
    {
      "question": "Why did Circle's CEO, Jeremy Allaire, make the \"buttoned up and proper\" decision to pursue strict regulation and audits in the United States, rather than opting for less-regulated offshore jurisdictions like Zug or Dubai?",
      "answer": "Circle's leadership believed that for stablecoins to become a truly global, internet-native financial system used by businesses and individuals for various financial activities, integration with the existing financial system and collaboration with policymakers were essential. This approach, though harder and more capital-intensive, aimed to build trust with institutions like BlackRock and ensure the reliability of digital dollars for everyday users, in contrast to the more anarcho-libertarian stance of some early crypto adopters.",
      "index_of_source": "Going back to even the founding of the company, when I looked at: if we want to establish a new way to put what we think of as regular money on the internet, and we want to actually build a new internet native financial system that the whole world uses—like actually uses—businesses, are you going to use it?"
    },
    {
      "question": "How do stablecoin issuers like Circle generate revenue and facilitate loyalty or rewards programs for their partners, given that regulations such as the Genius Act prohibit them from paying interest directly to stablecoin holders?",
      "answer": "Under acts like the Genius Act and similar global regulations, stablecoins are designed as cash-like payment instruments, preventing direct interest payments to holders. However, Circle, as a business, generates revenue from the float on its fully reserved assets. It works with platforms, markets, distributors, and brokerages (like Robinhood, Coinbase, Visa) that use stablecoins for payments and trading. These partners, benefiting from their relationship with Circle, can then offer rewards, loyalty programs, or incentives to their own users, a model captured and supported by the Genius Act.",
      "index_of_source": "So the Genius Act does that, but it also, I think, provides."
    },
    {
      "question": "How has the integration of AI transformed cyber threats, particularly through the development of \"autonomous malware,\" and what challenges does this pose for traditional cybersecurity defenses?",
      "answer": "AI has significantly compressed the attack timeline and minted new adversaries by allowing individuals with less technical knowledge to execute sophisticated attacks that mimic nation-state capabilities. \"Autonomous malware\" is a key development, operating with prompt-only interactions with LLMs to generate unique, changing fingerprints for each attack, eliminating the need to \"phone home\" and thus bypassing traditional signature-based detection methods. This necessitates advanced AI-driven defenses to identify \"indicators of attack\" rather than specific malware signatures.",
      "index_of_source": "So essentially you're minting new adversaries because you don't have to have all the knowledge."
    },
    {
      "question": "What was the strategic rationale behind Archer Aviation's acquisition of Hawthorne Airport, and how does owning such infrastructure support its goal of launching VTOL air taxi services?",
      "answer": "Archer Aviation acquired control of Hawthorne Airport near LAX for approximately $170 million to establish a home base and hub for its VTOL operations in Los Angeles. This provides a massive strategic advantage by giving them a platform to ramp up trial operations, especially in preparation for the LA-28 Olympics for which they won an exclusive. The airport's location near SpaceX and Tesla's design center also fosters connectivity with other innovators in transportation.",
      "index_of_source": "We also recently bought the Hawthorne Airport right outside of LAX to help give us a hub."
    },
    {
      "question": "What defines Crusoe Cloud's \"energy-first approach\" to building AI computing infrastructure, and how did this strategy contribute to its early success in powering major AI labs like OpenAI?",
      "answer": "Crusoe Cloud's \"energy-first approach\" involves co-locating compute infrastructure in areas with abundant, often underutilized energy sources, rather than traditional network hubs. This was exemplified in Abilene, Texas, where they capitalized on surplus wind and solar energy, and even negative power prices, due to transmission issues. By developing their own energy generation (like a 350 MW gas plant and a 1.2 GW substation), Crusoe was able to quickly build large-scale AI data centers, providing the critical infrastructure demanded by companies like OpenAI and Oracle.",
      "index_of_source": "So, you know, we, you know, we're experimenting a lot with, you know, the Ampere generation, which preceded Hopper."
    },
    {
      "question": "Given the \"enormous\" capital investment required for AI infrastructure, how does Crusoe Cloud mitigate the risk of a major AI lab potentially failing to meet its commitments, and what is their long-term outlook on the value of these data centers?",
      "answer": "Chase Lockmiller, CEO of Crusoe Cloud, dedicates half his time to risk management, financing massive projects through project equity and debt collateralized by the data centers themselves. He argues that even if a leading AI lab were to go out of business, its compute capacity would be immediately sought after by other, more successful model companies. This belief in the persistent demand for AI infrastructure, regardless of individual company success, underpins the long-term value and bankability of their data center projects.",
      "index_of_source": "Yeah, I think that's the biggest argument I make when people ask about the AI bubble: Imagine a scenario where OpenAI went out of business, which I don't think is going to happen."
    },
    {
      "question": "What are the primary trends and engineering challenges anticipated in AI computing infrastructure over the next three to five years, particularly regarding increasing hardware density and energy demands?",
      "answer": "The industry is moving towards significantly higher density configurations, with Blackwell chips at 130 KW per rack, Vera Rubin at 250 KW, and Vera Rubin Ultra expected to reach 600 KW, eventually aiming for one megawatt racks (equivalent to the power of a thousand homes). This extreme density creates immense challenges across all engineering disciplines, including cooling systems, electrical systems, silicon design, networking, and software engineering, requiring a full-stack solution to produce intelligence efficiently.",
      "index_of_source": "So, look, I think what’s so fascinating about this space and what gets me so excited is that it’s actually like the culmination of so many different engineering disciplines."
    },
    {
      "question": "How is Crusoe Cloud exploring and implementing novel energy solutions, such as repurposed jet engines and small modular nuclear reactors (SMRs), to power its rapidly expanding AI data centers?",
      "answer": "Crusoe Cloud is innovatively sourcing energy by partnering with Boom Supersonic to adapt their re-engineered supersonic jet turbines for power generation, securing a $1.2 billion purchase order for gas turbines. Additionally, they are \"very bullish on SMRs\" and plan to energize the first AI factory powered by an SMR in 2027 at the Idaho National Lab, operating outside typical regulatory domains as experimental technology, with Ollo Energy as a partner.",
      "index_of_source": "Yeah. So, you know, they had re-engineered this turbine for supersonic jet travel."
    },
    {
      "question": "How did the engagement of the Trump administration, particularly the Department of Transportation under Secretary Duffy, differ from the previous administration's approach to the VTOL industry, and what impact did this shift have on companies like Archer Aviation?",
      "answer": "The Trump administration, through Secretary Duffy, adopted a \"business first approach\" to new industries like VTOLs, actively seeking engagement with companies like Archer Aviation, unlike the previous administration which reportedly refused meetings. This shift resulted in President Trump issuing an executive order that fast-tracked the VTOL certification program, providing a crucial platform for companies to launch. This engagement was seen as vital for re-industrializing America, modernizing air traffic, and unlocking significant economic potential and job creation.",
      "index_of_source": "So the rules got put in place, but the most important thing that happened in the most recent history was that President Trump issued an executive order that was fast-tracking the program through the regulators and really starting to create a platform for us to launch."
    }
  ]
};
</script>
