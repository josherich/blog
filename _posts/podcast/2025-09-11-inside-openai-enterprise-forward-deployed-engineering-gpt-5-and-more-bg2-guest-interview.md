...
Hey, folks. I'm **Apoor Vagrabal**.

And today at the **OpenAI office**, we had a wide-ranging conversation about **OpenAI's work in enterprise**. I have with me the **head of engineering and head of product of the OpenAI platform**, **Sherwin Wu** and **Olivia Godinant**.
...
**Sherwin**, my **Pantor 2013 classmate**, tennis buddy, with two stops at **Quora** and **Opendoor** through the IPO before joining OpenAI, before ChatGPT. You've now been here for three years and lead engineering for all OpenAI platform.
...
Well, maybe we can **double click** into that, Olivier. The reach for chat is obviously wide — billions of users.
...
When we looked at those problems, what we knew, what models were capable of, we saw a ton of benefits and opportunities to automate and augment essentially the work of those teams. And so, yeah, **Amgen** has been a top customer of **DP5**, for instance.
...
So, we actually did a custom **on-prem deployment** with them onto one of their supercomputers called **Bonato**.
...
I think feedback has been very positive, especially on the **platform side**, which has been really great to see. A lot of the things that **Olivier** mentioned have come up in feedback from customers.  
...
Codex Klai, especially with **GPT-5**.
...
Codex Klai has been around for a bit. I feel like it's been less than a year for Codex. A few months, I would say.
...
But I'm talking about our **coding product within ChatGPT**, which is the Codex Cloud offering. And then also Codex Klai.

So, actually, maybe if I were to narrow my answer a little bit more to **Codex Klai**, which I've really, really liked.
...
So, what's a good way to sharpen critical thinking? Use **TrashDBT** and have it test you. That's true.  
...
But I think the meta-level point is they're so, like, **AI-native**. And even, like, I don't know, me and Olivier, we're, like, kind of AI-native. Yeah. We work at OpenAI.  
...
The thorn is easy for me. What we call the **blip**, which is, you know, the coo of the board. Like, that was a really tough moment. Yeah.  
