...
[The China Commission Reports!](https://pscrb.fm/rss/p/traffic.megaphone.fm/CHTAL5998245680.mp3)

The **2025 U.S.-China Congressional Commission Report** is upon us to discuss. We have on mike **Kiken**, who spent two decades on the hill with **Schumer** and **Sask**. He is now at **Hoover** and was appointed by **Schumer**, as well as **Leland Miller**, who's the co-founder and CEO of the **China Beige Book** and appointed by Speaker **Mike Johnson**. 
...
- Conversations with folks like **Jameson Greer**, Under Secretary **Kessler**, leaders in the military  
- We had a chance to meet with **General Kane** earlier this year, among others  
...
Jordan: It’s kind of a lateral, different taste. I had the feeling listening to the **AIPA Supreme Court discussion** like, 
...
Then the other thing to keep in mind is, you know, we did a major update to the **Taiwan Relations Act** three or four years ago. That was also carried by...
...
So, I’m curious...
Know if you end up having **cabinet members who disagree**, what is the hope that a unified **economic statecraft entity** could do? I mean, are we just moving this all into the **White House** and kind of taking it out of the hands of these other principals? Give me more on the vision here.
...
Over the course of the year, we had a series of hearings and meetings with a variety of folks. I sort of got to a point of frustration where I almost put my hand on my forehead, **Jordan**, and it was like, _"Oh my God, we didn't go big enough."_ 
...
or all of these completely reasonable arguments we've heard over the decades for not doing more coercive actions against **Iran**, **Iraq**, **Russia**, or **China**.
Pick your **country** where there is like a real cost to whatever, you know, sharper **economic** stuff the **U.S.** is considering. So is the argument then just like if you have someone who's a **cabinet member** whose job it is to advocate this, then just like that argument will be clearer? Or, I don't know, take it from here.
...
Okay, **Leland got it wrong** in that he's put it in your mind now. There's actually a former colleague of mine on the **Armed Services Committee**, a guy named **Tom Goffis**, who used to say when we were on trips, he'd always talk about the *alligator closest to the boat*, the alligator closest to the boat, right? And the sort of things that the commission wants to optimize for are more like two to five years out stuff.
...
> "**If you don't do what we want, then we're not going to let you have this, or we're going to let you have that,**"  
and that cuts down our policy choices.
...
That way, intelligence was actually coming in and fueling some of the things and served as a catalyst for some of the things that the **Treasury Department** did. The **Bureau of Industry and Security** certainly has access...
To the **intelligence community** are not integrated into it, and the consequence of not being integrated into it is basically the intelligence community will give you information when you ask for it but isn't sort of like pouring in their resources to make sure that your requirements are being met.  
...
But the second speed of China's economy is the national security side, and **Xi Jinping** has made very clear what...
This is **Made in China 2025** sectors. This is **advanced technology**—these are things that have a **national security nexus** and are helping to build up the military.  
...
We have to be looking at what are the things that we're doing that provide capital or **technological inputs** to the Party or to the military, and we need to shut those down. The problem here is not only that we do not have strong policies that shut that pipeline down.
Of **capital and technology**, we are refusing in most cases to even track that. So if you look at the problem with **supply chains**, it's not that we have bad policies; it's that we have refused up to this point to even get the data necessary to highlight what the **vulnerabilities** are. The reason we have not gotten those data is that we've been very sensitive to the idea that we're on industries' turf, we're going to hurt our companies, etc.
...
All right, we went 45 minutes without talking about **Trump**. The dynamic there, Mike, is you have **Mike Kratzio** giving nice speeches about **Vannevar Bush**, and then you have science funding getting cut. Us sort of like holding — or do we want to do this? Maybe let's not do this.
...
The whole entire resource issue is quite ridiculous, but what...
...
The other thing—and you're going to think I'm like a broken record here—is that, you know, **rare earths is really bad.** What is the...
...
This is again happening in Taiwan and some of these key areas of strategic importance.
...
It was an incredible opportunity just to see how much money in public treasure has been poured into this over the last 80 years, but also just to see all the...
Things that the **United States government** is capable of doing—one of the things that we did a hearing on, and I can't remember what the title was, but I know I loved it. It was like **"The Rockets' Red Glare"** or something like that. The staff wouldn't let me have a question mark at the end of another hearing title, so I didn't get a question mark at the end, which is devastating.
...
**Rinse** knows that greatness takes time, but so does laundry. So, Rinse will take your laundry and hand-deliver it to your door expertly cleaned, and you can take the time pursuing your passions.

Time once spent sorting, waiting, folding, and queuing is now spent challenging, innovating, and pushing your way to greatness.

- Pick up the Irish flute.
- Or those calligraphy pens.
- Or that daunting beef Wellington recipe card.

Leave the laundry to us. Rinse—it's time to be great.

<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "The 2025 U.S.-China Congressional Commission Report is upon us to discuss.",
      "section_title": "Introduction to the 2025 U.S.-China Congressional Commission Report",
      "section_level": 1
    },
    {
      "index_sentences": "It's actually kind of a fun story.",
      "section_title": "Understanding the China Commission: Origin and Activities",
      "section_level": 1
    },
    {
      "index_sentences": "The task was to keep an eye on China and on the executive branch as things progressed over time.",
      "section_title": "The Commission's Mandate and Annual Work",
      "section_level": 2
    },
    {
      "index_sentences": "What the China Commission tries to focus on are the issues that are more distant, on the horizon.",
      "section_title": "Looking Over the Horizon: Focusing on Distant Issues",
      "section_level": 2
    },
    {
      "index_sentences": "As a reader of this document going on a decade now, it's nice to see how the level of discourse in the American political ecosystem around topics like this is often very heated and not grounded in evidence.",
      "section_title": "The Importance of Evidence-Based Reporting and Staff Contribution",
      "section_level": 2
    },
    {
      "index_sentences": "Make the case, you two, for why Congress matters when it comes to U.S.-China issues.",
      "section_title": "The Enduring Influence of Congress on U.S.-China Policy",
      "section_level": 1
    },
    {
      "index_sentences": "If you think about the big moving pieces in U.S.-China policy over the last decade, a lot of them have come out of Congress.",
      "section_title": "Legislative Impact on Key Policy Areas",
      "section_level": 2
    },
    {
      "index_sentences": "Administrations are fleeting, and Congress is forever.",
      "section_title": "Congress as a Source of Durable Policy",
      "section_level": 2
    },
    {
      "index_sentences": "There is this weird thing though of the executive branch sometimes, perhaps increasingly, not doing the things that legislation says they have to do.",
      "section_title": "Executive Branch Non-Compliance with Congressional Intent",
      "section_level": 2
    },
    {
      "index_sentences": "One of our recommendations this year was on the creation of an economic statecraft agency or some sort of entity because there has not been enough coordination and integration among various government entities that handle sanctions, export controls, and other things.",
      "section_title": "Commission Recommendations: Towards an Economic Statecraft Agency",
      "section_level": 1
    },
    {
      "index_sentences": "My questions were a leading critique going into this first recommendation.",
      "section_title": "Addressing Disparate Government Entities and Lack of Coordination",
      "section_level": 2
    },
    {
      "index_sentences": "The frustration I have is that right now you have export controls, and this is also true in the sanctions community, where all these things sort of happen at a mid-level layer in departments and sometimes don't bubble up to senior officials.",
      "section_title": "Rationale for Consolidation and Senior Leadership",
      "section_level": 2
    },
    {
      "index_sentences": "I'll give an even more pessimistic take.",
      "section_title": "Structural Disincentives in Current Policy Frameworks",
      "section_level": 2
    },
    {
      "index_sentences": "What I think that does is it structurally sets up the policies to succeed, but I don't think any of this can succeed without a broader national economic security policy overlaying it.",
      "section_title": "Developing a Comprehensive National Economic Security Strategy",
      "section_level": 1
    },
    {
      "index_sentences": "Unless you have a broader policy that weaves them in and integrates them and sees them as a broader mission going forward in parallel, everybody's fighting for their own piece of the pie.",
      "section_title": "Integrating Economic Pillars for a Broader Mission",
      "section_level": 2
    },
    {
      "index_sentences": "If the reason that nobody was talking about supply chains until a few months ago, now everybody's talking about supply chains, is because they didn't see them as a tier one national security priority.",
      "section_title": "The Urgency of Supply Chain Resilience",
      "section_level": 2
    },
    {
      "index_sentences": "Our sixth hearing this year was focused on supply chains and Beijing’s economic choke points on the U.S. economy via very critical supply chains.",
      "section_title": "Identifying Beijing’s Economic Choke Points",
      "section_level": 3
    },
    {
      "index_sentences": "One of the things we did after 9-11 was make sure that the sanctions community was integrated into the intelligence community.",
      "section_title": "Integrating Sanctions and Intelligence Communities",
      "section_level": 3
    },
    {
      "index_sentences": "Listen, none of these things run on fairy dust, Jordan.",
      "section_title": "Funding, Political Will, and the Future of Export Controls",
      "section_level": 1
    },
    {
      "index_sentences": "I guess what's your sense of the broader appetite for this stuff and maybe a little anthropology of the different camps within Congress currently on both sides of the aisle about how they're thinking about these issues?",
      "section_title": "Congressional Appetite and Industry Resistance",
      "section_level": 2
    },
    {
      "index_sentences": "I think if you look at the broader picture, the argument is constantly being made—and it's certainly being made by industry—that we need to stop doing provocative stuff to China because we're poking the bear.",
      "section_title": "China's Two-Speed Economy and Targeted Policies",
      "section_level": 2
    },
    {
      "index_sentences": "The problem here is not only that we do not have strong policies that shut that pipeline down of capital and technology, we are refusing in most cases to even track that.",
      "section_title": "The Challenge of Data Collection for Vulnerabilities",
      "section_level": 2
    },
    {
      "index_sentences": "Let me just sort of go either a layer above or a layer below where Leland is, and that's the sort of innovation cycle.",
      "section_title": "Fostering Innovation and Addressing Future Technologies",
      "section_level": 1
    },
    {
      "index_sentences": "A number of the recommendations — quantum, biotech, and a few other things that we had in the report — talk about the importance of making sure that you preserve and sustain the ecosystem of innovation.",
      "section_title": "Reinvigorating the American Innovation Machine",
      "section_level": 2
    },
    {
      "index_sentences": "I want to talk maybe, Leland and Mike, a little bit about the sort of Treasury sanctions to Commerce export controls parallel.",
      "section_title": "Bolstering BIS and Lessons from Financial Sanctions",
      "section_level": 2
    },
    {
      "index_sentences": "I'm kind of—and you know we have an executive branch which is really of multiple minds on what they're going to do about a lot of these issues.",
      "section_title": "Overcoming Pessimism and Sustaining Long-Term Vision",
      "section_level": 2
    },
    {
      "index_sentences": "Well, it's not a normal occurrence, so let's enjoy it while it happens.",
      "section_title": "Changing the Paradigm for Critical Minerals",
      "section_level": 2
    },
    {
      "index_sentences": "The other thing I would add is the one thing that the Chinese are incredibly effective at—and this relates really to Taiwan and the critical mineral space—is this sort of boiling the frog or salami slicing of the status quo, doing it underneath everyone's nose.",
      "section_title": "Addressing China's 'Boiling the Frog' Strategy in Key Sectors",
      "section_level": 2
    },
    {
      "index_sentences": "Our biggest challenge is not convincing Congress and other policymakers to be serious about supply chains or even biotech.",
      "section_title": "The Challenge of Quantum Technology and its Ecosystem",
      "section_level": 2
    },
    {
      "index_sentences": "The second rent recommendation—the second one—says: See the commission's classified recommendation annex for a recommendation and discussion related to US-China advanced technology competition.",
      "section_title": "Classified Recommendations and Space Exploration",
      "section_level": 1
    },
    {
      "index_sentences": "See the commission's classified recommendation annex for a recommendation and discussion related to US-China advanced technology competition.",
      "section_title": "US-China Advanced Technology Competition (Classified)",
      "section_level": 2
    },
    {
      "index_sentences": "I love space issues.",
      "section_title": "Investing in Space Infrastructure and Synthetic Biology",
      "section_level": 2
    },
    {
      "index_sentences": "Oh man, who knew China commissioners could double as back-to-back stand-up acts?",
      "section_title": "Conclusion and Acknowledgements",
      "section_level": 1
    }
  ]
};
window.faq = {
  "qas": [
    {
      "question": "What is the U.S.-China Economic and Security Review Commission, and why was it established?",
      "answer": "The U.S.-China Economic and Security Review Commission (China Commission) was created by Congress to monitor China and the executive branch, especially during the WTO accession and Permanent Normal Trade Relation discussions, as Congress concluded they didn't like the ongoing changes and wanted to keep a close watch.",
      "index_of_source": "Its full name is the U.S.-China Economic and Security Review Commission."
    },
    {
      "question": "How does the China Commission differentiate its focus from other entities in Washington D.C.?",
      "answer": "The China Commission focuses on \"over the horizon\" issues – more distant economic, military, and technology challenges that Congress should consider for smarter policy – contrasting with \"alligators closest to the boat\" issues that immediate policymakers handle.",
      "index_of_source": "What the China Commission tries to focus on are the issues that are more distant, on the horizon."
    },
    {
      "question": "Why is Congressional involvement considered crucial for U.S.-China policy, according to the speakers?",
      "answer": "Congressional involvement is crucial because administrations are fleeting, and durable, lasting policies require Congress; many significant U.S.-China policies like sanctions, CHIPS and Science, and CFIUS reform originated from Congress, driving the agenda and providing executive branch tools.",
      "index_of_source": "I mean, listen, Jordan, the first thing I would say is that if you think about the big moving pieces in U.S.-China policy over the last decade, a lot of them have come out of Congress."
    },
    {
      "question": "What dynamic arises when the executive branch does not fully implement legislation related to China, such as the Taiwan Relations Act or the TikTok saga?",
      "answer": "A \"sloshing around\" push-pull relationship arises, where Congress, when the executive doesn't listen, finds ways to impose guardrails, constraints, or funding prohibitions, reflecting a historical tension that is never perfectly in balance.",
      "index_of_source": "There is this weird thing though of the executive branch sometimes, perhaps increasingly, not doing the things that legislation says they have to do."
    },
    {
      "question": "What problem does the proposed \"economic statecraft agency\" aim to solve, and what is its underlying vision?",
      "answer": "The proposed \"economic statecraft agency\" aims to solve the problem of insufficient coordination and integration among government entities handling sanctions and export controls, consolidate these functions into one silo with a senior leader to force decisions to the top, and free important national security policies from structural disincentives in current departments.",
      "index_of_source": "One of our recommendations this year was on the creation of an economic statecraft agency or some sort of entity because there has not been enough coordination and integration among various government entities that handle sanctions, export controls, and other things."
    },
    {
      "question": "According to Leland, how does the current government structure inherently set up export controls and sanctions to fail, particularly within departments like Commerce and Treasury?",
      "answer": "Leland argues that the current structure sets up these policies to fail because, for example, the Commerce Secretary's role in promoting U.S. businesses abroad creates an inherent tension and disincentive for policies like export controls that interfere with that major mandate.",
      "index_of_source": "I think the current structure sets up export controls and sanctions to fail because if you look at the way this works: At the Commerce Department, the undersecretary is in charge of export controls."
    },
    {
      "question": "What fundamental issue currently prevents the U.S. from developing effective policies to address supply chain and technology vulnerabilities with China?",
      "answer": "The fundamental issue is the U.S. government's refusal to track and collect necessary data on investment, supply chains, and technology, which makes it impossible to fully understand the extent of vulnerabilities and, consequently, to form good, evidence-based policies.",
      "index_of_source": "The problem here is not only that we do not have strong policies that shut that pipeline down."
    },
    {
      "question": "What unexpected connection was highlighted between synthetic biology and the future of U.S. space endeavors in the commission's space chapter?",
      "answer": "The space chapter highlighted the vital role of synthetic biology in sustaining life in space, whether in outer space, on the moon, or Mars, emphasizing the need to be thoughtful about this ecosystem and its future technological reliance.",
      "index_of_source": "The second piece, Jordan, is I sort of had a deeper awakening about two weeks ago when I was at this conference called iGEM."
    }
  ]
};
</script>
