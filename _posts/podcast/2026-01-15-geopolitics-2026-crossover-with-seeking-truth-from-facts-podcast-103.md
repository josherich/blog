---
layout: post
title: "Geopolitics 2026, crossover with Seeking Truth From Facts podcast – #103"
date: 2026-01-15 00:00:01
categories: podcast manifold
tags: [podcast_script]
---


[Geopolitics 2026, crossover with Seeking Truth From Facts podcast – #103](https://media.transistor.fm/5216d4ad/051fcf15.mp3)
...
But **Hanfei Tzu** points out that like what might have happened is that they zoomed up this catch-up curve so fast that now there isn't actually a Thucydides trap dynamic, that when the planners in Washington actually look at what a hot confrontation will look like, they think they're going to lose.  
...
Today, I am joined by a regular and friend of the show, **Steve Shue**, to do a roundup of **2025 from a geostrategic point of view.**  

How are you doing, Steve?  
Great. It's great to be with you again, Alf.  
...
2. At the same time, I think you picked up on something very important that I've also noticed, which is that a lot of the kind of, as you said, boomer attitudes towards China are based on these assumptions that may have been true 20 years ago,
That **China's only competitive because of its lower labor costs, that it artificially keeps wages low for that purpose**. And that's basically the core of its economic model when in reality, **real wages in China have been rising quite steeply for the past 20 or so years**.
...
So **Hegseth openly acknowledges this**, and their new official defense strategy policy papers acknowledge this.
And so what you're really seeing is a move toward **fortress Americus**, not America singular, but **Americus to include Venezuela**, for example.  
...
And I think that's what **Putin's sticking to**, because it seems like Trump and Witkoff, although they do want to settle this war, they don't want to be enemies of the Russians.
...
In a moment, I'll go on to the **Iran-Israel conflict**, although I have less conviction in this because a lot of the details still are classified and we don't know exactly what happened in the missile and drone exchanges between Iran and Israel.
So my moderate conviction conclusion is that the combination of the best **Israeli defense systems like David Sling**, plus **U.S. Arleigh Burke destroyers**, plus **U.S. Patriot systems**—basically everything that you could throw at the **Iranian missile attacks**—actually didn't work that well. 
...
And what's interesting on the point of the kind of boomer analysts often overestimating the extent to which these regimes will just fall, **Syria** is an interesting case because, I mean, yeah, well, in **2024**, the final push to remove **Assad** was very quick.
I mean, it did take a **a 13-year-long war** to lodge him from power. Even **Iran**, Iran's seen very serious protests before in 2009.
...
But I think the shift focus on, I think what we both agree is the most crucial geopolitical contest of the century, namely the **back** between the **United States and China**.
...
There's a writer for **Asia Times** whose pseudonym is **Han Feiza**, and I've had him on my show. I interviewed him when we were both in **Beijing**. There's an episode of *Manifold* called *Letter from Beijing* where I interview this guy, **Han Feiza**, who actually has a background in, he was educated in the US in engineering and then became an investment banker. And now he lives in Beijing.
...
But that sort of more or less short circuited the **Thucydides trap**.
The **Thucydides trap** is if you have a rising number two, there's often a war because the number one power sees that number two has more momentum and realizes it better fight early because if it waits, number two's growth curve will allow it to surpass number one. And then number one won't be able to prevail in a competition. So that's the dynamics of the **Thucydides trap**.

But **Hanfay Tzu** points out that, like, what might have happened is that they zoomed up this catch-up curve so fast that now there isn't actually a **Thucydides trap** dynamic; that when the planners in **Washington** actually look at what a hot confrontation will look like, they think they're going to lose. So actually, instead of a **Thucydides trap** dynamic in the **Western Pacific**, what's actually happening is intense planning for **fortress Americas**:
...
I have more questions than answers when it comes to Venezuela.  
One, because I'm not an expert on Venezuela.  
And two, because events are moving so fast. So everything I'm going to say you should take with a grain of salt and as low conviction.
...
Yeah, so I never believed in it.
I always thought **at the end, when push comes to shove, it becomes a matter of pure power, pure, coercive, violent military power**.
...
Thank you so much for coming on the show, **Stephen**.

I'm sure we'll do something like this again and I'll be very glad to do it.

> "Yeah, great to be with you again, Alf. Have a great 2026."
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "Hello and welcome to a brand new episode of Seeking Truth Through Facts.",
      "section_title": "Introduction",
      "section_level": 1
    },
    {
      "index_sentences": "So we're fitting now in just five days into the new year on the back of a 2025 that was very eventful from a geostrategic standpoint.",
      "section_title": "Major Geostrategic Trends of 2025",
      "section_level": 2
    },
    {
      "index_sentences": "So obviously, the big thing was the economic, shall we say, friction between Trump and China.",
      "section_title": "US-China Economic Friction: Trump Tariffs",
      "section_level": 2
    },
    {
      "index_sentences": "So there's sort of a, maybe you could call it a boomer take that, you know, might have been true 10 or 15 years ago, but isn't true anymore, which is that: China's economy is dominated by exports.",
      "section_title": "Misconceptions about China's Export Economy",
      "section_level": 3
    },
    {
      "index_sentences": "So for people who followed this, you know, the Trump team, I think, thought they were going to be able to use this as leverage against China.",
      "section_title": "China's Counter-Tariffs and Rare Earths Controls",
      "section_level": 3
    },
    {
      "index_sentences": "I guess that like two points I picked up on there: You mentioned that China's still growing around four to five percent a year.",
      "section_title": "China's Continued Economic Growth and Technological Advancement",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, I think we could go on for the whole hour on what's happening with the Chinese economy, Chinese manufacturing, competitiveness, et cetera.",
      "section_title": "China's Advanced Manufacturing and Technological Parity",
      "section_level": 3
    },
    {
      "index_sentences": "Now, looking into the future, there's some issue of whether they sort of pulled the rare earth trigger too early.",
      "section_title": "Future of Rare Earths Supply Chains",
      "section_level": 3
    },
    {
      "index_sentences": "Another one of the key developments of the year has been Donald Trump's return to the White House, as well as his announcing and implementation of a new national security strategy.",
      "section_title": "Trump's Second Term and Geostrategic Shift",
      "section_level": 2
    },
    {
      "index_sentences": "Right. So if you step away from economic competition to, more broadly, geostrategic competition, which could include military competition, there I think there's been a very strong break from the attitudes or the analysis that prevailed under the Biden team.",
      "section_title": "New Evaluation of US-China Military Balance",
      "section_level": 3
    },
    {
      "index_sentences": "Would you say that's a quite key difference between the strategy being pursued by the current Trump administration and the strategy that was pursued during his first term?",
      "section_title": "Contrast with Previous Administrations' Views",
      "section_level": 3
    },
    {
      "index_sentences": "And to kind of zoom in on a more regional level, one, everywhere there has been a real shift in policy, it seems, is Ukraine.",
      "section_title": "Ukraine War: End Prospects and Outcomes",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, so I feel that Ukraine will end up worse off than if we had settled things in Istanbul or even earlier before the Russian invasion.",
      "section_title": "Ukraine's Tragic Outcome and Military Situation",
      "section_level": 3
    },
    {
      "index_sentences": "Okay. And I mean, to move to another zone of tension, tremendous events have continued to take place in the Middle East with the fallout from events in 2024, such as Israel's purge operation against Hezbollah and the fall of Assad, as well as the seemingly failed U.S. mission to counter the Houthis and the Red Sea.",
      "section_title": "Middle East Review: Israel, Houthis, and Iran",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, so if I were to tally up the wins and losses on different sides from 2025, well, for sure: The collapse of Syria, The neutralization of Hezbollah by Israel I think surprised a lot of people.",
      "section_title": "Israeli Wins and US Naval Ineffectiveness against Houthis",
      "section_level": 3
    },
    {
      "index_sentences": "In a moment, I'll go on to the Iran-Israel conflict, although I have less conviction in this because a lot of the details still are classified and we don't know exactly what happened in the missile and drone exchanges between Iran and Israel.",
      "section_title": "Effectiveness of Missile Defense in Iran-Israel Conflict",
      "section_level": 3
    },
    {
      "index_sentences": "I guess to bring events into 2026, I mean, I don't know how much you've looked into the situation, but I don't know what, if you have any idea, the likelihood given the current unrest in Iran of any kind of regime change.",
      "section_title": "Unrest and Likelihood of Regime Change in Iran",
      "section_level": 3
    },
    {
      "index_sentences": "You make a very good point, which is that the final downfall, which is non-linear, if it happens, is some non-linear event, which might happen, seem to happen really quickly.",
      "section_title": "Non-linear Downfall of Authoritarian Regimes",
      "section_level": 4
    },
    {
      "index_sentences": "But I think the shift focus on, I think what we both agree is the most crucial geopolitical contest of the century, namely the back between the United States and China.",
      "section_title": "The Crucial US-China Geopolitical Contest",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, so, as I was saying earlier, I think the Trump people came in and thought they could win based on economic coercion, based on tariffs.",
      "section_title": "Shifting US Strategy from Economic Coercion to Military Acknowledgment",
      "section_level": 3
    },
    {
      "index_sentences": "China leapfrogged Western expectations so fast. It went from, you know, the West thinking it was still a backwards, low labor cost, low end manufacturer with shitty technology.",
      "section_title": "China's Rapid Ascent and the Thucydides Trap Bypass",
      "section_level": 3
    },
    {
      "index_sentences": "Now, to move on to the elephant that's been in the room for our entire discussion that I'm sure everyone wants to hear about: I think any geostrategic discussion right now would be incomplete without a discussion of the situation in Venezuela, where Nicolas Maduro was two days ago captured by U.S. Special Forces at time of recording, representing a reassertion of the Monroe Doctrine or the Donro Doctrine as it has been unofficially renamed.",
      "section_title": "Venezuela, Maduro's Capture, and the Monroe Doctrine",
      "section_level": 2
    },
    {
      "index_sentences": "I have more questions than answers when it comes to Venezuela. One, because I'm not an expert on Venezuela.",
      "section_title": "Venezuela's Strategic Implications for US-China",
      "section_level": 3
    },
    {
      "index_sentences": "I mean, to join on there to your point about international law. The idea of international law has always seemed to me to be one of those notions that if you think about it for more than five seconds, it just becomes transparently laughable.",
      "section_title": "International Law as a \"Useful Fiction\" for Hegemony",
      "section_level": 3
    },
    {
      "index_sentences": "And I guess one final kind of thing to add on to that that just came to mind was all this talk at the moment over Greenland and how serious do you think the Trump administration's designs on Greenland are?",
      "section_title": "Trump Administration's Designs on Greenland",
      "section_level": 2
    },
    {
      "index_sentences": "But this is kind of related to the fact that if you watch the recent press conferences that Trump has been giving, both about Maduro, but just in general, he clearly is undergoing some kind of cognitive decline.",
      "section_title": "Trump's Cognitive Decline and Diplomatic Approach",
      "section_level": 3
    },
    {
      "index_sentences": "You'll just notice like all the EU people are afraid to criticize Trump over Maduro.",
      "section_title": "EU Reactions to US Actions and the Imperial System",
      "section_level": 3
    },
    {
      "index_sentences": "I think to finish on that note, I think it's been a fantastic recap of 2025 and the first few days of 2026 as eventful as they have been.",
...
window.faq = {
  "qas": [
    {
      "question": "How did China's rapid economic and technological advancement impact the predicted \"Thucydides trap\" dynamic between China and the West?",
      "answer": "China's swift ascent up the catch-up curve made Washington planners believe they would lose a hot confrontation, thus short-circuiting the Thucydides trap, which usually predicts war when a rising power approaches parity with a dominant one.",
      "index_of_source": "China leapfrogged Western expectations so fast."
    },
    {
      "question": "What common Western assumptions about China's economy were proven wrong during Trump's tariff war?",
      "answer": "The assumptions that China's economy is dominated by exports, that most of those exports go to the U.S., and that the U.S. consumer is the consumer of last resort were all proven wrong; exports are a relatively small chunk of China's economy, and the U.S. portion of total Chinese exports is relatively small, amounting to only two to three percent of the Chinese economy.",
      "index_of_source": "So obviously, the big thing was the economic, shall we say, friction between Trump and China."
    },
    {
      "question": "In what specific technological areas has China either achieved parity, dominance, or fallen behind the rest of the world?",
      "answer": "In the majority of advanced manufacturing sectors, China now either dominates or is at parity with the best competitors globally. They significantly lag behind in EUV lithography and advanced semiconductors but are way ahead in battery technology, electric vehicles, alternative energy, and solar panels.",
      "index_of_source": "And they've succeeded in climbing the value chain to the point where one could almost argue in the majority of advanced manufacturing sectors, they now either dominate or are at parity with the best competitors from anywhere in the world."
    },
    {
      "question": "What radical shift has occurred in the Trump administration's geostrategic approach compared to previous administrations, particularly regarding military competition in the Western Pacific?",
      "answer": "The Trump administration, especially through figures like Secretary of War Hegseth, openly acknowledges that the U.S. fleet is at risk in the Western Pacific and could lose huge amounts of material in a shooting war with China. This has led to a strategic shift towards \"fortress Americas,\" focusing on dominating North and South America rather than maintaining a forward posture in the Western Pacific, a view fundamentally different and more realistic than what prevailed under Biden.",
      "index_of_source": "So if you step away from economic competition to, more broadly, geostrategic competition, which could include military competition, there I think there's been a very strong break from the attitudes or the analysis that prevailed under the Biden team."
    },
    {
      "question": "What did the events in the Red Sea involving the U.S. Navy and the Houthis reveal about modern missile defense capabilities?",
      "answer": "The events in the Red Sea demonstrated the U.S. Navy's inability to reopen shipping and subdue the Houthis, providing strong evidence that surface ships cannot effectively defend against modern missile systems, even relatively 'crappy' ones from the Houthis, and that claims of U.S. and Israeli defense contractors regarding missile defense have been strongly overstated.",
      "index_of_source": "So, on the L side, I think probably the most obvious L, and the one that I have the highest conviction in, is the inability of the U.S. Navy to reopen shipping through the Red Sea and to subdue the Houthis."
    },
    {
      "question": "What is the cynical view of \"international law\" and the \"rules-based order\" as discussed in the text, particularly regarding the actions of the U.S.?",
      "answer": "The cynical view is that \"international law\" and the \"rules-based order\" are a façade or a \"useful fiction\" employed by the U.S. to control the world without constant violence, conning weak-minded jurists and the public into believing in a fair system, while in reality, the U.S. disregards these rules when it deems necessary, as shown by actions like the Iraq War or the capture of Maduro.",
      "index_of_source": "So, I think the right way to say this is that, of course, there are two phases:"
    },
    {
      "question": "How did China's response to Trump's economic coercion, specifically regarding rare earth materials, turn the tide in the tariff war?",
      "answer": "China responded to Trump's tariffs by rolling out rare earth materials controls of its own. This made the U.S. realize a huge vulnerability for its defense and key economic industries, ultimately leading to the Chinese getting the best of the tariff war by leveraging their control over essential materials.",
      "index_of_source": "Ultimately, it culminated in the Chinese actually rolling out rare earth materials controls of their own, which I think the U.S. realized that this is a huge problem for, you know, defense, the defense industry, which I think actually is still currently restricted from getting rare earths from China."
    }
  ]
};
</script>
