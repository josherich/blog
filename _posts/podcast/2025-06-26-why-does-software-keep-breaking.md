...
If you are motivated to do it, **LLM** can be very helpful at doing that. Now you have to make sure you're not getting gaslit into believing some function doesn't exist, but for basic **CS fundamentals**, it's got.
**1975.519** - 5.04: all of those books loaded in direct it's. 

**1978.48** - 5.039: can probably you could ask it what's on 

**1980.559** - 4.321: page 37 of algorithms you know and it'll pull out it. 

**1984.88** - 2.399: probably knows what I'm saying. 

**1985.919** - 3.281: it's seen it so many times on the internet so for basic **CS** stuff to get you far on a bunch of these basics. 

**1990.88** - 3.84: you can be asking it, you can be doing questions, you can be like 

**1994.72** - 4.4: "explain that again" or "explain it you know in a way that I would understand." If I really don't know math, 

**2001.6** - 3.199: can you relate this to a **physics** example for me? I understand **physics** but I don't get **computer science**. 

**2006.64** - 5.36: people are definitely sleeping on that aspect of helping them out, but you've got to do it yourself. 

**2012.0** - 3.12: so that's kind of the 

**2015.12** - 4.24: but that's where the danger is because even if you're semi-desiring to learn, 

**2016.399** - 4.64: it really is a desire magnifier. It really reveals your ultimate desires. 

**2023.519** - 3.921: Was your desire to simply get the thing done or was your desire to learn? And if you don't have your desires correct, it will—or at least in your head, what you think of yourself versus in your actions— 

**2034.08** - 3.439: it will make revealed preference. **Revealed preference.** That's the term I'm looking for. 

**2040.48** - 4.24: This is why I think having an **AI** that's specifically designed for this, and you only subscribed to that service, would be helpful for people. 

**2047.2** - 4.719: Because I don't know about you guys, but like if I want to eat more healthy food, the easiest way is to 

**2054.159** - 3.68: just only buy the healthy food so I don't have like bad food around the house, right? 

**2060.079** - 3.201: Yes. It's much harder if I buy a bunch of cake that I love and I'm just supposed to not eat it. 

**2063.28** - 4.72: Just only eat one slice a week, Casey. Whatever. 

**2068.0** - 3.44: My wife does this, and she's like, 

**2071.44** - 3.84: "I bought natural popsicles for the kids," and I'm like, "Damn, I love strawberry." 

**2075.28** - 4.72: It's very hard for me not to want to eat them. 

**2077.679** - 4.16: This is what I'm saying for reals though. 

**2080.0** - 3.2: I feel like the **AI** is a bit of a problem that way, which is why it would be nice if you had a service that was like open **AI** or somebody, right? 

**2087.2** - 4.479: They have this one that's education only and it's specifically designed not to give you answers very quickly. 

**2093.599** - 4.0: It's like, "I'll dribble out some stuff," I'll give you some. 

**2097.599** - 3.201: It even has like this maybe you could bake the concept of time in there. 

```
if you haven't been working on this for a couple days,
    I'm just not going to tell you anymore.
    You have to spend some time trying it yourself.
```

**2108.72** - 3.44: I could see that being very helpful for people because, you know, **inaccessibility** is best. **Willpower** is second best, right? 

**2112.16** - 4.64: So, if you can have that, that would be cool. 

**2118.32** - 3.759: I think that would help bring out those learning abilities of the **LM** so that people aren't too tempted to just ask, 

**2123.839** - 3.121: "Just tell me how to do the freaking diamond," right? 

**2126.96** - 3.6: "Just give me the code." 

**2131.92** - 3.36: I also can't blame people for doing that. I would totally do that too. 

**2133.2** - 3.84: This is why I say to have the **AI** not do that, it's better, even though it's less—it trains your willpower less. 

**2138.8** - 4.96: But **willpower** is hard. It's hard for everybody. 

**2143.76** - 3.28: If you get the experience of actually solving it for yourself a few times, then you're like, 

**2148.48** - 4.32: "Oh, it actually was kind of rewarding," right? So like it really can.
**Help you, right?** If you start out and then suddenly your time starts going down on how fast it takes you to row **200 m**, right? And you're like, "Sick, that feels good." Initially, I wasn't thinking it would feel good; I didn't see any change at all at the beginning. 
