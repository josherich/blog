---
layout: post
title: "Allied Scale: Rush Doshi on US-China Net Assessment"
date: 2025-04-26 00:00:01
categories: podcast
tags: [podcast_script]
---


[Allied Scale: Rush Doshi on US-China Net Assessment](https://traffic.megaphone.fm/CHTAL5455872547.mp3?updated=1745605928)
...
In conclusion, the interplay between economic performance and strategic positioning is complex. Assessing the net advantages and disadvantages of both the U.S. and China necessitates a nuanced understanding of how each country is positioning itself in terms of technology, military capability, and international alliances. As we navigate this pivotal moment in global politics, it is imperative for policymakers to embrace this complexity, ensuring that strategies moving forward are not only responsive to current assessments but also adaptable to future shifts in the international landscape.
Japan, and now China. The consequence of that transition was that the U.K. lost its near-monopoly on what
was a new way of organizing production. 

Now, scale matters because it’s the element that allows nations to leverage their size effectively. The U.S. and
China are both in a position to utilize their large populations and resources. However, the way they translate
that scale into power and influence is crucial. China, for instance, has employed state-driven capitalism
that allows it to mobilize resources in ways that can rapidly scale up its industrial output and technological
development.

Meanwhile, the U.S. has a more fragmented approach where both public and private sectors play roles, often leading
to slower mobilization of resources for national projects. Yet, the U.S. maintains advantages in areas like
innovation and existing alliances. Thus, the comparative scale of output and effectiveness of organization
becomes a pivotal arena for competition, especially as we look towards the future.

Additionally, historical context is important. The U.S. emerged from the post-World War II order with a significant
advantage partly due to its industrial base being untouched by war, enabling rapid economic expansion. In contrast,
China is experiencing both extraordinary growth and profound challenges as it seeks to transition from an
export-driven economy to one focused on consumption and innovation.

As we assess the long-term trajectories of these two great powers, it's essential to factor in not just the raw size
and immediate capabilities, but also the evolving nature of their respective political systems and how they will adapt
in response to both internal pressures and global dynamics. The challenge lies in accurately interpreting these
complexities and recognizing the implications they hold for global stability and balance. 

In conclusion, effective net assessment must consider these variables, putting aside sensationalized narratives in favor
of informed observation grounded in historical and current realities. It's a nuanced endeavor, but one that is
...
to warships, but 200 times writ large. That's pretty significant numbers relative to us. But what I think is most interesting, Jordan, is also the fact that they have a pretty high share of global markets, too, when it comes to manufacturing.
...
It's very interesting that China was able to essentially set under Deng Xiaoping, you know, 20 years, 20 plus years of successors, right? Deng picked Jiang and he picked Hu Jintao as well, but he did not pick Xi. And so we don't have that same longitudinal planning. We're all living,
is to leverage that scale. The balance of power has shifted in favor of the U.S. and its allies, but we need to be strategic about how we utilize that strength. 
...
is taking that theoretical advantage and making it real. It's realizing that kind of sense of scale. 
...
In addition to doing that, you also want to reduce trade barriers among allies, so you can facilitate greater scaling up.
...
Well, the problem is there were pieces of paper, but the president chose the dumbest piece of paper because he thinks that tariffs are a great revenue-raising tool and he doesn't like trade. So,
...
All right, so China's to lose. We had a Trump administration before this, and we had the same leadership in China. You can argue they had the same perspective.
of blew it from a sort of global diplomatic alliance-making perspective. I don't know. Do you think they learned their lesson when it came to how to engage with these countries? What are the different likelihoods of potential playbooks that China may be running with this moment right now?
...
Let me try. Look, I think there's a few things to keep in mind. First of all, the Trump administration can negotiate these agreements with allies and partners in ways that actually achieve scale. It's conceivable. And there are signs that some folks that are
Running the negotiations are thinking in these terms. We know many of the people staffing the Trump administration at the level of mid-level staff, that the key principles, etc. I'm not talking about the cabinet specifically, but many of the people below that believe in allied scale. They may not have called it that, but they understand its logic. 
...
And look, it's on us to make this stuff accessible and interesting. So we can't just whine about it. We got to do the work and really make the case strongly that this is both important and fun. So that's what you do with your podcast.
I'm very excited to watch you manifest. The long game sold. There is an appetite for this. 
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "here. Historically, these have mattered. The American economy has a high level of innovation and adaptability, while China has shown remarkable growth and resilience. However, in this context, the expectation cone isn't just about how fast the economies can grow but how that growth translates into strategic capabilities.",
      "section_level": 1,
      "section_title": "Introduction: Economic Growth and Strategic Capabilities"
    },
    {
      "index_sentences": "Japan, and now China. The consequence of that transition was that the U.K. lost its near-monopoly on what was a new way of organizing production.",
      "section_level": 1,
      "section_title": "The Importance of Scale"
    },
    {
      "index_sentences": "to military vessels. So we're seeing this shift in capability that is unprecedented. The scale of China's manufacturing and industrial base stands in stark contrast to what we've seen historically.",
      "section_level": 1,
      "section_title": "China's Unprecedented Industrial Scale and Implications"
    },
    {
      "index_sentences": "to warships, but 200 times writ large. That's pretty significant numbers relative to us. But what I think is most interesting, Jordan, is also the fact that they have a pretty high share of global markets, too, when it comes to manufacturing.",
      "section_level": 2,
      "section_title": "Specific Examples of China's Industrial and Technological Dominance"
    },
    {
      "index_sentences": "Okay. So let's not underestimate China. I'm with you this far, Rush. What's the answer? So one answer that you're hearing out of the administration is like, we need to industrialize.",
      "section_level": 1,
      "section_title": "Addressing Arguments for Underestimating China"
    },
    {
      "index_sentences": "I think that's right. I mean, these advantages that have been built are very sticky. You know, poured concrete is poured concrete. It exists.",
      "section_level": 2,
      "section_title": "Debunking Macroeconomic, Demographic, and Debt Arguments"
    },
    {
      "index_sentences": "So, Rush, you ran through a lot of the arguments that people make to make the bear case of the 20-year China net assessment, but political instability is not one you address. So why don't you take that one on?",
      "section_level": 2,
      "section_title": "Considering Political Instability Risk"
    },
    {
      "index_sentences": "is to leverage that scale. The balance of power has shifted in favor of the U.S. and its allies, but we need to be strategic about how we utilize that strength.",
      "section_level": 1,
      "section_title": "Leveraging Allied Scale for Strategic Advantage"
    },
    {
      "index_sentences": "is taking that theoretical advantage and making it real. It's realizing that kind of sense of scale. And too often, we think of our allies in terms of hierarchy.",
      "section_level": 2,
      "section_title": "Alliances as Platforms for Capacity Building"
    },
    {
      "index_sentences": "get this right or we lose the century to China. That is not the usual frame that I think people think about with allies. They think allies, great; not allies, four alarm fire; you need this, five alarm fire; you need this right now.",
      "section_level": 2,
      "section_title": "The Urgency of Allied Scale"
    },
    {
      "index_sentences": "Okay. To be clear, the U.S. and China independently are roughly going to be running neck and neck or far too neck and neck for comfort in the vast majority of futures over the next few decades.",
      "section_level": 2,
      "section_title": "Why Allied Scale is Essential for Competition"
    },
    {
      "index_sentences": "So I think this is a really important point. Modern-day Japan and modern-day Germany are not India circa 1890. We are talking about very different allies in terms of their latent ability to contribute to the Metropole's national power.",
      "section_level": 2,
      "section_title": "The Quality and Strategic Advantage of Current Allies"
    },
    {
      "index_sentences": "What are the sort of errors you get from being too conciliatory versus being too coercive with respect to trying to get allies on board with scaling up together? One critique that the Trump administration makes of the Biden administration is that the focus on allies was too much on persuasion and not enough on pushing allies, or what you could call coercion.",
      "section_level": 1,
      "section_title": "Challenges and Approaches in Alliance Management and Trade"
    },
    {
      "index_sentences": "I think there's a good counter to that, which is there was a lot of progress with AUKUS and the Quad, and European involvement in Asia and Asian involvement in Europe that began to take a step in the direction of allied scale.",
      "section_level": 2,
      "section_title": "Critiquing Approaches and Seeking the Right Mix"
    },
    {
      "index_sentences": "And you could imagine, Jordan, what those deals should look like, right? You could imagine a deal in which allies invest more here. We reduce trade barriers.",
      "section_level": 2,
      "section_title": "A Path to Allied Scale Through Trade Deals"
    },
    {
      "index_sentences": "Well, the problem is there were pieces of paper, but the president chose the dumbest piece of paper because he thinks that tariffs are a great revenue-raising tool and he doesn't like trade.",
      "section_level": 2,
      "section_title": "Critique of Trade War Execution"
    },
    {
      "index_sentences": "So let's stay on the Germany example for a second, because that was my whiny Lib's owned case study that I referenced earlier. You guys were not able to get Germany to break its debt covenants and spend a trillion dollars on defense, right?",
      "section_level": 1,
      "section_title": "The European Case Study: Germany and Transatlantic Unity"
    },
    {
      "index_sentences": "Yeah, you know, it's an interesting point. The risk of the current approach, though, is that it's so intense that it pushes Germany out of being a core US ally on the things that we care about.",
      "section_level": 2,
      "section_title": "The Risk to Transatlantic Unity from Pushing Allies Too Hard"
    },
    {
      "index_sentences": "Yeah. So dark timelines. How does Trump 2.0 turn into America's Gorbachev moment? Yeah. I mean, that was a provocative line in the piece.",
      "section_level": 1,
      "section_title": "The Risk of Alliance Fragmentation: America's Gorbachev Moment"
    },
    {
      "index_sentences": "No. I mean, I think this is actually the critical point, Jordan. You're totally right. My assessments are really focused on sort of the macro indicators, demographics, financial indicators, because those are the ones that, in many ways, people are talking about when they say China might never catch up to the US.",
      "section_level": 2,
      "section_title": "The Risk of Dismantling Alliances and State Capacity"
    },
    {
      "index_sentences": "And if that all comes apart at the seams, you could have fragmentation. And that Gorbachev moment has a different element as well, which is that everything I've talked about being able to compete successfully with China, it requires state capacity.",
      "section_level": 2,
      "section_title": "Strategic Planning and Execution Lessons"
    },
    {
      "index_sentences": "We have a number of potential futures. One is all the allies, all these Democratic allies realize that maybe they can't count on the U.S., but they band together, get their houses in order, start spending on defense, and do some good deals between South Korea and Germany and whatever.",
      "section_level": 1,
      "section_title": "Potential Futures: A World with a Checked-Out America"
    },
    {
      "index_sentences": "We're seeing China right now, pretty excited. You're seeing leadership traverse different countries and strike deals. They see an opportunity.",
      "section_level": 2,
      "section_title": "China's Opportunity and Strategy in a Fragmenting World"
    },
    {
      "index_sentences": "What I worry about is, let's say we run the bear case play. Let's say we don't reconstitute our alliances, see greater transatlantic ruptures, and are not able to strike a great deal with our East Asian partners.",
      "section_level": 2,
      "section_title": "The Risk of Fragmentation and Isolation for the U.S."
    },
    {
      "index_sentences": "Every once in a while, people ask me, Jordan, why don't you turn into the Matt Levine for China policy? And my answer is, fundamentally, Matt Levine thinks securities fraud is funny.",
      "section_level": 1,
      "section_title": "Advice and Outlook"
    },
    {
      "index_sentences": "Let me try. Look, I think there's a few things to keep in mind. First of all, the Trump administration can negotiate these agreements with allies and partners in ways that actually achieve scale.",
      "section_level": 2,
      "section_title": "Hope for Achieving Allied Scale and Shaping Policy"
    },
    {
      "index_sentences": "And I guess the last thing I'd say is that this administration won't be forever. Congress might flip in two years. America is always changing.",
      "section_level": 2,
      "section_title": "Enduring American Advantages and Long-Haul Competition"
    },
    {
      "index_sentences": "All right. One last one, Rush. I remember DMing you during the administration being like, they're not going to let you talk about this book, right?",
      "section_level": 1,
      "section_title": "Insights from Experience and Chinese Grand Strategy"
    },
    {
      "index_sentences": "Yeah. Well, so thanks, Jordan. I'm really proud of the long game. It was unfortunate I couldn't really talk about it when I was in government.",
      "section_level": 2,
      "section_title": "Reinforcement of Grand Strategy Conclusions"
    },
    {
      "index_sentences": "And the conclusion was that China had, since the end of the Cold War, a grand strategy to displace American order first at the regional level and then at the global level.",
      "section_level": 2,
      "section_title": "Evolution of Chinese Grand Strategy"
    },
    {
      "index_sentences": "All right. Let's take us into the future, Rush. What's the broader open source project that you're launching at CFR? Sure. Well, let me just say, for me, I'm continuing my research at Georgetown as a professor there.",
      "section_level": 2,
      "section_title": "The Open Source Project at CFR"
    }
  ]
};
window.faq = {
  "qas": [
    {
      "answer": "It's not just about how fast economies grow, but how that growth translates into strategic capabilities and affects decisions on the global stage.",
      "index_of_source": "Historically, these have mattered. The American economy has a high level of innovation and adaptability, while China has shown remarkable growth and resilience. However, in this context, the expectation cone isn't just about how fast the economies can grow but how that growth translates into strategic capabilities.",
      "question": "How does economic growth relate to strategic capabilities?"
    },
    {
      "answer": "Scale allows nations to leverage their size effectively, translating large populations and resources into power and influence, which is a pivotal arena for competition.",
      "index_of_source": "Now, scale matters because it’s the element that allows nations to leverage their size effectively.",
      "question": "Why is scale important in the competition between the US and China?"
    },
    {
      "answer": "China makes about half the world's chemicals and ships, 67-70% of electric vehicles, over three quarters of batteries, 80% of consumer drones, 90% of solar panels, and 90% of refined rare earths.",
      "index_of_source": "They're about half the world's chemicals. They make half the world's ships. They make 67, 70 percent of the world's electric vehicles, more than three quarters of the world's batteries, 80 percent of the world's consumer drones, 90 percent of the world's solar panels, 90 percent of the world's refined rare earths, and we're not done because they're betting on the next industrial revolution, right?",
      "question": "What are some key areas where China's manufacturing output significantly exceeds that of the US?"
    },
    {
      "answer": "Challenges like macroeconomic problems and aging demographics might not matter as much in the relevant timeframes for great power competition, potentially offset by purchasing power adjusted GDP, the timing of dependency ratio changes, investment in robots, and a focus on market share over profits.",
      "index_of_source": "But I think if you walk through those, you see those problems are probably a little overstated too.",
      "question": "Despite potential economic/demographic challenges, how might China maintain strategic advantages?"
    },
    {
      "answer": "The critical path to Chinese failure, particularly in the 21st century, runs through a failed political transition from President Xi to his successor.",
      "index_of_source": "But political leadership is a tough one. I think if there's a path to Chinese failure, right, if there's a path to Chinese sort of inability to succeed in the 21st century, that path runs through a failed political transition from President Xi to his successor.",
      "question": "What does the text suggest is the critical risk or path to failure for China?"
    },
    {
      "answer": "The US lacks scale alone and needs allies to match or exceed China's scale, as this is presented as urgent to avoid being smaller relative to China and potentially losing the century to them.",
      "index_of_source": "And the reason it's essential is because we're underestimating China's sense of scale.",
      "question": "Why is leveraging allies considered essential and urgent for the United States in competing with China?"
    },
    {
      "answer": "Examples include Japanese and Korean investment in American shipbuilding, the US transferring sensitive military technology like nuclear submarines (AUKUS example), forming novel joint military formations like anti-ship missile battalions, and allies helping each other, such as South Korea helping Europe rearm or Scandinavian countries selling missiles to Southeast Asia.",
      "index_of_source": "And there's a lot of ways in which you could imagine that, Jordan. You could imagine, like, take defense. You could imagine Japanese and Korean investment in American shipbuilding, right?",
      "question": "What are some examples of how the US could build \"allied scale\" capacity with partners?"
    },
    {
      "answer": "Being too coercive risks pushing allies away, potentially leading to strategic autonomy born out of dissatisfaction, hedging with rivals like China, changing allies' domestic politics to become more anti-American, or activating questions of face and respect that lead allies to make decisions against US interests.",
      "index_of_source": "The risk of the current approach, though, is that it's so intense that it pushes Germany out of being a core US ally on the things that we care about.",
      "question": "What is the risk of the US being too coercive with its allies?"
    },
    {
      "answer": "After the Cold War until the global financial crisis, China pursued a strategy of \"hiding capabilities and biding time\" (blunting American power quietly). After 2008, the strategy shifted to \"actively accomplish something\" (building order within Asia). Since 2016, it has become a global grand strategy (\"great changes unseen in a century\") focused on global power projection, economic dominance, technological leadership, and changing global institutions.",
      "index_of_source": "And the conclusion was that China had, since the end of the Cold War, a grand strategy to displace American order first at the regional level and then at the global level.",
      "question": "How has China's grand strategy shifted over different periods since the Cold War, according to the text?"
    }
  ]
};
</script>
