...
[China's Low-Key Response to the Iran Crisis](https://traffic.libsyn.com/secure/ea0f0fdd-2944-4ff3-8a00-704e8c67d58b/CGSP_01202025_Libsyn.mp3?dest-id=4287628)
...
Some people are trumpeting the end of the American empire and saying that China is going to replace or hasten that as a sort of anti-colonial even or sort of, you know, non-Western force that operates differently.
I caution against both of those narratives. **Basically, I would say that the American empire may be on the decline in some places, but it's still there and it's still the predominant hegemonic force in a lot of these regions.** That's obviously true in **Latin America**, and it's also increasingly clear in the **Middle East**.
...
But two other quick points before we go.
Number one is you've talked about how they're not reliant on **Iranian oil**, but about **30 to 40 percent of Chinese energy that's imported every year does pass through the Straits of Hormuz**.
...
> _escalating the situation, moving it away from their strengths of diplomacy and moving it toward a kinetic conflict._
...
> _"America is great and it's so much more powerful than China. Look at how China was trumpeting how great it was and how it was going to be a major player. And now, you know, look, we've proven that we're still the big dogs in town."_
...
- [ChinaGlobalSouth.com](https://ChinaGlobalSouth.com)
...
It's coming out in June, and all the great analysis from people like Bill are going to be on this new platform. So keep your eyes out for that.
...
and share your thoughts on today's show.
...
<script>window.tocIndex = {
  "index": [
    ...
    },
    {
      ...
      "section_title": "Podcast Welcome and Iran Situation Overview",
      "section_level": 1
    },
    {
      "index_sentences": "Today we're going to dive into the situation in Iran.",
      "section_title": "Dramatic Past Few Weeks in Iran",
      "section_level": 2
    },
    {
      "index_sentences": "Now, throughout all of this, there was also the prospective threat that the United States was going to launch some type of military intervention, potentially alongside Israel.",
      "section_title": "US Military Intervention Threat and China",
      "section_level": 2
    },
    {
      "index_sentences": "There was this kind of giddy excitement in some of the MAGA circles and conservative podcasts and conservative media that the United States has successfully cut off the oil supply from Venezuela to China.",
      "section_title": "China's Oil Supply and Conservative Media Excitement",
      "section_level": 2
    },
    {
      "index_sentences": "But it's interesting because the Chinese reaction—you would never know that so much was potentially on the line.",
      "section_title": "The Subdued Chinese Reaction",
      "section_level": 2
    },
    {
      "index_sentences": "So to find out why there's been such a divergence between Venezuela and Gaza earlier and now Iran, we have our old friend back on the show, one of the leading China-Iran scholars in the world, William Figueroa, who is an assistant professor at the University of Kroningen in the Netherlands and really, again, one of the great go-to people on this issue.",
      "section_title": "Introducing William Figueroa",
      "section_level": 1
    },
    {
      "index_sentences": "Well, you started your column saying Chinese officials have struck a cautious tone in response to the protests.",
      "section_title": "China's Cautious Tone in Response to Protests",
      "section_level": 2
    },
    {
      "index_sentences": "Absolutely. Well, first, I just want to take a moment to acknowledge what you said at the beginning, that these are some of the most serious protests we've seen in Iran since at least the Jina Amini protests or the Women Life Freedom movement a couple of years ago.",
      "section_title": "Nature of the Iranian Protests",
      "section_level": 2
    },
    {
      "index_sentences": "OK, so before we get to the China part of this, are there similarities to these protests than to those that we saw in other Gen Z riots, say, in Indonesia, Nepal, Manila and also in Nairobi, where young people in particular were frustrated with corruption?",
      "section_title": "Similarities to Other Gen Z Riots",
      "section_level": 3
    },
    {
      "index_sentences": "So this is getting, as I mentioned, a lot of people in conservative media and mega circles in Washington excited that there is the prospect that the regime, the Ayatollahs in particular, are in jeopardy of collapsing.",
      "section_title": "The China-Iran Relationship: Iran's Lifeline?",
      "section_level": 2
    },
    {
      "index_sentences": "Well, first of all, yeah, as you said, there are these kind of more serious questions now about the survival of the Iranian government.",
      "section_title": "Iran's Political Stability and Oil Supply",
      "section_level": 3
    },
    {
      "index_sentences": "More importantly, they might even be thinking: \"You're going to cut off the oil from Iran?",
      "section_title": "Debunking the \"$400 Billion\" China-Iran Investment Narrative",
      "section_level": 2
    },
    {
      "index_sentences": "Let's just take a very quick pause there because not everybody may understand the $400 billion reference that you're making.",
      "section_title": "Strategic Partnership and MOU Context",
      "section_level": 3
    },
    {
      "index_sentences": "Yeah. And Saudi Arabia, of course, being the most important country in the region.",
      "section_title": "China's Subdued Response vs. Venezuela",
      "section_level": 2
    },
    {
      "index_sentences": "What do you think of the criticism that we have heard quite a bit in media narratives and on social media as well that says Venezuela and Iran were both all-weather and strategic partners of the Chinese, and when push came to shove, the Chinese weren't there to help or to defend them?",
      "section_title": "Critiques of China's \"All-Weather\" Partnerships and Hard Power",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, this was one of the points that I was making over the past week and some of the conversations I was having with folks that they say: \"Well, listen, the Chinese have built up this massive Navy, this huge military investment, and you would think that they could deploy it in order to counter a Chinese or a U.S. intervention in that respect.\"",
      "section_title": "China's Military Investment and Strategy",
      "section_level": 2
    },
    {
      "index_sentences": "To give you a great example of how this kind of exaggeration versus reality happens, a couple of years ago, there were reports that there was a doubling of the presence of China's fleets in the Persian Gulf.",
      "section_title": "Exaggeration vs. Reality of China's Power Projection",
      "section_level": 3
    },
    {
      "index_sentences": "Number one is you've talked about how they're not reliant on Iranian oil, but about 30 to 40 percent of Chinese energy that's imported every year does pass through the Straits of Hormuz.",
      "section_title": "Vulnerability in the Straits of Hormuz",
      "section_level": 2
    },
    {
      "index_sentences": "Sure. So, I mean, there is, without a question, a serious issue.",
      "section_title": "China's Diplomatic and Economic Approach to Conflict Prevention",
      "section_level": 3
    },
    {
      "index_sentences": "So you've raised your own expectations, and then China doesn't meet them, and everyone is shocked.",
      "section_title": "China's Strategic Sidelines and Expectations",
      "section_level": 2
    },
    {
      "index_sentences": "Very quickly before we go, just, you know, you talk about kind of misreading the situation.",
      "section_title": "The Long Game: Misreading Strategic Failure",
      "section_level": 2
    },
    {
      "index_sentences": "One last question, and I'm throwing you a curveball here, so if you want to kind of deflect it, that's fine.",
      "section_title": "China's Engagement with Israel",
      "section_level": 2
    },
    {
      "index_sentences": "And if I could add just one last bit in the interest of, you know, this kind of things that people aren't necessarily thinking about enough.",
      "section_title": "China's \"Behind-the-Scenes\" Role: Surveillance Technology",
      "section_level": 2
    },
    {
      "index_sentences": "Well, that is a great place for us to end.",
      "section_title": "Conclusion and Podcast Information",
      "section_level": 1
    }
  ]
};
window.faq = {
  "qas": [
    {
      "question": "Why has China's reaction to the protests and potential U.S. intervention in Iran been significantly more subdued compared to its response to the Venezuelan situation?",
      "answer": "China's reaction to Iran has been subdued due to less investment in the relationship, with only pro forma denunciations of U.S. threats and no concrete actions like evacuating citizens. The economic ties are not as strong as often portrayed, making Iran less critical for China compared to Venezuela's immediate regional implications.",
      "index_of_source": "But it's interesting because the Chinese reaction—you would never know that so much was potentially on the line."
    },
    {
      "question": "What is the reality behind the widely reported $400 billion investment figure between China and Iran?",
      "answer": "The $400 billion figure is a complete exaggeration, stemming from poor journalism and anonymously sourced articles, bearing no resemblance to the actual hundreds of millions of dollars China invests annually in Iran, which is far from the billions implied by the figure.",
      "index_of_source": "There's this narrative of $400 billion worth of investment that's gone into Iran or is going into Iran over the next 25 years, which is a complete exaggeration."
    },
    {
      "question": "How significant is the threat to China's oil supply if both Venezuelan and Iranian oil exports were cut off, as suggested by some conservative media in the U.S.?",
      "answer": "While cutting off Venezuelan and Iranian oil would amount to about 20% of China's imported oil, it wouldn't significantly cripple China financially as it has diverse suppliers like Russia, Saudi Arabia, Iraq, and Brazil, and can also seek new partnerships like with Canada.",
      "index_of_source": "You put it together. It's a lot. But China gets oil from so many other places."
    },
    {
      "question": "What is the primary focus of China's substantial military investment, and does it enable global power projection similar to the U.S.?",
      "answer": "China's massive military investment is primarily designed for the Western Pacific, specifically focusing on Taiwan, the first and second island chains, and periphery defense, rather than projecting power into distant regions like the Mediterranean, Persian Gulf, or Latin America.",
      "index_of_source": "that military investment that the Chinese have made, as you pointed out, is really specifically designed for the Western Pacific and the first and second island chain, with the focus on Taiwan and then periphery defense."
    },
    {
      "question": "Despite its subdued diplomatic response, how has China already played a role in the Iranian government's ability to suppress protests?",
      "answer": "China has quietly assisted the Iranian government by selling a lot of surveillance technology and drones, along with training kits, which have contributed to the increased technological sophistication and effectiveness of the repression seen in Iran over the last decade.",
      "index_of_source": "And one thing that China, I kind of alluded to this in the article that I posted for you guys, is that one thing it's done is sold a lot of surveillance technology and drones technology to Iran."
    },
    {
      "question": "What does the text suggest about China's overall approach to international relations and its role in challenging the U.S.-backed international order?",
      "answer": "China is not aiming to replace or overthrow the U.S.-backed international order through aggressive military means but rather seeks to redefine and alter it fundamentally using economic investment opportunities and alternative diplomatic platforms.",
      "index_of_source": "I do think that there's been an overblown narrative of China is coming to replace and overthrow the U.S.-backed international order coming from the opposite end of the spectrum."
    },
    {
      "question": "What is China's primary concern regarding the Straits of Hormuz, and how does it plan to address potential disruptions there?",
      "answer": "China is very concerned about any potential closure or disruption in the Straits of Hormuz, as 30-40% of its imported energy passes through it. Its primary strategy to address such issues is through diplomatic and economic resources, rather than military intervention.",
      "index_of_source": "I mean, if you looked at even just the downward effects of downstream effects of rerouting of so much shipping—not of oil flows, but of just commercial shipping—during the Ansar Allah attacks on Red Sea shipping cost China a lot of money."
    },
    {
      "question": "Given the tensions with Iran, why did China's special envoy for the Middle East, Jai Jun, visit Jerusalem and meet with the Israeli Foreign Minister?",
      "answer": "China's visit to Jerusalem and meeting with the Israeli Foreign Minister, even amidst tensions involving Iran, underscores Israel's importance to China's Middle East strategy, not just for bilateral economic ties (like R&D cooperation), but also for maintaining connections with diverse partners in the region.",
      "index_of_source": "And Israel has always been an important part of China's strategy in the Middle East, not just because of something to do with their bilateral relationship, which is valuable to China as a kind of a way to a lot of, for example, a lot of Chinese companies do R&D in Israel."
    }
  ]
};
</script>
