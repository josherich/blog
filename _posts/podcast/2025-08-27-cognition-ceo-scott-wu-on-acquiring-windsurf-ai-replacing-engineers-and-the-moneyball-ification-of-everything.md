...
[Cognition CEO Scott Wu on acquiring Windsurf, AI replacing engineers, and the Moneyball-ification of everything](https://media.transistor.fm/ea7ef508/f8aee0b5.mp3)
...
So, for this guy, you can just jump it upside down like that.  
And for this guy you can just jump it upside down like that.
...
**Scott Wu** is the co-founder and CEO of **Cognition** which makes Devon the AI coding agent.  
...
But it's things like, you know, yeah, like **math puzzles**, things like, you know, the frog that's like going up and then every night falls down the well and how many nights.
...
I have a middle school degree, but, you know, I didn't really make it through high school  
or college.

So I left high school a year early.

I spent a year actually in the Bay working at a company called **Adapar**.
...
And then **Srinath RA**, who's most recently at Sandbar as the CDO.

Wait, sorry.
This is a real **small group theory moment**.  
So you and **Alex** were in the same—  
That's right. So we knew each other. We met in **middle school**.  

Alex now of **Meta**.  
Yeah. Now of Meta, that's right. **MSL**, I guess.  
Yeah, and so we met in sixth grade. He was from **New Mexico**. I was from **Louisiana**.  
...
It turns out there's some **math and AI**.  
Yeah, this may be an inspiration.  
Yeah, yeah, it's a fun thing.  

Well, a lot of the folks, as it turns out, from our vintage ended up being—  
I think there's a real infectiousness of being **entrepreneurial**, too.  

I think **Alex deserves a lot of credit** for, I'd say, being the first of our group. Alex Wang got you into the idea of starting a company.  
...
I was going to say, I appreciate you calling me young.  
I mean, I think relative to being 18 or 19, you know, it's still a long way. The test is like in your 20s.  
...
And so, so it really just came down to how sharp you were and how good you were at making your own decisions. I think now there's, there's a lot more experience to draw from. Maybe that's part of it.
I also do kind of just have a theory of like, I guess I would call it **the money ballification of everything**.  
...
It's very, of course, people kind of think of it as—people know that like the **poker solvers** and the **odds tables** and everything like that—  
**"Is it more mathematical than that?"**  
No, no, I think that's right. I think that's right.  
...
We've been talking about that. Now there's Windsurf as well, so now there's a third thing. But I think some consolidation is probably good.
Okay. And so people are maybe familiar with the, you know, the **GitHub Copilot** or the **IDE style paradigm** where you're there writing code in your, in your IDE and it helps you autocomplete it, or you can give some instructions in the IDE. 
...
**How do you get large enterprises comfortable with giving Devons sufficient permissions to be effective?**  
...
- We strongly recommend that people using Devon don't give it production database access, for example.  
...
Devon naturally slots neatly into all of these things.  

Typically, the way folks will work with Devon is they’re doing some big code migration and will break up the task. Maybe they have **50,000 files** that all need to be upgraded from one version of Angular to another. Devon will do each one and make pull requests.  
...
In practice, what we see especially in enterprise migrations is when folks measure internally, they see something like an **8 to 15x gain** for a lot of use cases with Devon.  
...
What’s not totally obvious is the impact on metrics like **PRs per developer** or what’s happening in that space.
Generally, you see some increase there. But, of course, **it's not clear how good even a pull request per dev metric is**. And then maybe you can say that there is some ongoing maintenance cost if you're shipping low quality code or something like that.
...
I think what we're getting to with **RL** as this thing is improving and improving, like, and we see more and more of the gains and people are developing the techniques.
You know, I think of **RL** and this paradigm of **AI** as basically the **platonic ideal** of it is the ability to solve any benchmark, right?  
...
So how have the newly released **Cloud 4.1** and **GPT-5** done this benchmark?  
...
Over the last 10 years or so, I think there was a real time where most of the stuff that was being built was a lot more incremental, basically, right? Like, each next thing and building for a particular niche or for a small part of the workflow and making that more efficient.
And **AI now**, I think, is the total opposite of that in the sense that, **now we're talking about the entirety of knowledge work and perhaps the entirety of physical work as well**, depending on what happens with robotics, right?

And so, first thing is there's just going to be a lot of AI.  
**Yes.**
...
**Yeah, yeah, for sure.**  
Yeah, seat-based to usage-based, big, big, big, big one for sure. I think on both sides, right, from the perspective of one, **seats don't really make sense when the AI themselves are arguably seats as well**, you know, like, they're doing a lot of the labor, too.
...
**Yeah, yeah.**  
Like, just at Devin, can you go buy some more whiteboards for us or something like that?  
**Yeah.**
...
You know, a lot of Devin working really well, obviously, relies on Devin being able to do these things and then you get through a bit.  
But some of these things, you know, I think are quite natural with the model, which is, you know, you often have **API keys or secrets** or things like that that you want Devin to be able to hold on to.  

And so, that works for **credit card numbers** as well.  

And, obviously, there's a lot of work of, you know, **real-world software engineering** doesn't involve a lot of just going and browsing the web and finding different sites and clicking around on that.  
You know, even if you're just testing your own front end or putting in documentation or something.  
...
Like, doesn't everyone want this magic wand app where you can just have your virtual assistants?  
Like, there's a million virtual assistant startups.  
It seems like none of them have really gotten to any scale.  

**Yeah, it's a fun question.**  
I think from our perspective, like, I think, on the one hand, like, it's fun seeing Devin go and do these **DoorDash** things.  

At the same time, we also just know that, you know, our team is so small.  
We just don't have the kind of, you know, focus to be able to do that in addition to doing software engineering.  

You're pulling up Devin and you're seeing this.  
And then, on the other side, there's, like, the **IDE** there.  
But, like, you know, Devin's just going on DoorDash or something.  
You know, it's a very, like, fish-out-of-water experience.  
And I think it's fine for us to keep it.  

But, you know the way a lot of product development follows from people noticing how a product is being used.  
Like, emergent patterns.  

**Exactly, and these emergent patterns.**  
Like, **Twitter especially**, you know, people started linking to photos off-site.  
So, they built, you know, in native image support.  
Or the **hashtag** was invented by the community.  

So, similarly, you know, you're checking the Devin logs and you notice people are buying a lot of DoorDash.  
Like, maybe that's a suggestion on the product side of things.  
...
And Devin went to the site and, naturally, the site forwards you to their agent to have the conversation.  
And then Devin was kind of, like, explaining these things and, like, wasn't making progress.  
And then, at some point, Devin said,  
...
He basically made it past the robot agent equivalent and then got to a human.  

And did it successfully get the flight refund?  
It got the refund, yeah.  

Okay.  
Well, again, the people want this.  

Going back to the economic infrastructure for AI, the other thing that, you know, we think about is it feels like **trust**.  
AI is going to become a bigger deal online.  

**Yeah.**  
I don't quite know what form that takes, because, obviously, you know, it's been a **big, bad internet** for a long time.  

**Yeah.**  
There's a lot of scams out there.  
There's a lot of hacking.  

But, I don't know, the hacking attempts become more sophisticated, the **deep fakes** and everything.  

And so, having a good sense of who is a trusted individual, who is a trusted business.  
**Yeah.**  
Just seems to become much more important in this world.  

**Yeah, yeah.**  
Like, related to that, too, I also think one of these things, you know, I feel like the **Cloudflare with agents** and everything is a hot topic.  

Explain the **Cloudflare** issue.  

Oh, yeah, yeah, yeah, of course.  
So, you know, there's a lot more agents browsing the web these days.  
And there's been certain things, you know, protections set up to not give agents access to websites.
And I think the **paradigm**, up until now, the paradigm for a lot of this stuff, I mean, there's **robots.txt** and all these things, has often been basically almost like, there are tons of things which you are **not allowed to do as a non-human**.
...
And how does the existence of **Devon** affect your own hiring of engineers?
...
I think at that point, obviously, the **jobs change a lot**.
Funnily enough, I mean, I think, if anything, **we will have way more software engineers, not fewer**. And I think just because the **interface is not code anymore doesn't mean that the core skills of software**.
...
I think one of the nice things is everyone talks about **Jevin's paradox and how it relates to AI**. You know, I think there's nowhere that it's more true than software because, you know, we really never seem to run out of demand for more code and more software. You can just run a lot of software.

You know, the half-joking way to say this is despite how many software engineers in the world, you know, we all know this, there are so many products out there that are still so bad:
...
One was a big hardware component of, like, yeah, you had to just go ship modems to everybody and you had to get people on the internet and you had to give everyone a phone first, right?
And then two was, like, a very core **critical mass effect** or, like, you know, **empty room effect** or whatever, you know, **network effect**, whatever you want to call it, where the internet was great and all, obviously, but, like, it doesn't really get that useful until **all your friends are on the internet, too**.
...
Exactly.
And so it's like, if it even waited until **Thursday**, instead of **Monday**, people were going to cancel their contracts, people were going to be interviewing at other places.
...
Did you also pull an all-nighter that Saturday night, or did you get some sleep?  
We got a couple hours of sleep on **Saturday**. It was especially, I mean, a huge shout-out to **Jeff**, **Graham**, and **Kevin** because they had had a pretty rough few days before as well, actually. They were already pretty sleep-deprived coming into it.
...
We luckily filmed the kind of **Windsurf** video in the Windsurf studio. We said, okay, we should just film it anyway. You realize you're going to announce acquisitions without a video.  
"Yeah, yeah, yeah. It's always nice to have one."  
...
So, you got to acquire a bunch of people who have lots of familiarity with the space. They have a product offering that is in an adjacent but not identical place to **Devon**. And so, you get to accelerate the go-to-market efforts and broaden out the product portfolio.

That's how you think about it?  
"Yeah, yeah, yeah, absolutely."

And then, of course, the products themselves—funny enough, we were thinking about what does the interaction of an **async** product like Devon look like with a more **synced** product. We had some ideas for certain synchronous things that we wanted to build.
...
- Using all of the Devon code-based representation in search  
- Spinning up the agent there  
```

All of these things, I think, we just felt were a lot of natural compliments.
And so from there, it kind of felt like, you know, if there was a **right person to work with and do this with**, you know, it would be.

So in six months, do I buy **Devon's** and I get **Winsurf** bundled?  
Do I separately buy **Winsurf** and I can buy **Devon**?  
...
<script>window.tocIndex = {"index":[{"index_sentences":"And this is stuff like if I ask you what's 694 squared? It is 481,636.","section_title":"Introduction and AI Demo","section_level":1},{"index_sentences":"Scott Wu is the co-founder and CEO of Cognition which makes Devon the AI coding agent.","section_title":"Meet Scott Wu: Co-founder and CEO of Cognition","section_level":1},{"index_sentences":"Tell me about your upbringing and all the math stuff.","section_title":"Upbringing and Early Math Competitions","section_level":2},{"index_sentences":"So, I grew up, I'm from Baton Rouge. My parents were both chemical engineers and so they immigrated from China for grad school and then naturally when they were looking for jobs they were doing like air emissions permitting and things like that.","section_title":"Childhood and Introduction to Math","section_level":3},{"index_sentences":"So, I started doing math competitions in second grade. I remember there was a contest at the local college that I went to which was for like middle schoolers and high schoolers.","section_title":"Competitive Math Journey","section_level":3},{"index_sentences":"My last year of high school, which would have been my junior year, I left a year early.","section_title":"Education and Early Career","section_level":2},{"index_sentences":"I spent a year actually in the Bay working at a company called Adapar.","section_title":"First Professional Experience at Adapar","section_level":3},{"index_sentences":"How did you end up at Adapar? And that's very forward thinking of them, obviously.","section_title":"The 'Small Group Theory' Moment: Adapar Cohort","section_level":2},{"index_sentences":"OK, so this gets to something I was wondering. You know, there's this topic that people talked about a while back of, where are the young founders?","section_title":"Young Founders and Industry Vibrancy","section_level":2},{"index_sentences":"So I have, I have a take on this actually. And I'm curious to hear yours on this.","section_title":"Scott's Take: Founding Has Gotten Harder","section_level":3},{"index_sentences":"I also do kind of just have a theory of like, I guess I would call it the money ballification of everything.","section_title":"The Moneyballification of Everything","section_level":2},{"index_sentences":"To give a few examples, one of the things that I do casually for fun is playing poker, and poker is a very fun game.","section_title":"Examples in Poker, Chess, and Gaming","section_level":3},{"index_sentences":"Okay. I'm getting distracted from asking you about Cognition.","section_title":"Cognition and Devin: The AI Software Engineer","section_level":1},{"index_sentences":"So, we're building the AI software engineer. We've been building Devin for the last year and a half, and most recently just acquired Windsurf.","section_title":"What is Cognition and Devin?","section_level":2},{"index_sentences":"Devin is a very different paradigm of what I would call like an async experience, right?","section_title":"Devin's Asynchronous Paradigm vs. IDE Copilot","section_level":3},{"index_sentences":"Yep. Yep. And what level of task is Devin doing a good job of today?","section_title":"Devin as a 'Junior Engineer'","section_level":3},{"index_sentences":"What metrics can you share on where the business is at?","section_title":"Measuring Devin's Impact and Productivity","section_level":2},{"index_sentences":"There is a view that some people have out there that coding tools are a moment in time thing that get run over by increasing model performance, you know, GPT-6 or GPT-7.","section_title":"AI Coding Tools vs. Foundation Model Performance","section_level":2},{"index_sentences":"My take is actually just that overall, being a founder has just gotten harder.","section_title":"The 'Nihilist Computer Use Take' and Specific Intelligence","section_level":3},{"index_sentences":"I think the thing that we end up in is basically a point where the hard question is, all right, now what is the benchmark, right?","section_title":"Defining Benchmarks in Real-World Software Engineering","section_level":3},{"index_sentences":"As you think about the AI business and industry over the next five to ten years, you can think about all the different layers of the stack:","section_title":"Economic Infrastructure for AI","section_level":1},{"index_sentences":"So everyone always makes fun of me whenever I say this, but I think all the layers are going to do very well.","section_title":"Value Accrual and Industry Structure","section_level":2},{"index_sentences":"And so, we're building out, you know, usage-based billing infrastructure.","section_title":"Stripe's Role: Usage-Based Models and Agent Economy","section_level":2},{"index_sentences":"But, like, we order our DoorDash on Devin. You know, we order our Amazon packages with Devin.","section_title":"Devin's Real-World Agent Capabilities","section_level":3},{"index_sentences":"Going back to the economic infrastructure for AI, the other thing that, you know, we think about is it feels like trust.","section_title":"Trust and Delegating Access in an Agentic World","section_level":2},{"index_sentences":"And how does the existence of Devin affect your own hiring of engineers?","section_title":"Cognition's Hiring and the Future of Software Engineering","section_level":1},{"index_sentences":"So, like 30 people? Yeah, so up until a few weeks ago, our whole team is about 35 people of whom...","section_title":"Keeping the Engineering Team 'Tight and Elite'","section_level":2},{"index_sentences":"Sorry, build their own version of Devin or build stuff with Devin?","section_title":"Hiring Process: Building Your Own Agent","section_level":3},{"index_sentences":"When will you hire your last engineer?","section_title":"The Last Engineer and Evolution of the Role","section_level":2},{"index_sentences":"People often ask us, like, \"my son or daughter is in high school or has just started college. Should they even be studying computer science?\"","section_title":"Computer Science Education and Jevons Paradox","section_level":3},{"index_sentences":"Isn't it shocking that the UIs haven't changed at all?","section_title":"The Future of AI User Interfaces","section_level":2},{"index_sentences":"One of my thoughts on this, too, is I think AI is, I'd say, uniquely different from some of these previous ways in an important way, which is, you know, personal computer or internet or mobile phone.","section_title":"AI's Unique Impact on Product Development","section_level":3},{"index_sentences":"What are your AGI timelines?","section_title":"AGI Timelines","section_level":1},{"index_sentences":"We've got to talk about Windsurf.","section_title":"The Rapid Windsurf Acquisition","section_level":1},{"index_sentences":"So we heard the news that it was going to be Google buying Windsurf, or I guess not technically buying, this whole deal that was happening.","section_title":"Play-by-Play: Friday to Monday Deal","section_level":2},{"index_sentences":"So, you got to acquire a bunch of people who have lots of familiarity with the space.","section_title":"Strategic Synergy and Product Complementarity","section_level":2},{"index_sentences":"Do you think that stays as a thing in the AI space?","section_title":"M&A and the 'Hyperscaler or Bust' Polarity","section_level":2},{"index_sentences":"Yeah. Yeah. Yeah. I think for us, it's, you know, and most folks have been really excited to come in and do it.","section_title":"Integrating Cultures: Opt-in for Intensity","section_level":2},{"index_sentences":"Every day, Cognition is the largest company you've ever run. You're speed running coming up to, it was true of me with Stripe as well, to be clear, because you're speed running, learning how to run a company.","section_title":"Leading a Growing Company and Learning from Peers","section_level":2},{"index_sentences":"Last question. I'm curious, what is your information diet in terms of how you learn about the world?","section_title":"Scott's Information Diet","section_level":1}]};
window.faq = {"qas": [{"question": "Despite his remarkable achievements as a triple IOI gold medalist and co-founder of Cognition, Scott Wu mentions that he \"wasn't that good at school\" and dropped out of both high school and Harvard. How does he reconcile this self-assessment with his evident success, and what does this suggest about traditional education paths for high-achievers in tech?", "answer": "Scott clarifies that he \"wasn't that good at finishing school,\" having left high school a year early and dropping out of Harvard after two years. His path involved working at Adapar as a software engineer before attempting college, indicating a non-traditional route focused on practical experience and deep engagement in specific areas like math competitions and programming, rather than formal academic completion.", "index_of_source": "Well, I just, you know, I wasn't that good at finishing school, you know."}, {"question": "Scott Wu describes a \"moneyballification of everything,\" where fields like poker and chess have evolved from relying on intuition to being dominated by mathematical optimization. What causes this shift, and what implications does it have for creativity in these domains?", "answer": "Scott explains that as a space matures, the underlying \"math\" becomes clearer and the \"right questions to ask\" become known. In less mature spaces, sharp intuition and first-principles thinking are crucial, but with maturity, the skills selected shift towards mathematical analysis and optimizing towards an \"optimum,\" potentially leading to less obvious creativity in the traditional sense, as seen in the \"romantic style of play\" in chess giving way to optimized moves.", "index_of_source": "But the one thing that's kind of interesting is you see it in the evolution of the top players in the space as well."}, {"question": "Cognition's Devin operates on an \"async experience\" model, delegating tasks at a \"ticket level\" or \"project level,\" distinct from synchronous IDE tools. How does this async model make Devin's productivity impact more measurable than other AI coding tools, and what kind of gains are observed?", "answer": "The async model makes Devin's productivity more measurable because it handles tasks \"end to end,\" allowing for a clearer assessment of engineering hours saved, such as a migration being completed by Devin and a human merely reviewing the pull request in minutes. This approach leads to reported gains of \"8 to 15x\" for many use cases, with Devin typically merging 30-40% of all pull requests in a successful organization.", "index_of_source": "On the other hand, with agents, a lot of the workflow obviously is going and doing the task for you, right?"}, {"question": "Given the rapid advancements by AI labs (e.g., GPT-6, GPT-7), how does Cognition, as an application layer company, plan to avoid getting \"run over\" by increasingly powerful general models?", "answer": "Scott argues that \"software engineering in the real world is so messy,\" involving significant \"contextual knowledge\" and \"industry details\" not easily covered by general intelligence. While general intelligence improves, the challenge lies in defining the specific \"benchmark\" for real-world tasks, such as fixing a Grafana dashboard where a server is running the wrong package version, which requires specific intelligence and product delivery experience that labs alone might not possess.", "index_of_source": "I think the biggest thing I would just say here is software engineering in the real world is so messy, and there's all sorts of these things that come up."}, {"question": "Devin, an AI software engineer, is used internally at Cognition for non-software tasks like ordering DoorDash, Amazon packages, and negotiating flight refunds. How does Cognition address the inherent trust and security challenges when an AI agent performs real-world commerce on behalf of a human, especially regarding site blockers and sensitive information?", "answer": "Cognition acknowledges the challenge of sites blocking bot activity but suggests a future where access is delegated, allowing agents to act \"on your behalf\" and attaching \"reputation\" to their actions, similar to API key permissions but at a mass consumer scale. This would involve the agent holding onto API keys or secrets, and the user being responsible for its actions, as seen in Devin successfully chatting with an airline agent and using contract links to secure a flight refund.", "index_of_source": "But, like, we order our DoorDash on Devin."}, {"question": "Scott Wu predicts a significant shift in software engineering within two to four years, where engineers might stop using code as the main interface. What does he envision the role of a software engineer will be in this future, and how will traditional computer science education remain relevant?", "answer": "In this future, software engineers will primarily instruct computers, making architectural and high-level decisions (e.g., \"we need to make a new page here,\" \"save this data this way\") without directly looking at code, similar to how assembly is not used today. Scott believes there will be \"way more software engineers, not fewer,\" and traditional computer science education will remain absolutely vital for teaching theoretical concepts and problem-solving with the computer as a tool, rather than just syntax or specific frameworks.", "index_of_source": "I'll make a distinction here, which is I think that there will come a point, and my guess on this point is probably in the neighborhood of, let's say, two, three, four years from now where we stop using code as the main interface."}, {"question": "The acquisition of Windsurf by Cognition happened incredibly fast, from hearing the news on a Friday to signing and announcing the deal on Monday. What unique factors enabled such a rapid turnaround, and what were the immediate strategic benefits for Cognition?", "answer": "The rapid acquisition was driven by the urgent \"melting ice cube\" situation, where Windsurf's customers and team needed immediate clarity. Cognition could act swiftly because they already \"knew the space very well\" and didn't require extensive due diligence on the product or customers. Strategically, Cognition gained Windsurf's intact non-research/product engineering functions (enterprise engineering, go-to-market, etc.), which Cognition was \"a little bit behind on,\" and acquired complementary product synergies for integrating synchronous IDE experiences with Devin's asynchronous agent.", "index_of_source": "So we heard the news that it was going to be Google buying Windsurf, or I guess not technically buying, this whole deal that was happening."}]};
</script>
