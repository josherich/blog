...
[Learning from Ukraine, Preparing for Taiwan](https://pscrb.fm/rss/p/traffic.megaphone.fm/CHTAL4426296547.mp3?updated=1755659614)
...
He also writes the excellent **Ventura Doctrina** Substack, which has taught me a tremendous amount over the past few years.
...
> "It would be a very grave error to think that great contests are won solely by larger and larger forces moving inexorably towards victory, by global trends, or by sophisticated causation chains.  
> To be sure, if vast ships occur in the economic substructure and productive forces, an overwhelming flood of ships, planes, and guns being sent to the battles, then it is more likely that the enemy's battalions will be pressed.  
> Indeed, if victory did not follow, the historian would be hard-pressed to explain that.  
> But the deficit in all deterministic explanations is that they lack human agency."
The victors' **ships, planes, and guns** need **courageous men** to steer them, **insightful men** to organise them, and **clever men** to give them superior battlefield performance.
...
Some of that range of **tactical decision making by AI and computers** will continue to be extended, I think. But I think the big questions about **war**, about whether to go to war, the key trajectory of war, whether to end a war, will remain human.
...
And I think we've seen that in the air as well. You know, **this has not really been an air war.** There's been it's been a drone war, but there hasn't been a large scale air war. So, you know, the future of air warfare is probably more about what we saw Israel using against Iran than what we've seen in Ukraine.
...
So, one more time on the sort of like humans lending decision making to AI, maybe because it seems to me, you know, before we're going to have a **humanoid robots** that can do everything that infantry do; before we're going to have robots make crazy **material science breakthroughs**, like the types of things that someone in a command post or someone managing a battalion or whatever—those sorts of decisions seem to me to be closer than, you know, **AGI or what have you**.
So I guess maybe from another way to get at this maybe is like, what would you need, like, what would you need to see from, you know, your **war games** or your interactions with, you know, some **automated command and control system** in order for, you know, you as a **commanding officer** to start handing more and more of the reins over up from the super tactical stuff towards the more operational decisions.
...
When all the science disproves that and we've failed to act.
So ultimately, **humans are pretty good at ignoring facts and data if it's in their economic or their ideological interests**. And because of that, we'll continue to do things like go to war, just as we have in **Ukraine** and just as we may in other places in the future.
...
**Philip Blom**'s book, *The Vertigo Years*, looks at each year in the 15 years that led up to the beginning of World War I and examines societal, technological, industrial issues that emerged and how the world in 1914 ceased to exist by 1918.
...
I mean, I think those two periods for me would be really, really interesting. And then probably, you know, the **United States in 1940-41**.
...
From a **European perspective**, they assumed they could continue being **economically integrated with Russia**, and that would condition their behavior towards its neighbors. Very much the old Norman Engel, "won't go to war because we're economically integrated" model.
...
The Russians used everything in their inventory against the Ukrainians. So none of this was escalatory, but it was used by the peace nicks and the risk-averse in the Biden administration to slow down aid.
...
- The polls that look at **Taiwanese views of themselves** — are they Chinese, are they Taiwanese, these kinds of things.
So that's the necessary foundation for any exploration of the ongoing **tension and competition between Taiwan and China**.

And, well, of course, you need to understand **regional dynamics**. There's no regional NATO; there are some alliances that are very important. You know, **Indo-PACOM in Hawaii** is central to all those, I think. So they're the kind of essential ingredients of any understanding of the situation in the **Western Pacific**.
...
> _"don't augur well if we're not decisive and determined in standing up for not just Taiwan, but all democracies in the Western Pacific and pushing back against coercion, subversion, and aggression."_
...
> _"this is an ideological war."_
...
> _"it will be about who is number one in the world."_
...
> _"It's a multi-domain war, and the area of decision will be that strip of land within a thousand kilometers of the Eurasian heartland that runs from Vladivostok to Tasmania."_
...
Well, I think it's still the way we do business. I think you've seen a step up in foreign assistance to Taiwan, even though not all of it will be declared.
**But it is a way of signaling** that you are taking a big risk of targeting **Taiwan**, because if you hit these people of ours, regardless of which country they're from, you will have to answer to us. So I think that's still a valid theory.
...
This was a subject I wrote about in a detailed report with **Peter Singer**, published through an American think tank in June this year. It pointed out that this will continue into the future and may get more sophisticated because **AI** will help us not just see more, but also help us deceive more.
...
I'm curious, because at other points in time, and I think one of the big lessons of the **Ukraine wars** is that 

> there isn't really one thing that you can sort of cook up at home that is going to drastically change everything for you.
So what was your thinking behind kind of concluding your book with something that was cooked up under a **mountain** that has this **big strategic effect**?
...
I'm curious if there are a handful of books that come to mind that are maybe, like, I wouldn't want to say entry-level, but maybe starting points for folks who haven't already read 15 books of military history — to give folks a sense of just how messy the introduction of new technology to warfare ends up playing out in practice.
Yeah, I think some of the stuff about the **interwar period**, the debate about **tanks and cavalry**, and the debate about **battleships versus aircraft carriers** were important debates about an old and a new technology and their potential impact on war.  
...
**Andrew Krepinovich, Origins of Victory.** These are sort of like chapter-length, not really anecdotes, but they almost feel reported—like they have characters, and they develop over time.  
...
And all of the little iterations you need that lead you all the way to **Midway**.
**It's, it, it, it, it shows kind of the personalities that you need to have in these systems in order to sort of feel your way through the darkness.**

And then **The Wizard War by R.V. Jones.**  
It's written by, written by an engineer. It's a memoir. It's, like, got a lot of color, a lot of characters. And I think sort of does the, does a really good job of, of illustrating just how **dynamic these sort of technological competitions can be, where you have engineers on both sides trying to sort of outdo each other.**
...
> "All of the deaths in Afghanistan could be acknowledged individually."
Because they would happen sort of spaced out enough to have people to give people time to grieve individually, whereas, in our future **Taiwan war**, they're happening by the dozens and by the hundreds on a daily basis, which just changes like the quote unquote **battle rhythm for grief**.
...
Well, I'm gonna lay my burden down by the riverside.  
Down by the riverside.  
Down by the riverside.  
Down by the riverside.  
Down by the riverside.  
I'm gonna lay my burden down by the riverside.  
**Study water no more.**

Well, I ain't gonna study water no more.  
I ain't gonna study water no more.  
I ain't gonna study water no more.  
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "5,000 years of history proves that humans are not smart enough to prevent war. It's very imaginable that America and China could find themselves at war, regardless of any economic interest they have in not going to war.",
      "section_level": 1,
      "section_title": "Introduction: The Inevitability of War"
    },
    {
      "index_sentences": "Mick Ryan is a retired major general in the Australian Army, author of three books: War Transformed, A near-future Taiwan war piece of fiction called The White Sun War, The War for Ukraine: Strategy and Adaptation Under Fire.",
      "section_level": 2,
      "section_title": "About Mick Ryan"
    },
    {
      "index_sentences": "He also writes the excellent Ventura Doctrina Substack, which has taught me a tremendous amount over the past few years.",
      "section_level": 2,
      "section_title": "Influence of Ventura Doctrina"
    },
    {
      "index_sentences": "So we're not passing up an opportunity to open a show with Andrew Marshall. You're fond of the following quote: That is a mouthful and potentially a little self-serving coming from the net assessment guy.",
      "section_level": 1,
      "section_title": "The Human Element in Warfare"
    },
    {
      "index_sentences": "Yeah, I mean, I think it's a really important quote because it goes beyond the current focus or obsession with AI and drones.",
      "section_level": 2,
      "section_title": "Beyond AI and Drones: The Centrality of Humans"
    },
    {
      "index_sentences": "So kind of on the other side of the spectrum, you have a book like Paul Kennedy's The Rise and Fall of Great Powers.",
      "section_level": 1,
      "section_title": "Industrial Capacity vs. Human Agency"
    },
    {
      "index_sentences": "So why isn't it just the sort of like, GDP or correlation of how many factories you have that ends up deciding this stuff and actually what Andrew Marshall was getting at?",
      "section_level": 2,
      "section_title": "The Clever Application of Industrial Power"
    },
    {
      "index_sentences": "So, he has a quote at the end of Victory at Sea: It would be a very grave error to think that great contests are won solely by larger and larger forces moving inexorably towards victory, by global trends, or by sophisticated causation chains.",
      "section_level": 2,
      "section_title": "Paul Kennedy on Human Agency in Victory"
    },
    {
      "index_sentences": "Yeah, and, as someone wrote recently, we thought the future of war was drones, and then Bakhmut happened.",
      "section_level": 2,
      "section_title": "The Additive Nature of War and Technology"
    },
    {
      "index_sentences": "Mick, can you imagine a future where the longbow makes a comeback?",
      "section_level": 3,
      "section_title": "Future of Archaic Technologies"
    },
    {
      "index_sentences": "Speaking of human beings, another book, which I want to credit you for turning me on, is On the Psychology of Military Incompetence, written by Norman Dixon, who's a royal engineer for 10 years and then becomes a professional practicing psychologist.",
      "section_level": 1,
      "section_title": "Military Incompetence and AI Decision-Making"
    },
    {
      "index_sentences": "I think he got it partially right. I don't think it's the full story.",
      "section_level": 2,
      "section_title": "Beyond Dunderheads: Rockstars in Military Affairs"
    },
    {
      "index_sentences": "But short-term tactical engagement decisions have been made by computers in things like: Close-in weapon systems, Air defence systems for a very long time.",
      "section_level": 3,
      "section_title": "Current and Future Role of AI in Tactical Decisions"
    },
    {
      "index_sentences": "So let's talk a little bit maybe about the sort of crawl up the command chain that kind of autonomous decision making could have.",
      "section_level": 2,
      "section_title": "The \"Crawl Up\" of Autonomous Decision Making"
    },
    {
      "index_sentences": "Oh, absolutely. And for the most part, we'd be crazy not to. But there are still limits to seeking advantage.",
      "section_level": 3,
      "section_title": "Limits, Conventions, and Total War"
    },
    {
      "index_sentences": "I mean, I guess maybe like a slightly different way to get at that is like, you know, you've seen this increasing digitization of command and control.",
      "section_level": 2,
      "section_title": "AI's Role in Digital Command and Control"
    },
    {
      "index_sentences": "what would you need, like, what would you need to see from, you know, your war games or your interactions with, you know, some automated command and control system in order for, you know, you as a commanding officer to start handing more and more of the reins over up from the super tactical stuff towards the more operational decisions.",
      "section_level": 3,
      "section_title": "Human Commander Trust in AI Systems"
    },
    {
      "index_sentences": "Well, we already see this happening in digital command and control platforms that the Ukrainians are using and many others are using.",
      "section_level": 3,
      "section_title": "Tangible Benefits of Digitization and AI"
    },
    {
      "index_sentences": "I feel like your most recent book is this like extended meditation on what this war kind of confirms about the nature of war—broadly, as well as like what are the sort of disjunctures that we may see today and tomorrow.",
      "section_level": 1,
      "section_title": "Reflections on the Ukraine War"
    },
    {
      "index_sentences": "Yeah, I mean, the whole reason I wrote War Transformed was because these kind of wars are inevitable.",
      "section_level": 2,
      "section_title": "The Inevitable Nature of High-Intensity Conflict"
    },
    {
      "index_sentences": "Unfortunately, politicians and citizens still now believe, or at least before 2022, believe that this kind of thing was impossible, that conventional war wouldn't take place because of economic integration.",
      "section_level": 3,
      "section_title": "Debunking Economic Integration as a War Deterrent"
    },
    {
      "index_sentences": "So, you want to do a U.S. Civil War detour? How does, do we have lessons from that conflict for Ukraine or Taiwan?",
      "section_level": 2,
      "section_title": "Lessons from the US Civil War"
    },
    {
      "index_sentences": "Another thing you point out in, I think, The War Transformed is this idea of the sort of, like, future shock moment of, you know, the 1900s and 1910s being perhaps the one which is most applicable to today, just in terms of, like, all this new stuff making your head spin perspective.",
      "section_level": 2,
      "section_title": "Historical Parallels and \"Future Shock\" Moments"
    },
    {
      "index_sentences": "Maybe to put a finer point on it, like, what is this, you know, if you could spend one year as a fly on the wall, and like, which bureaucracy over the course of, I don't know, the past, let say, 300 years.",
      "section_level": 3,
      "section_title": "Ideal Historical Bureaucracies to Study"
    },
    {
      "index_sentences": "So maybe that's a good transition to kind of talk about how the strategic level often completely wipes out whatever creative stuff you could do at the technical or operational level.",
      "section_level": 1,
      "section_title": "The Primacy of the Strategic Level"
    },
    {
      "index_sentences": "Yeah, I think first I'd start with the Russian side of things. Before he decided on this invasion, Putin had a series of assumptions, strategic assumptions.",
      "section_level": 2,
      "section_title": "Putin's Failed Strategic Assumptions"
    },
    {
      "index_sentences": "From a European perspective, they assumed they could continue being economically integrated with Russia, and that would condition their behavior towards its neighbors.",
      "section_level": 2,
      "section_title": "European and US Miscalculations"
    },
    {
      "index_sentences": "It manifested in the Ukrainians not being able to exploit the defeat of the Russians at the end of 2022.",
      "section_level": 3,
      "section_title": "The Importance of Sustained Pressure"
    },
    {
      "index_sentences": "Let's turn to Taiwan for a bit. You've obviously been thinking about what is and isn't applicable from the past three years and have a new piece coming out in the next few weeks.",
      "section_level": 1,
      "section_title": "Applying Lessons to Taiwan"
    },
    {
      "index_sentences": "Well, the first thing is to understand: What does China want? What does the CCP want? What does Xi want? That's the start for any investigation of Taiwan, I think.",
      "section_level": 2,
      "section_title": "Understanding Adversary and Taiwan's Aspirations"
    },
    {
      "index_sentences": "So you lay out this framework of four filters for interpreting—for screening—what you're seeing in Ukraine and applying it to Taiwan.",
      "section_level": 2,
      "section_title": "Four Filters for Interpreting Ukraine for Taiwan"
    },
    {
      "index_sentences": "Well, I think the first one is always, you've got to focus on the enemy and you can never take your eye off the adversary.",
      "section_level": 3,
      "section_title": "The Adversary and Ideological Conflict"
    },
    {
      "index_sentences": "My other favorite, I guess, is terrain and vegetation, primarily because so many people think that the Pacific War is a maritime war.",
      "section_level": 3,
      "section_title": "Terrain and Vegetation in a Multi-Domain War"
    },
    {
      "index_sentences": "Foreign tripwires in Taiwan is something that features prominently in your novel.",
      "section_level": 2,
      "section_title": "Foreign Tripwires and Signaling Commitment"
    },
    {
      "index_sentences": "This idea of surprise is somehow still underappreciated. Even though we've had a number of wild surprises just over the past three years, why is pricing in the idea that you can be surprised such a hard thing?",
      "section_level": 1,
      "section_title": "The Enduring Challenge of Surprise"
    },
    {
      "index_sentences": "Now there has been a lot of talk recently about the transparent battlefield. I think that is a fallacious view.",
      "section_level": 2,
      "section_title": "The Fallacy of the Transparent Battlefield"
    },
    {
      "index_sentences": "I guess maybe a broader question is this: no spoilers, but at the conclusion of your novel there is a super weapon that gets unveiled.",
      "section_level": 2,
      "section_title": "The Role of \"Super Weapons\" in Warfare"
    },
    {
      "index_sentences": "This idea of mobilizing intellectual capacity is, I think, a really powerful idea.",
      "section_level": 1,
      "section_title": "Mobilizing Intellectual Capacity"
    },
    {
      "index_sentences": "Well, I think the first thing is you can't just study one war. You can't study Ukraine and think you understand war.",
      "section_level": 2,
      "section_title": "Ukraine as a Case Study, Not the Sole Future"
    },
    {
      "index_sentences": "I'm curious if there are a handful of books that come to mind that are maybe, like, I wouldn't want to say entry-level, but maybe starting points for folks who haven't already read 15 books of military history — to give folks a sense of just how messy the introduction of new technology to warfare ends up playing out in practice.",
      "section_level": 2,
      "section_title": "Recommended Readings on Technology and Adaptation in War"
    },
    {
      "index_sentences": "Yeah, I think some of the stuff about the interwar period, the debate about tanks and cavalry, and the debate about battleships versus aircraft carriers were important debates about an old and a new technology and their potential impact on war.",
      "section_level": 3,
      "section_title": "Key Books on Military Innovation and Learning"
    },
    {
      "index_sentences": "Awesome. I'll throw in two more. Andrew Krepinovich, Origins of Victory. These are sort of like chapter-length, not really anecdotes, but they almost feel reported—like they have characters, and they develop over time.",
      "section_level": 3,
      "section_title": "Additional Insights from Military History Literature"
    },
    {
      "index_sentences": "Mick, how are you trying to improve? Yeah, improve me?",
      "section_level": 1,
      "section_title": "Personal Growth and Humility in Learning"
    },
    {
      "index_sentences": "You want to assign me and maybe the audience some paper topics? Like, what have you not seen covered to the degree it should be?",
      "section_level": 2,
      "section_title": "Unexplored Research Areas: Organizational Learning"
    },
    {
      "index_sentences": "Well, I mean, I really think, you know, one of the reasons I've focused on adaptation is, you know, we need to focus more on how organizations learn how to learn better.",
      "section_level": 2,
      "section_title": "The Value of Studying Military History and Tech Applications"
    },
    {
      "index_sentences": "Mick, I want to close on funerals. This was the most powerful part of your novel to me is this little moment where you have one of the officers kind of just note that: All of the deaths in Afghanistan could be acknowledged individually.",
      "section_level": 1,
      "section_title": "The Human Cost of Future Wars"
    },
    {
      "index_sentences": "Yeah, I think it's an important part of military service is acknowledging those we lose. I mean, military organizations are ultimately designed to lose people.",
      "section_level": 2,
      "section_title": "Acknowledging Loss and Preparing for Future Realities"
    },
    {
      "index_sentences": "All right. Well, I guess we're ending on a somewhat somber note. But, Mick Ryan, thank you so much for being a part of China Talk.",
      "section_level": 1,
      "section_title": "Conclusion and Farewell"
    }
  ]
};
window.faq = {"qas": [{"answer": "Humans are not smart enough to prevent war, as evidenced by 5,000 years of history.", "index_of_source": "5,000 years of history proves that humans are not smart enough to prevent war.", "question": "What does Mick Ryan's opening statement suggest about humanity's ability to avoid conflict?"}, {"answer": "The \"one real future of war\" is the human being, because if the human element is removed, it is no longer war by definition.", "index_of_source": "But there's only one real future of war. And that's the human being.", "question": "According to the speaker, what is the \"one real future of war\" and why?"}, {"answer": "The speaker believes they are complementary ideas, stating that while both sides may have industrial capacity, the one that leverages it cleverly, through human decisions, is the one that wins.", "index_of_source": "Well, I think they're complementary ideas. I don't think they exist in tension because at the end of the day, in the wars he examined—and it's a fabulous book—both sides had industrial capacity, but the one that's able to leverage it cleverly is the one that wins.", "question": "How does the speaker reconcile Paul Kennedy's argument about industrial weight deciding wars with Andrew Marshall's emphasis on human agency?"}, {"answer": "Drones have not fundamentally changed existing ideas and technologies in warfare, but rather extended what military organizations already do, evolving some aspects but not totally transforming them.", "index_of_source": "Even in Ukraine, drones have not, and I'll repeat this, they have not changed a whole lot of existing ideas and technologies.", "question": "What is the speaker's assessment of the impact of drones on warfare, particularly in Ukraine?"}, {"answer": "The speaker argues that while Dixon focused on \"dunderheads,\" every military organization also has \"rock stars\" and brilliant people, suggesting that both competence and incompetence exist simultaneously.", "index_of_source": "I think he got it partially right. I don't think it's the full story.", "question": "How does the speaker challenge Norman Dixon's premise in On the Psychology of Military Incompetence?"}, {"answer": "Societies have accepted limitations such as the Biological and Chemical Weapons Convention and the Geneva Convention. However, Russia's actions in Ukraine suggest these norms might not hold, potentially leading to \"real total war.\"", "index_of_source": "But there are still limits to seeking advantage. We've accepted that through the Biological and Chemical Weapons Convention.", "question": "Despite the drive for competitive advantage, what limitations on warfare have societies accepted, and how might these be challenged in the future?"}, {"answer": "Humans are adept at ignoring facts and data when it conflicts with their economic or ideological interests, leading to miscalculations and conflicts like the war in Ukraine or potential conflicts in the Asia-Pacific.", "index_of_source": "Ultimately, humans are pretty good at ignoring facts and data if it's in their economic or their ideological interests.", "question": "Why does the speaker believe humans continue to go to war despite historical lessons and economic integration?"}, {"answer": "Mick Ryan emphasizes that one cannot just study a single war, like Ukraine, and claim to understand all war. Instead, it's crucial to study war in its past, present, and future dimensions as a foundational work, using specific conflicts as case studies to test hypotheses, and focusing on how organizations learn how to learn better.", "index_of_source": "Well, I mean, I really think, you know, one of the reasons I've focused on adaptation is, you know, we need to focus more on how organizations learn how to learn better.", "question": "What is Mick Ryan's primary recommendation for those in the \"thinking community\" who wish to contribute to understanding and solving big intellectual challenges related to war?"}, {"answer": "The speaker argues that while battlefields are \"highly visible\" with better visibility than ever, they are not transparent, as evidenced by regular surprises in densely surveilled conflicts like Ukraine and Afghanistan, and humans are still able to deceive.", "index_of_source": "Now there has been a lot of talk recently about the transparent battlefield. I think that is a fallacious view.", "question": "Why does the speaker believe the idea of a \"transparent battlefield\" is a fallacy, despite increased surveillance?"}, {"answer": "The speaker clarifies that \"super weapons\" alone do not win wars. Instead, they are just one element within a range of capabilities (like cyber operations, ground warfare, aerial warfare, and drones) that collectively contribute to the culminating point of a conflict and are part of the desire to help end wars.", "index_of_source": "So super weapons don't win wars, but they're going to be part of our desire to help end wars in the future, I think.", "question": "How does the speaker view the role of \"super weapons\" in winning wars, contrary to the typical perception of such devices?"}]};
</script>
