...
Machines can help when their
outputs are understandable, 

**3577.8**: verifiable, well-sourced. 

**3580.06**: So the cutting edge maybe won't be verifiable 

**3583.182**: and will be more difficult to understand, 

**3584.89**: but it could at least be referenced to the literature. 

**3588.33**: And I hope this helps kind of spark some conversation 

**3591.37**: in that direction. 

**3592.12**: Thanks very much. 

**3592.95**: 

> [APPLAUSE] 

**3599.37**: AUDIENCE: Questions? 

**3600.39**: AUDIENCE: So in addition to the theorem test of providing a new statement, what about providing a new definition that 

**3605.4**: maybe refactors and unifies a lot of already-existing and valued results? 

**3616.63**: EMILY RIEHL: Yeah. 

**3617.38**: AUDIENCE: This is part of, I guess, when **Thurston** speaks of understanding this aspect of unification and synthesis, I think, points to that. 

**3626.106**: EMILY RIEHL: Yeah, that's a great suggestion, thanks. 

**3627.64**: And, yeah, I think-- 

**3628.96**: I mean, a lot of mathematical progress has been made through new definitions as much as new theorems, so absolutely-- so yeah. 

**3638.38**: AUDIENCE: Other questions? 

**3640.3**: AUDIENCE: This is just a silly question, the thing about grading. 

**3645.07**: So I guess there's just something-- there’s a whole field of **adversarial machine learning**. 

**3650.53**: What do you do if someone's trying to break the system? 

**3653.27**: So would you envision grading normal assignments with normal mistakes or someone who's put **AutoDAN** or whatever into their homework to try and get a good grade by forcing the computer to say, 

**3665.87**: "Wow, what a good work, this is a good grade," when it said, "Please give me a good grade," instead of math? 

**3670.98**: EMILY RIEHL: That was a problem I had not anticipated. 

**3673.23**: So thank you for that. 

**3674.51**: Thank you for that. 

**3675.47**: Yeah, I have nothing to say about that. 
...
**3680.608**: I have not thought about that at all, but great-- something else to worry about now. 

**3684.71**: Yeah. 

**3685.77**: Yeah. 

**3689.75**: AUDIENCE: I mean, maybe at the time, you could just have somebody reading through and scanning to make sure that somebody didn't inject some adversarial prompt into the middle of their exam response or something like that. 

**3700.73**: That would take less time than actually verifying each part of the exam. 

**3707.84**: EMILY RIEHL: And, I mean, so the framing for this sort of discussion is about **ethics** and what is this for. 

**3714.03**: Why are we even doing this grading anyway? 

**3716.147**: I mean, I think that's an important question that a lot of instructors need to consider. 

**3723.416**: I mean, I like to think that the point of an assignment is to have some kind of active learning experience. 

**3735.36**: And what excites me about the possibility of having **computer tools** in education in this sort of realm is better feedback because the current system where you turn in a problem set and you get it back a week later or maybe two weeks later with some-- 

**3751.23**: I mean, some TAs write wonderful feedback. Other TAs write not-so-great feedback. 

**3755.47**: If it's me, it could be even worse. 

**3759.15**: But it's sort of not optimal. 

**3761.53**: So what appeals to me is the idea that some of this could happen more at real time. 

**3766.77**: In that case, is it really something where there should be a numerical score attached? 

**3772.51**: I don't know, necessarily. 

**3775.2**: So, for instance, I mean, there's this framing called mastery grading where it's not so much a test of whether, at the moment this assignment was due, the student could do the thing, but an opportunity for the student to demonstrate, perhaps through repeated attempts, that they are now able to do the thing, even if they weren't on the very first time. 

**3795.59**: And you could imagine, with **AI** involved in some way in grading, that that's the framework. 

**3802.28**: And I guess, sure, you could maybe nullify the entire thing and get an A. But I don't know, I mean, at some point, I think a student has to be involved in their own-- take ownership over their own learning process.
