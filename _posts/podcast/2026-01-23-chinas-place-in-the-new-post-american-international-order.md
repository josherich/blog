...
[China's Place in the New Post-American International Order](https://traffic.libsyn.com/secure/ea0f0fdd-2944-4ff3-8a00-704e8c67d58b/CAP-CGSP_with_Zoe_Liu_1.mp3?dest-id=4287628)
...
So from that perspective, I'd say,
**China's export-oriented model** is probably not applicable for other countries aspiring to learn from China in a more fragmented world.
...
So I'd say the **credibility gap** is pervasive. And it also speaks to China's lack of sophistication in making itself better understood. And there are reasons for lack of transparency.
In that context, you point out also that **China depends a lot on the global south for political coordination** and that the **politics of global south solidarity** kind of underlie a lot of some of the **risks that China** financial risks and some of the China takes on in parts of the developing world.
...
At the same time, there's also been like, there is very significant, you know, by some of the most robust communication systems in the world, there is a very significant **anti-China narrative**, you know, kind of coming from those communication systems. That is also true.
I think there may be, you know, **there's another issue**, I think, which is an issue that I think comes from being a kind of a relatively **mono-ethnic**, like **East Asian developmental state**, you know, and some kind of like ways in where there's some problems I think that **China is facing**, that **Japan** and **South Korea** also faced as they moved into the world.
...
So, you can't trust them because we don't trust our own government.
And I think that's a **fundamental difference** that is very difficult to bridge for **Chinese actors** because they have such embedded other big issues that they have to deal with on their side.
...
<script>window.tocIndex = {"index":[{"index_sentences":"Hello, and welcome to this special joint edition of the China Global South podcast and the China in Africa podcast.","section_title":"Welcome and Introduction to the Podcast","section_level":1},{"index_sentences":"Kobus, you and I are both old enough to remember some of the great speeches of the 20th century.","section_title":"Setting the Stage: The Post-American Order and Mark Carney's Speech","section_level":1},{"index_sentences":"For decades, countries like Canada prospered under what we called the rules-based international order.","section_title":"Mark Carney's Davos Speech: A Rupture in the International Order","section_level":2},{"index_sentences":"Kobus, there we have it. A rupture and references to subordination.","section_title":"Initial Reactions to Carney's Speech","section_level":2},{"index_sentences":"Well, I was struck by this, a little bit down in the speech, he said, to help solve global problems, we're pursuing variable geometry.","section_title":"Carney's " ,"section_level":2},{"index_sentences":"Well, if you've been following the speeches of Carney over the past couple of weeks, this speech this week in Davos may not have come as a surprise.","section_title":"Introducing Zoe Liu and China's Role in the Changing World","section_level":1},{"index_sentences":"Eric, thank you for somehow connecting my article, linking some of my analysis with Prime Minister Mark Carney's speech.","section_title":"Zoe Liu's Initial Reflection on Carney's Speech","section_level":2},{"index_sentences":"I was wondering, in listening to comments, he was mostly mentioning great powers, which is obviously an on-purpose vague way of talking about it and not particularly calling out any specific great power.","section_title":"Interpreting " ,"section_level":2},{"index_sentences":"How do you think the leadership in Beijing is interpreting all of this?","section_title":"Beijing's View of the Rules-Based International Order","section_level":2},{"index_sentences":"I would say China's relationship with the international order, or the U.S.-led, and to a large extent, the U.S. helped build the existing international rule-based order.","section_title":"China's Evolving Engagement with the International System","section_level":1},{"index_sentences":"Instead, what China has been experimenting, I'd say probably through three channels as I see it.","section_title":"China's Three Approaches to the International Order","section_level":2},{"index_sentences":"That's a very interesting question. I think somebody should write a dissertation about it, and the China and the Global South project provide a lot of interesting and useful data points and case studies.","section_title":"How China's Rise Impacts the Global System","section_level":2},{"index_sentences":"Let's pick up on that. And I'd like to take advantage of your expertise, because this is a conversation I've been having with a number of different people, and there's not a consensus on it.","section_title":"The " ,"section_level":2},{"index_sentences":"That is also a very complex question, Eric, because if we put ourselves in the shoes of a Chinese exporter, I'm not talking about the Chinese government.","section_title":"Sustainability and Fragmentation in China's Export Model","section_level":2},{"index_sentences":"So, you know, there's all of the vice premier, for example, and President Xi Jinping himself have been committing China to become more consumption-led, and to increase the rates of consumption within China.","section_title":"Domestic Challenges and International Credibility","section_level":1},{"index_sentences":"One thing I think Western economists seem to have underappreciated about China's so-called overcapacity challenge is that since the end of COVID, when Western governments did major stimulus, followed by President Putin's war against Ukraine, major Western economies ended up with high inflationary pressure.","section_title":"The Paradox of China's Consumption-Led Growth","section_level":2},{"index_sentences":"Your article also talks about the challenges that they face internationally as well.","section_title":"China's Credibility Gap and the Debt Trap Narrative","section_level":2},{"index_sentences":"The reason I wanted to emphasize credibility, and especially I wanted to emphasize the debt trap as a case, I'll start with the puzzle that I have had for a long time.","section_title":"Opacity, Bad PR, and the Pervasiveness of Distrust","section_level":2},{"index_sentences":"In that context, you point out also that China depends a lot on the global south for political coordination and that the politics of global south solidarity kind of underlie a lot of some of the risks that China financial risks and some of the China takes on in parts of the developing world.","section_title":"China's Identity and Global South Solidarity","section_level":1},{"index_sentences":"Right. That's a really interesting way to describe it. And I think China itself struggles with how to maintain its dual identity, in the sense that on the one hand, it wants to become a global superpower, at least economically.","section_title":"Dual Identity: Superpower vs. Global South Member","section_level":2},{"index_sentences":"So from that perspective, I'd say claiming itself as a member of the global South gives China a sense of moral obligation to practice foreign policy agenda.","section_title":"Earning Trust: The Challenge of China's Image","section_level":2},{"index_sentences":"The article is " ,"section_title":"Concluding Discussion: Soft Power, Transparency, and US Credibility","section_level":1},{"index_sentences":"Kobus, when we were in Indonesia last week and speaking with various stakeholders there, the way that the China-Indonesia relationship was described to us was that Indonesians see China as an opportunity, not an ally or a threat.","section_title":"Chinese Opacity and the Roots of Distrust","section_level":2},{"index_sentences":"At the same time, there's also been like, there is very significant, you know, by some of the most robust communication systems in the world, there is a very significant anti-China narrative, you know, kind of coming from those communication systems.","section_title":"East Asian Developmental State and Communication Challenges","section_level":2},{"index_sentences":"And one of the other issues that's not unique to China, we also see it in other authoritarian states like Vietnam as well, where you don't have active civil society.","section_title":"Lack of Civil Society and State-Centric Interactions","section_level":2},{"index_sentences":"Well, however bad the Chinese are at soft power, at least this particular brand of soft power, they can take comfort in the fact that, well, the United States now is even worse.","section_title":"The Implosion of US Soft Power","section_level":2},{"index_sentences":"The thing is, you know, they're losing it in countries with old populations, right?","section_title":"Generational Perceptions and the New Normal","section_level":2},{"index_sentences":"I'll disagree with you on the differences between Democrats and Republicans because certainly in some of the foreign policy realm, I 100% agree with you in domestic policy and kind of spiritual policy.","section_title":"Podcast Outro and Call to Action","section_level":2}]};
window.faq = {
  "qas": [
    {
      "question": "What does Canadian Prime Minister Mark Carney mean by a 'rupture' in the international order, and what does he identify as its causes?",
      "answer": "Carney describes a 'rupture, not a transition' in the international order, stating that the bargain of mutual benefit through integration no longer works. He attributes this to great powers weaponizing economic integration through tariffs, financial infrastructure coercion, and supply chain exploitation.",
      "index_of_source": "Let me be direct. We are in the midst of a rupture, not a transition."
    },
    {
      "question": "According to Kobus van Staden, what was more significant about Mark Carney's speech: the break in substance or the break in optics?",
      "answer": "Kobus van Staden argues that the speech was 'a break in optics, I think, more than necessarily that bigger break in substance,' suggesting that the visual presentation and acknowledgement of the order's failure were more impactful than immediate policy changes.",
      "index_of_source": "So, this is definitely, it's a break in optics, I think, more than necessarily that bigger break in substance, because we don't really know what a lot of this is going to mean yet."
    },
    {
      "question": "How does Liu Zhongyuan (Zoe) describe China's three main approaches to the existing international rule-based system?",
      "answer": "Zoe outlines three approaches: first, China tries to 'change from within' by reforming institutions like the WTO, IMF, World Bank, and UN, often with Global South support; second, it 'tries to work only with Global South' through platforms like BRICS, SCO, or AIIB; and third, China sometimes 'go it alone,' as seen with its cross-border interbank payment system (CIPS).",
      "index_of_source": "Instead, what China has been experimenting, I'd say probably through three channels as I see it:1. China tries to change from within as expressed by how it tries to change, revise, or reform the WTO, tries to reform IMF, tries to reform World Bank, and the attempt to reform, or for that matter, UN."
    },
    {
      "question": "Why does Zoe argue that China is unlikely to completely overthrow the existing U.S.-led international order, despite its frustrations?",
      "answer": "Zoe explains that China has 'benefited tremendously from the existing international rule-based order,' particularly after joining the WTO. She argues that 'if you destroy the system from which you benefit from, you do not know what is coming next, the opportunity cost is too huge.' While China feels constraints, it seeks to reform rather than abolish the system.",
      "index_of_source": "Part of the reason is because if you destroy the system from which you benefit from, you do not know what is coming next, the opportunity cost is too huge."
    },
    {
      "question": "What does Zoe identify as the main reasons behind the persistent 'debt trap diplomacy' narrative surrounding China, despite empirical evidence debunking it?",
      "answer": "Zoe attributes the narrative's pervasiveness to 'China's opaque lending practices and the political leverage that appears to be built into its financing model have led to global unease.' She also points to China's 'very, very bad PR' and a lack of understanding by Chinese actors of how other countries, particularly in the Global South, operate, often failing to consider regime change or tribal conflicts.",
      "index_of_source": "Chinese government and Chinese companies tend to just have very, very bad PR."
    },
    {
      "question": "How does Zoe offer an 'underappreciated' perspective on the impact of cheap Chinese goods on Western economies, particularly in relation to inflation?",
      "answer": "Zoe suggests that 'when Chinese goods were cheap, before tariffs, it also meant Western countries who were importing Chinese goods—these cheap goods actually could have the effect of smoothing out part of the inflationary pressure.' She notes this aspect is often overlooked, with economists focusing instead on the risk of China exporting deflation.",
      "index_of_source": "One thing I think Western economists seem to have underappreciated about China's so-called overcapacity challenge is that since the end of COVID, when Western governments did major stimulus, followed by President Putin's war against Ukraine, major Western economies ended up with high inflationary pressure."
    },
    {
      "question": "According to Zoe, what is the 'dual identity' challenge China faces in the international system, and why does it struggle to maintain it?",
      "answer": "China struggles to maintain its 'dual identity' as both a global superpower (at least economically) and a self-proclaimed member and leader of the Global South. Zoe notes that this dual identity allows China to align with countries sharing grievances against former colonial powers or non-rule writers, helping it assert 'strategic autonomy' without engaging in Western discussions about democracy or human rights.",
      "index_of_source": "China itself struggles with how to maintain its dual identity, in the sense that on the one hand, it wants to become a global superpower, at least economically."
    },
    {
      "question": "According to Eric, how do China's opaque business practices contribute to the credibility gap and the persistence of narratives like the 'debt trap'?",
      "answer": "Eric argues that while external propaganda plays a role, 'the Chinese have done themselves no service whatsoever by the opacity that they conduct their business around the world.' He notes their absence from media and public conversations, which fuels 'rumors of debt traps, overcapacity, other things that they really resent to their core.'",
      "index_of_source": "I also think that the Chinese have done themselves no service whatsoever by the opacity that they conduct their business around the world."
    }
  ]
};
</script>
