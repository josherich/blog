---
layout: post
title: "Industrial Maximalism and Its Discontents: Dan Wang on US-China Competition – # 104"
...
[Industrial Maximalism and Its Discontents: Dan Wang on US-China Competition – # 104](https://media.transistor.fm/cfd31a09/00ada541.mp3)
...
And so I think that is sort of the two facts I really want to get across.
And as part of this **book tour**, I think what surprised me is the extent to which people are now quite curious about **China**. I think **China is in the water**, so to speak. Everybody has to have a view about China, whether that is something very social media driven like **home prices in Chongqing**—that's been a weird mimetic trend to take off. You know, whatever aspect of weird industrial chemicals, that was a **TikTok meme** very briefly.
...
No less bad than socialist, capitalist, democratic, authoritarian to have another lens to think about this important relationship.
Now, setting aside **China entirely**, as somebody who spends all his time talking to other scientists and talking to technologists in **Silicon Valley**, the idea that our nation should be run by **lawyers** is, to us, a **shockingly bad outcome**.  
...
Yeah, I get where you're coming from. And I think it is a position that is easy to be sympathetic to. But I want to rebut it somewhat with this idea that **what is truth?**
And if we can discover the **truth**, what follows is not necessarily something that **scientists** are able to comment on very well. You say that **entrepreneurs** are trying to figure out what **consumers want**.
...
Yes, that is a story that even before the Communist Party, the Chinese rulers have created this story. And the Communist Party has indeed put it into the heads of everyone. And I would want to offer a little bit of nuance here.
First, if these were **barbarians**, how do they get all this great **science and technology**? So maybe there is at least a little bit something else here going on that these **British, Dutch, red-bearded people** were able to invent a lot of great things.
...
And so when this is all over and we are on top and we're no longer threatened,
**Threatened by the West, then we can relax and create this beautiful vision that you have for how society should be.**  
...
> "No, we cannot possibly give them NVIDIA chips because these people are so horrible. If they get AI first, it's game over for the whole planet," et cetera, et cetera.
So I don't claim to know the answer for which of those two scenarios is more plausible, but I think **it's the one, it's what people should really be focused on, the future of a world in which China becomes possibly the most powerful country.**
...
- In the semiconductor industry, there's been an enormous amount of **graft** that the party state has been keen to crack down on.
And so, this is where I feel like much of the **party state doesn't feel very safe in Xi Jinping's China**. **Xi Jinping himself sent his daughter to study at Harvard University**. I did not go to Harvard, but his daughter graduated college in the same year that I did.
...
It was so naive and sincere, the reaction of this kid.
So anyway, but it was like a **cluster of Chinese**. And these guys were involved in the most **hardcore model training**, pre-training of the models at **DeepMind** and **Google**.
...
> **"In Berlin, the situation is serious but not hopeless. Whereas in Vienna, the situation is hopeless, but it is not serious."**
And this is where I think a lot of the **U.S. is, where they are just not a serious country in a lot of different ways.**
...
I believe that **authoritarian powers can do incredible science and technology.** We saw this with the **Soviet Union.**
We saw this with **Nazi Germany**, in which **totalitarian systems produce miracles** in, let's say, **spaceflight**, as well as many other things.  

So, I think that the more that we can get our discourse and our level of competition to the level of sustained capacity building, which is what the **Chinese have done**, rather than thinking, _"oh, well, they can do that, which is not that difficult, and we can do this, which is much harder,"_ let's acknowledge that they can do a lot of difficult, important things, and that the **United States should also get in this game in a much more active way**.
...
I think by now, people, even most normie boomers, have kind of set that one aside, and they say, _"oh, well, they can do advanced manufacturing."_ But the core idea, the **zero-to-one, brilliant, genius breakthrough**, that still has to come from the West.
...
Maybe half-half. I think that there is still plenty of clinginess among the _quote-unquote_ serious people. But I think that there is also a readiness.
...
Yes, and I think this is one of the sins of the lawyers, that they think that, _"oh, we need so much free speech in order to produce scientific breakthroughs."_
...
**Right.**
The best of the best from the **Soviet Union**, former **Soviet Union**, came to the United States and competed with young Americans like me for the same jobs. So, it was a very, very vivid experience with me, and I spent many, many hours in so-called **Russian seminars**.
...
I sometimes hear that the U.S. will save manufacturers through **automation**.
The truth is that **Chinese factories tend to be ahead on automation**. That's a big part of the reason that **Chinese Tesla workers are more productive than California Tesla workers**. **China regularly installs as many robots as the rest of the world put together**. They are also able to provide greater amounts of training data for AI. 
...
**What is the long run? Is that a matter of two decades or two years?**
Very hard to predict because the problem is that, and this is the **key thing everyone's on the lookout for**, is **when do the AIs become so good at AI research and software writing that they start improving themselves** and at a pace where human engineers can't quite follow the way in which they're improving themselves? 
...
- Demis has more of a **five to 10 year timeline** to get to this point.
And they both said, **Dario said, "I actually prefer your timeline. I wish it would — I hope it's going to take five to 10 years and not one to five years."** They both said, **"Yeah, we're both more comfortable if we can slow this down."**
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "So I think that we have moved on from this idea that the Chinese cannot innovate.",
      "section_title": "Introduction: Beyond the 'Chinese Cannot Innovate' Myth",
      "section_level": 1
    },
    {
      "index_sentences": "We've moved on to another idea, which is that, okay, the Chinese are much better at scaling, going from 1 to 100, whereas the Americans are still good at going from 0 to 1.",
      "section_title": "Debunking the '0 to 1' vs '1 to 100' Dichotomy",
      "section_level": 2
    },
    {
      "index_sentences": "Welcome to Manifold. It's my pleasure to be here with Dan Wong at his home institution.",
      "section_title": "Introducing Dan Wong and His Book 'Breakneck'",
      "section_level": 1
    },
    {
      "index_sentences": "Dan, as you know, is the author of Breakneck, China's Quest to Engineer the Future.",
      "section_title": "The Impact and Relevance of 'Breakneck'",
      "section_level": 2
    },
    {
      "index_sentences": "I'm going to drill down on certain topics that I think my audience, the manifold audience, which is very interested in the U.S.-China competition and the development of China in the last generation",
      "section_title": "Podcast Focus: U.S.-China Competition and China's Development",
      "section_level": 2
    },
    {
      "index_sentences": "Okay, so one of the things, one of the themes in your book is contrasting the so-called engineering state of China versus the lawyerly society of the United States.",
      "section_title": "The 'Engineering State' vs 'Lawyerly Society' Framework",
      "section_level": 1
    },
    {
      "index_sentences": "I think the first thing I should acknowledge is that this idea of lawyers and engineers has become a memetic idea, but it hasn't exactly been original to me.",
      "section_title": "Origins and Weaponization of the Concept",
      "section_level": 2
    },
    {
      "index_sentences": "And I think one of the things I've really wanted to do is to try to capture this fact that I would say that China, modern China today, is defined by two central facts, two central trends:",
      "section_title": "China's Defining Trends: Progress and Repression",
      "section_level": 2
    },
    {
      "index_sentences": "And as part of this book tour, I think what surprised me is the extent to which people are now quite curious about China.",
      "section_title": "Reflections on the Book Tour and China's Growing Interest",
      "section_level": 2
    },
    {
      "index_sentences": "One of the things I maybe not everybody in the audience is aware of is that your life really prepared you exquisitely to write this book and even prepared you for that specific formulation of lawyers versus engineers.",
      "section_title": "Dan Wong's Background and the Framework's Genesis",
      "section_level": 1
    },
    {
      "index_sentences": "And after zero COVID fell apart in China, I moved to the Yale Law School where I was a fellow.",
      "section_title": "The Yale Law School Experience: A Contrasting View",
      "section_level": 2
    },
    {
      "index_sentences": "Now, setting aside China entirely, as somebody who spends all his time talking to other scientists and talking to technologists in Silicon Valley, the idea that our nation should be run by lawyers is, to us, a shockingly bad outcome.",
      "section_title": "Critique of the Lawyerly Society in the US",
      "section_level": 1
    },
    {
      "index_sentences": "Power isn't something that is ever given to you. Power is something that you have to seize.",
      "section_title": "Seizing Power: Lawyers vs. Scientists/Engineers",
      "section_level": 2
    },
    {
      "index_sentences": "I think the first thing to acknowledge is that Trump is an excellent, splendid product of the Lawyerly Society.",
      "section_title": "Donald Trump as a Product of the Lawyerly Society",
      "section_level": 2
    },
    {
      "index_sentences": "The comment you made about the sort of trumped-up charges against Maduro is illustrative of why people who come from more of a science or techno-entrepreneurial background really hate the ideas, the idea of lawyers running society.",
      "section_title": "Scientists' Disdain for Lawyers: Truth vs. Argument",
      "section_level": 2
    },
    {
      "index_sentences": "Yeah, I get where you're coming from. And I think it is a position that is easy to be sympathetic to. But I want to rebut it somewhat with this idea that what is truth?",
      "section_title": "Rebuttal: The Complexity of 'Truth' and Normative Questions",
      "section_level": 2
    },
    {
      "index_sentences": "So I would say that what we want is pluralism. What we need to have are some scientists and the ruling elites.",
      "section_title": "The Need for Pluralism in Leadership",
      "section_level": 2
    },
    {
      "index_sentences": "Well, what you call arguing out of both sides of your mouth, I can call empathy and understanding what the other side thinks.",
      "section_title": "Empathy and Company Creation in a Lawyerly Society",
      "section_level": 2
    },
    {
      "index_sentences": "So I want to turn to a concept called industrial maximalism, which is promulgated by something sometimes called the Industrial Party in China.",
      "section_title": "Industrial Maximalism and China's 'Industrial Party'",
      "section_level": 1
    },
    {
      "index_sentences": "Yeah, the Industrial Party is not a legitimate political party because there are only, aside from the Communist Party, I believe there are eight other tolerated political parties in China, but all of them must be subservient and loyal and obedient to the Communist Party.",
      "section_title": "History and Ideals of the Industrial Party",
      "section_level": 2
    },
    {
      "index_sentences": "So, for our non-Chinese listeners, I think it's important to give some cultural context here, which is that for thousands of years, China regarded itself as at least the preeminent civilization that it knew of on the planet.",
      "section_title": "Cultural Context: China's Century of Humiliation",
      "section_level": 2
    },
    {
      "index_sentences": "But what about the quarter century of self-humiliation that the Communist Party inflicted right afterwards, after 1949, when tens of millions of people perished after various landlord struggles, after the Great Leap Forward in which a famine ravaged the land?",
      "section_title": "Dan's Counterpoint: The Quarter Century of Self-Humiliation",
      "section_level": 2
    },
    {
      "index_sentences": "We had to break a bunch of eggs and we made a bunch of mistakes to get us to where we are now. But now we finally emerged in our rightful place among the leading nations.",
      "section_title": "Nationalist Justification for Past Hardships",
      "section_level": 2
    },
    {
      "index_sentences": "This is the third world war, but it's being conducted in a more subtle way. And I think that is what some of my listeners who belong to this party, the industrial party, that's how I think they would articulate their position.",
      "section_title": "The 'War' Mindset: Will China Ever Relax?",
      "section_level": 2
    },
    {
      "index_sentences": "And I want to say that this, by the way, this NATSEC (national security) perspective exists on both sides.",
      "section_title": "Paranoid Mindsets in Both China and the US",
      "section_level": 2
    },
    {
      "index_sentences": "So coming to the current Chinese government and the nature of life in China, you've commented on the parity that's experienced even by the elites.",
      "section_title": "The Precarity of Life for Chinese Elites",
      "section_level": 1
    },
    {
      "index_sentences": "I think the average person in China is pretty happy with their government just because of the very strong growth and development that's happened in the last generation.",
      "section_title": "General Populace: Satisfaction and Awareness",
      "section_level": 2
    },
    {
      "index_sentences": "But then I think you make this insightful comment, both in some of your interviews and also in the book: For the elites, there is still the sense of participation.",
      "section_title": "Elites' Insecurity Amidst Party Purges",
      "section_level": 2
    },
    {
      "index_sentences": "The one spot traditionally reserved for a woman has been axed.",
      "section_title": "Xi Jinping's Crackdown and Its Impact on Elites",
      "section_level": 3
    },
    {
      "index_sentences": "I know a lot of people who have the opposite view and feel that now is the time actually to go back to China because the companies there really are doing cutting-edge stuff.",
      "section_title": "The Complicated Flow of Talent: Staying or Returning",
      "section_level": 2
    },
    {
      "index_sentences": "A funny story I think I told before on this podcast is that I was visiting DeepMind.",
      "section_title": "Anecdotes on Chinese AI Talent in the West",
      "section_level": 3
    },
    {
      "index_sentences": "So he reports to me that the scene in, partially for this reason, because he's on the academic side, he's doing his PhD, the scene in Beijing is more vibrant than the scene here on the Stanford campus.",
      "section_title": "Tsinghua vs. Stanford: A Tale of Two Academic Environments",
      "section_level": 3
    },
    {
      "index_sentences": "So I have a bunch of quotes, which I loved, that came from your, I think the ones I wrote down came from your annual letter.",
      "section_title": "Dan Wong's Annual Letters and China's Market Dynamics",
      "section_level": 1
    },
    {
      "index_sentences": "Probably the most underrated part of the Chinese system is the ferocity of market competition.",
      "section_title": "Quote: 'Ferocity of Market Competition'",
      "section_level": 2
    },
    {
      "index_sentences": "If we take a look at the Chinese equity market, I mean, that's – this is not the whole reason, but part of the reason that, you know, the Shanghai Composite Index has mostly trended sideways for 20 years.",
      "section_title": "Impact on Profit Margins and Consumer Benefits",
      "section_level": 3
    },
    {
      "index_sentences": "Next quote: Beijing has been preparing for Cold War without eagerness for waging it, while the U.S. wants to wage a Cold War without preparing for it.",
      "section_title": "Quote: 'Cold War Preparation'",
      "section_level": 2
    },
    {
      "index_sentences": "And this is where I think a lot of the U.S. is, where they are just not a serious country in a lot of different ways.",
      "section_title": "U.S. Lack of Seriousness in Cold War Strategy",
      "section_level": 3
    },
    {
      "index_sentences": "But China has mostly prospered under this system. And so, but it has also been quite cautious and preparing for energy self-sufficiency, food self-sufficiency.",
      "section_title": "China's Cautious Pursuit of Self-Sufficiency",
      "section_level": 3
    },
    {
      "index_sentences": "So, lots of entrepreneurs, Silicon Valley people, are astonished that we can't seem to get our shit together.",
      "section_title": "The 'Industrial Party of America's' Concerns",
      "section_level": 3
    },
    {
      "index_sentences": "Let me read a few things about innovation and manufacturing in China from you. I'm going to read a few of them and then you comment.",
      "section_title": "China's Innovation and Manufacturing Prowess",
      "section_level": 1
    },
    {
      "index_sentences": "By failing to recognize China's real strength, the industrial ecosystem's pulsating with process knowledge, the U.S. is only cheating itself.",
      "section_title": "Quote: 'China's Real Strength: Industrial Ecosystem'",
      "section_level": 2
    },
    {
      "index_sentences": "So I think that we have moved on from this idea that the Chinese cannot innovate.",
      "section_title": "Innovation Beyond '0 to 1' and '1 to 100'",
      "section_level": 2
    },
    {
      "index_sentences": "I cite the example of, you know, who was it who, you know, which American lab invented solar panels?",
      "section_title": "The Solar Panel Example: Invention vs. Ownership",
      "section_level": 3
    },
    {
      "index_sentences": "I believe that authoritarian powers can do incredible science and technology. We saw this with the Soviet Union.",
      "section_title": "Authoritarianism and Scientific Breakthroughs",
      "section_level": 2
    },
    {
      "index_sentences": "Yes, and I think this is one of the sins of the lawyers, that they think that, \"oh, we need so much free speech in order to produce scientific breakthroughs.\"",
      "section_title": "Political Freedom vs. Scientific Productivity Debate",
      "section_level": 3
    },
    {
      "index_sentences": "In my book, I spent a bit of time thinking about the example of the Soviet Union, and there's a particular historian of science from Harvard named Lauren Graham, who studied the Soviet science system.",
      "section_title": "Lessons from the Soviet Science System",
      "section_level": 3
    },
    {
      "index_sentences": "Now, there is a more extreme version of this hypothesis, which, for example, people from the French system and people who really experienced the Soviet system will advocate for it.",
      "section_title": "French System: Meritocracy Over Materialism",
      "section_level": 3
    },
    {
      "index_sentences": "I sometimes hear that the U.S. will save manufacturers through automation.",
      "section_title": "Automation and AI: China's Lead and Future Implications",
      "section_level": 1
    },
    {
      "index_sentences": "The truth is that Chinese factories tend to be ahead on automation.",
      "section_title": "China's Lead in Factory Automation",
      "section_level": 2
    },
    {
      "index_sentences": "We have to be careful not to let automation, like superintelligence, become an excuse for magical thinking rather than doing the hard work of capacity.",
      "section_title": "AI and the Danger of Magical Thinking",
      "section_level": 2
    },
    {
      "index_sentences": "You know, for me, I would say we're close to spending 2% of GDP now on CapEx investments for data centers and model training and NVIDIA chips and things like this.",
      "section_title": "AI Investments vs. Industrial Capacity",
      "section_level": 3
    },
    {
      "index_sentences": "As far as the long-run existential risk from AI, I think the people who are afraid are not wrong.",
      "section_title": "Assessing Long-Run Existential Risk from AI",
      "section_level": 2
    },
    {
      "index_sentences": "Do you believe that there will be a point in which it starts self-recursively improving? Yes, I do.",
      "section_title": "The Threat of Recursive Self-Improvement",
      "section_level": 3
    },
    {
      "index_sentences": "So, I was in a war game held at the Tate Modern, this museum in London, and the war game was sponsored by people who are concerned about AI safety.",
      "section_title": "AI War Games and Collective Action Problem",
      "section_level": 3
    },
    {
      "index_sentences": "Very good. Well, that's a good place for us to stop.",
...
window.faq = {
  "qas": [
    {
      "question": "What is the speaker's updated view on China's capacity for innovation and scaling, moving beyond previous misconceptions?",
      "answer": "The speaker states that the idea of Chinese people being unable to innovate is \"decisively buried.\" He also challenges the newer notion that Chinese are only good at scaling (1 to 100) while Americans excel at original innovation (0 to 1). He suggests that Chinese are capable of both innovation and scaling, viewing these as continuous processes, and that the exclusive remit of 0 to 1 innovation for the West is no longer empirically supported.",
      "index_of_source": "So I think that we have moved on from this idea that the Chinese cannot innovate."
    },
    {
      "question": "What is the \"brilliant formulation\" Dan Wong proposes to contrast China and the United States, and how has it been received?",
      "answer": "Dan Wong's book theme contrasts the \"engineering state of China versus the lawyerly society of the United States.\" This formulation has gone viral, even being adopted by leading thinkers like historian Adam Tooze in keynote addresses.",
      "index_of_source": "Okay, so one of the things, one of the themes in your book is contrasting the so-called engineering state of China versus the lawyerly society of the United States."
    },
    {
      "question": "According to the speaker, what are the two central, defining facts or trends of modern China that he aims to convey in his work?",
      "answer": "Modern China is defined by two central facts: first, its success in lifting hundreds of millions out of poverty, creating a global elite and a broader middle class, demonstrating significant economic progress. Second, the Communist Party's repressive authoritarian power in the 21st century, using modern tools to suppress human flourishing for many.",
      "index_of_source": "And I think one of the things I've really wanted to do is to try to capture this fact that I would say that China, modern China today, is defined by two central facts, two central trends."
    },
    {
      "question": "Why do many scientists and technologists in Silicon Valley view the idea of a \"lawyerly society\" as a negative outcome, and how does the speaker counter this perspective?",
      "answer": "Scientists and technologists decry a \"lawyerly society\" because they perceive lawyers as prioritizing making arguments over uncovering truth, which is central to scientific and entrepreneurial endeavors (natural laws, market wants). The speaker counters by noting that power is seized, not given, and challenges scientists/engineers to \"get better at organizing society\" and \"make a case better to the population\" to gain power themselves, rather than merely decrying lawyers. He also suggests that arguing both sides can be seen as \"empathy.\"",
      "index_of_source": "Now, setting aside China entirely, as somebody who spends all his time talking to other scientists and talking to technologists in Silicon Valley, the idea that our nation should be run by lawyers is, to us, a shockingly bad outcome."
    },
    {
      "question": "What is \"industrial maximalism\" in China, and what is its historical and philosophical basis?",
      "answer": "Industrial maximalism is an online meme movement in China, advocating for technocratic rule to pursue science and technology. Its proponents believe China's historical weaknesses, such as being brutally invaded and partially colonized by Western powers and Japan, stemmed from backwardness in science and technology. They argue the solution is to organize all of society to pursue scientific and technological advancement to restore China's rightful place in the world.",
      "index_of_source": "I want to turn to a concept called industrial maximalism, which is promulgated by something sometimes called the Industrial Party in China."
    },
    {
      "question": "What causes the sense of precarity among China's elites, despite the country's economic advancements, and how does this influence their actions?",
      "answer": "Chinese elites face insecurity due to the Communist Party's extra-legal discipline process, with millions of officials being \"disciplined\" annually through their own party system. Furthermore, crackdowns in sectors like finance and tech, including pay ceilings and anti-graft campaigns in industries like semiconductors, create an unstable environment. This precarity leads many, including top officials like Xi Jinping (who sent his daughter to Harvard), to send their children to Western universities and try to move capital abroad.",
      "index_of_source": "Well, I think that in the state party context, these are people who are relatively high up within the Communist Party."
    },
    {
      "question": "How does market competition in China compare to the U.S. tech industry, and what are its implications for consumers and profitability?",
      "answer": "In China, market competition is described as \"ferocious,\" with companies constantly \"fighting everyone over everything,\" resulting in intense competition and frequently driving profit margins to zero. This contrasts with the U.S. tech industry, which the speaker characterizes as a \"gentleman’s club\" where major companies largely avoid treading on each other's core businesses. While this intense competition leads to lower profitability for Chinese companies (Shanghai Composite Index trending sideways), it greatly benefits consumers with incredible buying power and quality of life.",
      "index_of_source": "Probably the most underrated part of the Chinese system is the ferocity of market competition."
    },
    {
      "question": "Can authoritarian systems foster scientific breakthroughs, or is political freedom essential for such advancements?",
      "answer": "The speaker argues that authoritarian powers can indeed achieve \"incredible science and technology,\" citing examples like the Soviet Union (spaceflight, pure mathematics, chess) and Nazi Germany (many things). He notes that while he doesn't advocate for authoritarianism, \"money is good for science.\" He references a historian who found that the dissolution of the Soviet Union was worse for scientists than Stalin's purges because funding stopped, whereas Stalin actively funded science, allowing some to produce Nobel-winning work even after gulags. Scientists in such systems might use science as an \"intellectual escape\" from political unfreedom.",
      "index_of_source": "I believe that authoritarian powers can do incredible science and technology."
    }
  ]
};
</script>
