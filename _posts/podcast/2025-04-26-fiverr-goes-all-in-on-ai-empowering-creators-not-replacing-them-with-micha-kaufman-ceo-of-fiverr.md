---
layout: post
title: "Fiverr Goes All-In on AI: Empowering Creators, Not Replacing Them, with Micha Kaufman, CEO of Fiverr"
...
[Fiverr Goes All-In on AI: Empowering Creators, Not Replacing Them, with Micha Kaufman, CEO of Fiverr](https://pdst.fm/e/chrt.fm/track/993DGA/mgln.ai/e/1113/traffic.megaphone.fm/RINTP4316663640.mp3?updated=1745707022)
...
My goal is to help people understand AI on its own terms from as many different perspectives as possible, so we can avoid the dystopian scenarios of human disempowerment and instead, with AI's help, live the lives we've always dreamed of. Part of the way I'm doing that is by speaking at more AI events.
...
You know, 999 companies out of 1,000 are not going to be here that are doing AI because they're doing things that are going to be interchangeable by other things that are going to be even cheaper, even faster, even whatever. And the reality is that you need less entry-level people, and you need more people that know how to increase their capacity and know how to work with technology to do more because the bar is just higher.
And I think that this, much like the 2000, this could be a snowball effect where you see companies are starting to lay off people. And those people don't have places to go because everybody's firing people, because everybody's trying to figure out how to upgrade their game with technology. I'm not happy about this. It's just I'm calling things for what they are. And I may be wrong on this being the equivalent of the dot-com, but I don't think I'm wrong on the expectations that we have from ourselves to be able to use these new superpowers, super tools to achieve more.
...
Hey, we'll continue our interview in a moment after a word from our sponsors. In business, they say you can have better, cheaper, or faster. But you only get to pick two. But what if you could have all three at the same time? That's exactly what some of the world's most innovative brands and AI tech companies have since they upgraded to the next generation of the cloud: Oracle Cloud Infrastructure.
...
As I've told you, we started the company in 2010, launched with six categories. We now have close to 800. It doesn't mean that we didn't have hundreds of them go away, but many, many new hundreds of ones are appearing. The dynamics of a marketplace that is horizontal, which, by the way, is the reason why we can sustain a very successful business, is because we can shift between different categories very, very fast.
And what's interesting is we always, as human beings, not necessarily as a company, but as human beings, we always fail to predict what's going to be the future jobs that are going to be around. Not even in five years, in six months, in a year. It was impossible for me to see the explosion around crypto and NFT, right? NFT burst into our lives. It lasted a year. But this was a crazy year. Everybody was all around this. And then it went away. And that's fine.
...
And so, I think in any area, having this hardcore hacker mentality is going to be in very high demand. These are going to be the people that you pay for, and you pay generously.
...
In my view, at least let's think about this and figure out if there are other ways of actually doing this. What we've offered with Go is just a different approach of saying, you know what? We think we love the technology. We think it's incredible.
But we want to give also experiment with giving this technology to our creators and saying, instead of giving away your creation to train this infinite model, train your own model. It's going to be Nathan's model for creation. And it's going to have your, its corpus is going to be your world of creation. It's going to be your body of work. And it's going to be very, very true to your unique signature and style.
...
And so I think that all of us as companies need to challenge the status quo or the conceptions and iterate and be very, very quick, have very high velocity of testing.
...
AI is AI, but you can't have AI be non-compliant with its creator. When you have potentially millions of creators that have AI, you need to make it compliant with each one.
...
Is there any framework that you could muster for what things ought to be protected and what things should be the special space for humans versus the things that we won’t be sorry to have delegated?
Look, I don't, again, I'm not taking, I'm not putting the heart of a regulator and thinking, oh, what should we protect? In my view, you've mentioned a few different types of tasks. Any task that a human being should not do because it's repetitive and a computer can do better, we should stop doing.
...
I think I've kind of alluded to it previously when I said that the experiences of how we consume stuff, how we find things, how we convert, how we get comfortable, how we create trust, and how we make a decision are going to change.
...
But if I can pull this in three hours, not three weeks—no way. So there is some setting of an example, but it’s also really understanding. Much like you don't create companies by taking an MBA course, you need to be in the trenches.
You need to be an operator to understand the actual. It's the same with this. I think that this is a good time for a wake-up call because there's going to be changes in the industry. I think it's going to affect a lot of people, and it's the time to wake up. I think we're doing ourselves a favor by doing this.
...
<script>window.tocIndex = {
  "index": [
    ...
    {
      "index_sentences": "He's recently launched an interesting new suite of AI products called Fiverr Go, staked out one of the most notable values-based positions for how his company intends to use AI to empower human creators, and published what began as an internal company memo meant to wake team members up to the unpleasant truth that AI is coming for your jobs, adding also, heck, it's coming for my job too.",
      "section_level": 2,
      "section_title": "Fiverr Go and AI Positioning"
    },
    {
      "index_sentences": "Now, this is obviously an attempt to position Fiverr for success in the AI age.",
      "section_level": 2,
      "section_title": "Deeper Philosophy and Future Outlook"
    },
    {
      "index_sentences": "As always, if you're finding value in the show, we'd appreciate it if you'd share it with friends or write a review.",
      "section_level": 2,
      "section_title": "Call to Action and Events"
    },
    {
      "index_sentences": "For now, I hope you enjoy this conversation about the future of work and the challenge of building an AI platform on a foundation of core human values, with Micha Kaufman, founder and CEO of Fiverr.",
      "section_level": 1,
      "section_title": "The AI Wake-Up Call"
    },
    {
      "index_sentences": "You just put out a memo to the company that sort of said, okay, hey, guys, this is the wake-up call.",
      "section_level": 2,
      "section_title": "Context of the Memo"
    },
    {
      "index_sentences": "Look, you know, one of the things that I've wrote in my email is that what's going on with AI is really the fact that it's transforming the way all of us work.",
      "section_level": 2,
      "section_title": "Key Message of the Memo"
    },
    {
      "index_sentences": "And yesterday, I mean, Shopify, I mean, we didn't, I didn't do this, but they're talking about layoffs of 10%.",
      "section_level": 2,
      "section_title": "AI and Industry Disruption"
    },
    {
      "index_sentences": "And that's why I thought that this was really important to share with the team, because I believe in radical candor, because radical candor comes from care.",
      "section_level": 2,
      "section_title": "Radical Candor Philosophy"
    },
    {
      "index_sentences": "Someone asked me if I think technology or AI specifically will replace people.",
      "section_level": 2,
      "section_title": "AI Mastery for Survival"
    },
    {
      "index_sentences": "I think it's really going to be interesting to unpack this at kind of three levels.",
      "section_level": 1,
      "section_title": "AI and the Freelance Marketplace"
    },
    {
      "index_sentences": "My take on this is, when I started Fiverr 15 years ago, freelancing was something that people mostly did in between jobs.",
      "section_level": 2,
      "section_title": "Freelancer Adaptation vs. Full-Timers"
    },
    {
      "index_sentences": "So, historically, when I started the company, there were very few categories.",
      "section_level": 2,
      "section_title": "Characterizing the Fiverr Marketplace"
    },
    {
      "index_sentences": "So how have you seen AI impacting the activity on the platform?",
      "section_level": 2,
      "section_title": "AI Impact on Marketplace Activity"
    },
    {
      "index_sentences": "Do you have any, I mean, one that I can't resist floating is the AI scout.",
      "section_level": 2,
      "section_title": "Future of Work and New AI Jobs"
    },
    {
      "index_sentences": "Actually, I can give you a framework for why people go to others for things.",
      "section_level": 2,
      "section_title": "Why People Still Hire Humans"
    },
    {
      "index_sentences": "I sometimes describe AI as a great leveling of a lot of different playing fields.",
      "section_level": 1,
      "section_title": "Fiverr's AI Strategy: Centering Creators"
    },
    {
      "index_sentences": "So, I mean, to explain my motivation or why we have done it in the first place, I need to get a little bit philosophical.",
      "section_level": 2,
      "section_title": "Motivation Behind Fiverr Go"
    },
    {
      "index_sentences": "What's interesting is if you think, and look, I'm thinking, obviously, I'm the CEO of a public company, which is very much tied into technological trends and developments.",
      "section_level": 3,
      "section_title": "History of Human Advancement and Creation"
    },
    {
      "index_sentences": "What's really interesting in what happened with the way AI was designed in past years is that it just eats up everything.",
      "section_level": 3,
      "section_title": "AI's Impact on Creation Value"
    },
    {
      "index_sentences": "There is a burning question here, which some might say is philosophical.",
      "section_level": 3,
      "section_title": "The Central Question: Who is in the Center?"
    },
    {
      "index_sentences": "So what we've done with Fiverr Go and the keynote that you've mentioned is really to talk about this and say we need to decide.",
      "section_level": 2,
      "section_title": "Fiverr Go Product Suite"
    },
    {
      "index_sentences": "So the personal assistant was pretty obvious.",
      "section_level": 3,
      "section_title": "Personal Assistants"
    },
    {
      "index_sentences": "Then we had the creation models, and we said, okay, great.",
      "section_level": 3,
      "section_title": "Personalized Creation Models"
    },
    {
      "index_sentences": "How do you think about upgrading these things over time for people?",
      "section_level": 2,
      "section_title": "Challenges and Iteration"
    },
    {
      "index_sentences": "Look, you're touching on a big vulnerability of AI in general and those who design it.",
      "section_level": 3,
      "section_title": "Model Upgrades and Compatibility"
    },
    {
      "index_sentences": "At least the good news is that it really informs the model creators on how to do a better model.",
      "section_level": 3,
      "section_title": "Learning and Adapting"
    },
    {
      "index_sentences": "In the long term, let's posit for the sake of analysis that the models are going to continue to get better.",
      "section_level": 1,
      "section_title": "The Future of Work and AI"
    },
    {
      "index_sentences": "I don't know.",
      "section_level": 2,
      "section_title": "Lessons from Media Evolution"
    },
    {
      "index_sentences": "We're already making changes to our own model as a result of the learnings that we've had since launch, two months ago.",
      "section_level": 2,
      "section_title": "Learning from Go Launch"
    },
    {
      "index_sentences": "At some point the regulator is going to catch up.",
      "section_level": 2,
      "section_title": "Regulation and Human Creation"
    },
    {
      "index_sentences": "People ask you where do you think you're going to be 10 years from now?",
      "section_level": 2,
      "section_title": "Predicting the Future"
    },
    {
      "index_sentences": "For what it's worth, I'll take a little bit the other side of the AI understanding debate and say, I think there is some meaningful understanding going on inside certainly the latest systems.",
      "section_level": 2,
      "section_title": "AI Understanding Debate"
    },
    {
      "index_sentences": "Look, I don't, again, I'm not taking, I'm not putting the heart of a regulator and thinking, oh, what should we protect?",
      "section_level": 2,
      "section_title": "Machines vs. Humans - What to Delegate"
    },
    {
      "index_sentences": "How about on just creating liquidity in the marketplace?",
      "section_level": 2,
      "section_title": "AI and Marketplace Liquidity"
    },
    {
      "index_sentences": "That's an easy one.",
      "section_level": 2,
      "section_title": "AI for Matchmaking"
    },
    {
      "index_sentences": "Okay. So then maybe going back full circle to kind of where we started in terms of AI coming for all of us, coming for you at some point and the sort of wake-up call that you gave to your team.",
      "section_level": 2,
      "section_title": "Leadership and Team Response to AI"
    },
    {
      "index_sentences": "So when I sent this, I sent this more than maybe 36 hours ago and the reception of it was very good for some that are just ahead of the curve.",
      "section_level": 2,
      "section_title": "Impact of Memo and Team Response"
    },
    {
      "index_sentences": "In that day, almost two days from it, I've had so many conversations.",
      "section_level": 2,
      "section_title": "Leading by Example"
    },
    {
      "index_sentences": "Is it impacting your hiring plans?",
      "section_level": 2,
      "section_title": "Hiring in the AI Age"
    },
    {
      "index_sentences": "Interestingly enough, the question of being a seasoned professional or a junior may be less of an issue because the juniors are often the best hackers.",
      "section_level": 3,
      "section_title": "Proficiency vs. Seniority"
    },
    {
      "index_sentences": "It doesn't matter.",
      "section_level": 3,
      "section_title": "Learning and Education"
    },
    {
      "index_sentences": "I do worry at the same time.",
      "section_level": 3,
      "section_title": "University Curriculum Lag"
    },
    {
      "index_sentences": "If you care about the socializing aspect, absolutely, yes.",
      "section_level": 3,
      "section_title": "University Value Debate"
    },
    {
      "index_sentences": "Yeah, it is a strange world, but I would agree that in many cases, internet hustlers that are selling courses on how to use Cursor or how to use ChatGPT, whatever it may be.",
      "section_level": 3,
      "section_title": "Internet Hustlers vs. Universities"
    },
    {
      "index_sentences": "Well, I really appreciate how generous you've been with your time and it's been a great conversation.",
      "section_level": 2,
      "section_title": "Concluding Thoughts and Optimism"
    },
    {
...
window.faq = {
  "qas": [
    {
      "answer": "The attempt is not to maximize the value-to-price ratio for customers, but to empower the freelancers that have powered the Fiverr marketplace over the last 15 years.",
      "index_of_source": "As fast-improving AI capabilities and even faster-falling prices enable startups to disrupt all sorts of markets everywhere all at once, Fiverr Go stands out as an attempt not to maximize the value-to-price ratio for customers, but to empower the freelancers that have powered the Fiverr marketplace over the last 15 years.",
      "question": "Why did Fiverr Go focus on empowering freelancers instead of just optimizing for customer value/price?"
    },
    {
      "answer": "Freelancers are very often eager early adopters of AI tools, and actually in some ways much better prepared for the AI era than most salaried employees. They have a hunger to teach themselves and learn everything as it goes out. They know all the best software. They've gained the discipline and the know-how of how to be very agile, adaptive, and how to reinvent themselves very quickly.",
      "index_of_source": "Today, that means providing freelancers, who interestingly, Micha notes are very often eager early adopters of AI tools, and actually in some ways much better prepared for the AI era than most salaried employees, with custom AI assistants that can help them engage and serve more customers more efficiently, and also personalized image generation and text-to-speech models that are meant to ensure that the platform's many graphic designers and voiceover artists maintain control over and can continue to monetize their own distinctive styles and sounds.",
      "question": "According to the guest, why are freelancers often better prepared for the AI era than salaried employees?"
    },
    {
      "answer": "The core idea is that humans should be in the center, and AI should serve them, rather than the other way around, motivated by the belief that demotivating people from creating could lead to a \"very, very dark future.\"",
      "index_of_source": "If everything you create, the moment you create has zero value because AI sucks it and churns out generative stuff based on you, without giving you credit, without giving you the opportunity to gain from it, then my fear is that people's motivation to create is going to drop to zero, because there's no value.",
      "question": "What is the core philosophical stance behind Fiverr's approach to AI as announced with Fiverr Go?"
    },
    {
      "answer": "The memo stated that AI is transforming work, redefining \"ground zero,\" meaning easy tasks will disappear, hard tasks become the new easy, and impossible tasks become the new hard. It serves as a wake-up call for everyone, including himself, to adopt an \"AI-first mentality,\" increase output and quality, and warned that those unable to adapt will find themselves out of the industry.",
      "index_of_source": "Look, you know, one of the things that I've wrote in my email is that what's going on with AI is really the fact that it's transforming the way all of us work.",
      "question": "What were the key points of the internal memo Micha Kaufman sent to his team about the impact of AI?"
    },
    {
      "answer": "The three reasons are arbitrage of time (it's faster or more cost-effective than doing it yourself), needing a competitive edge (someone with better taste, skill, or tools), and complexity (the task is too complicated or multidisciplinary to handle alone).",
      "index_of_source": "The first reason is the arbitrage of time.",
      "question": "What are the three main reasons, according to Micha Kaufman, why people historically and currently seek services from other people?"
    },
    {
      "answer": "Instead of a general model eating up creations without reward or recognition, Fiverr Go allows creators to train their *own* models based on their unique body of work, ensuring their signature style is maintained and enabling them to monetize the model's output, serving as a tool for their business rather than displacing them.",
      "index_of_source": "What we've offered with Go is just a different approach of saying, you know what?",
      "question": "How does Fiverr Go's personalized creation model differ from how general AI models typically operate regarding creator compensation and recognition?"
    },
    {
      "answer": "He believes AI will significantly improve liquidity and matchmaking, changing how people consume, find, convert, build trust, and make decisions on the platform, leading to potentially previously unimaginable scale.",
      "index_of_source": "I think I've kind of alluded to it previously when I said that the experiences of how we consume stuff, how we find things, how we convert, how we get comfortable, how we create trust, and how we make a decision are going to change.",
      "question": "What is Micha Kaufman's outlook on the impact of AI on marketplace liquidity and matchmaking?"
    }
  ]
};
</script>
