...
Working complexity theorists have developed super good intuitive notions.
**3285.32** of how to deal with things that are a bit fuzzy.

**3287.76** You move, and it's not actually a bit like physics. 

**3290.018** You move, and it's maybe not actually mathematically correct. 

**3292.56** But in practice, it's correct. 

**3294.005** But if you want to do it in a proof assistant to figure out whether there's a **17** or **18** the exponent of the polynomial, that's no fun—super horrible.

**3306.55** SUBJECT: Yeah. 

**3308.29** I want to ask you about this because I supervised a few formalization projects myself, and in my experience, it will take a whole quarter to write **200 lines**. 

**3323.9** Sorry, here. 

**3325.21** SUBJECT: --you can—with that amount of supervision, you can have a paper with **3,000 lines of code**.

**3330.33** YANNICK FORSTER: I think I cheated. 

**3332.17** I forgot to import the slide that was there before because I imported the slide from a different talk on teaching. 

**3337.31** And there's a relevant bit here. 

**3339.61** So this was at **Saarland University in Germany**, which is similar to many universities in the **US** in the **'90s**, but not anymore. 

**3347.11** One as the first programming language introduces used to introduce **Standard ML** now **OCaml**, but doesn't matter—a functional programming language. 

**3354.68** So those are going to be people who as their first experience at university in programming languages. 

**3359.64** So a functional programming language. That's already probably not the case for your students. 

**3363.65** Two—in the second semester, so first year, lots of students take an introduction to interactive theorem proving to **Coq**. 

**3374.87** And then there are classes after that kind of prepare these topics well. 

If you have access to your curriculum, and you can design your curriculum—I know by accident because I observed it. 

**3387.11** I observed a curriculum that works super well where third-year students are perfect to do formalization projects. 

**3392.82** Indeed, the copy/paste of this is not easy because you need to have the right curriculum, or, slash, people need to learn the right things. 

**3406.55** But in this case, it happened that they had one year or so of experience on the right topics, and then they were good. 

To turn it around, they probably have to—should have explained it like this. After one year, people are ready to do that. 

**3416.54** But the one year, maybe six months you need. 

**3421.375** SUBJECT: To gain the educational aspect of it, is this something like a **bachelor thesis**? 

**3432.495** YANNICK FORSTER: It's a bachelor's thesis, which means, in total, I think it's **nine credits** for the seminar phase. 

That's how the **270 hours** come. And the three months should be something like **15 or 16 credits**. 

So this is getting close to **30 credits**, but not quite **30 credits**. 

In the seminar phase, it's not full-time. In the three months, it's full-time. 

**3458.09** So it's three months full-time plus **217 hours** to **70 hours of time**. We actually told our students to more or less log their hours. 

So this is really the case. 

**3470.98** So my understanding from hearsay is that the formalization of **[INAUDIBLE]**, and when they're assuming some results to be true while they work on it. 

**3481.19** So how reasonable do you think it is to take some things that people think are understood as axioms and then proving some result, kind of formalizing top down? 

**3491.135** YANNICK FORSTER: I think that's the right way to go in many, many areas. 

It's not always super well-appreciated when trying to publish a paper. Reviewers are a bit critical of this. 

That happened to me recently where we did some **bijection** between—I assume the bijection between natural numbers and something.
**3511.16**: that's clearly in **bijection** with **natural numbers**. 

**3512.94**: because I didn't want to write out the thing. 

**3514.35**: And then the reviewer said, “come on, why are you not formalizing this?”

**3517.64**: But I think that's the way to go. 

**3520.33**: If you want to **formalize**, there is a huge overhead in **formalization**. 

**3526.01**: Formalize the interesting things.  

**3527.79**: Ignore the boring things. 

**3530.48**: There is a danger. 

**3531.63**: For instance, you spell out the boring theorem in the wrong way, and then you actually use the wrong theorem. 

**3536.11**: And then your interesting theorem relies on the boring theorem that's actually wrong. 

**3539.585**: This happens all the time. 

**3540.67**: When formalizing stuff as a practitioner, in formalization, you always do this thing where you locally assume something. 

**3544.878**: You base something on it. 

**3546.89**: You need to have a lot of intuition when to actually go back to the thing you assumed and prove it a little bit because usually you get it wrong. 

**3552.878**: You never write down the right thing. 

**3554.42**: You need to fix it again. 

**3556.13**: And it's a very interactive process where you base it a bit on something, then you have the feeling, “OK, this is going to work.” 

**3561.35**: Now, I'm going to go back and prove this a little bit to make sure that it actually works. 

**3564.82**: And then you jump a bit. 

**3566.18**: That's super hard. 

**3567.07**: More or less, the one hour we spent in weekly meetings is a lot about this. 

- Assume this first, do that. 
- Now, go back and do it. 

**3576.79**: But for something like **Fermat's Last Theorem**, sure. 

**3579.52**: Don't spend five years on doing things that everybody knows if you want to prove the interesting things, but let enough people audit the things that are assumed. 

**3590.735**: SUBJECT: Now, I have myself in the last question here. 

**3594.38**: So there's a lot of excitement about this in the **mathematical community**. 

**3601.37**: There's less excitement in the **theoretical computer science** area. 

**3605.4**: So what is required to get this? 

**3608.94**: Is there something missing? 

**3610.22**: Or how would you envision you can get similar excitement in different areas? 

**3616.168**: **YANNICK FORSTER**: Maybe we can interest **Kevin Buzzard** in doing theoretical computer science.

**3619.918**: [LAUGHTER]

**3622.79**: So I'm sure there are social aspects at play. 

**3625.43**: There were advocates of computer formalization that played a super crucial role in exciting people. 

**3632.12**: Maybe there's a pope of theoretical computer science that needs to fall to formalization. 

**3636.437**: I don't think that's all of it because there is this problem with the invisible math. 

**3641.51**: I think THERE is something special going on here. 

**3643.57**: SUBJECT: [INAUDIBLE]

**3646.86**: **YANNICK FORSTER**: So for instance, **computability proofs**. 

**3651.068**: To prove that—I don't know—multiplication of natural numbers is computable. 

**3654.562**: Obviously, multiplication of natural numbers is computable. 

**3657.02**: To prove this, using **Turing machines** is super hard. 

**3659.51**: You're going to spend months formalizing this result. 

**3662.72**: So that's what I mean by invisible, because the obviously right proof is obvious. 

**3667.82**: There's nothing to prove on paper. 

**3671.95**: But there's a lot of invisible math in this proof in the sense that the real proof is super long. 

**3675.77**: SUBJECT: It's on the level of machine code. 

**3679.27**: It's like subhuman. 

**3681.02**: Is that kind of what you're talking about? 

**3684.44**: So intuitive that the humans don't write it out. 

**3686.92**: And nobody would ever spell it out for good reasons. 

**3689.21**: But in the proof system, you need to do it. 

**3691.002**: The thing that will always stay invisible on paper, but it's really there. 

**3694.4**: That's also there for mathematical proofs. 

**3695.84**: You have these intermediate bits. 

**3696.88**: Like, the steps, they will always stay invisible. 

**3698.922**: You don't spell out logical inference rules.
You always have **invisible math**. Here there is maybe more. 
