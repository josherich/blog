---
layout: post
title: "Callum Williams: Economics, AI, and Technological Progress — #82"
...
[Callum Williams: Economics, AI, and Technological Progress — #82](https://media.transistor.fm/5e5f8069/86976462.mp3)
...
In summary, the U.S. is indeed unequal, but when a Martian arrives, we should clarify that inequality manifests in numerous ways and can depend on what metrics one is considering—wealth versus income, for instance—and that age significantly influences the picture.
Interest rate then multiplying by twenty thousand dollars, that two hundred thousand dollars is the wealth of which you get a five percent interest rate, you get ten thousand dollars a year. So it's a sort of calculation, an estimation of wealth rather than directly observing the wealth that someone has at hand. 
...
Good excellent okay our next big topic AI and jobs, which yes, I believe you actually covered this. This is like one of your focuses, right? Well, I've written about most stuff we've talked about. Sorry, stuff, but yeah, no, it is. It is. Yeah. 
...
**Speaker 1:** You might say that ten thousand dollars is being valued as two hundred thousand dollars. 

Now, if we instead consider the actual income derived from tangible wealth that is genuinely owned—rather than hypothetical values that arise from assumed returns—we find that this analysis significantly reduces the extreme ends of wealth. Ultimately, much of the wealth inequality we observe stems from these hypothetical returns.

**Speaker 2:** Right, and if we examine the Gini coefficient of earnings as a measure of income inequality, we find that it has remained relatively stable over recent decades. While there's certainly considerable income inequality, it's stayed fairly consistent. This presents a markedly different narrative compared to wealth inequality, which suggests that the wealthy are exponentially enriching themselves relative to everyone else.

**Speaker 1:** When it comes to age, it plays a crucial role. A significant number of individuals in the lower wealth percentiles are younger people just beginning their careers. They haven’t yet amassed the assets that older individuals, who have been in the workforce for years, have accumulated. This significantly skews wealth figures.

**Speaker 2:** Exactly. While one can argue that there are systemic issues in the U.S. surrounding wealth concentration—particularly among the super wealthy—the implications of wealth inequality need a careful analysis that takes age and the distinction between real versus hypothetical wealth into account.

**Speaker 1:** To summarize, while the U.S. is indeed marked by inequality, it's essential for someone new to look at how this inequality presents itself in various ways. The metrics used—be it wealth versus income—can greatly influence the picture, and age is a significant factor in this narrative.

**Speaker 2:** Moving on to the interest rates, multiplying twenty thousand dollars gives you a valuation of two hundred thousand dollars, which generates a five percent interest rate, yielding ten thousand dollars annually. So, this is more of a calculation or estimation of wealth, rather than a direct observation of the wealth someone currently possesses.

**Speaker 1:** The underlying assumptions could include stocks, real estate, bonds, or even simple bank accounts. Traditionally, the Piketty work has assumed that the rate of return is uniform across households and income distributions—essentially a flat five percent for everyone. However, this isn’t the reality. 

Often, individuals at the lower end possess poor financial literacy, leading them to keep their entire income in low-interest bank accounts, which might yield almost no returns or just one to two percent through other means.

**Speaker 2:** In contrast, the very wealthy are far more likely to invest their resources in equities or corporate bonds, which typically provide higher returns. If the return rates are indeed higher for the wealthy, then the estimated wealth from which they draw that income is considerably lower than it appears. 

Adjustments like these reveal a U-shaped pattern of wealth inequality in the U.S. and elsewhere, peaking during the Great Gatsby era, declining after World War II, and then rising again since the 1980s—but not to the degree that current Piketty research might imply. 

**Speaker 1:** Just to recap for those listening, Piketty's influential book came out about 15 years ago, around 2012 or 2013. It made a substantial impact and left many, including me, impressed by its figures but hesitant about fully trusting its conclusions.

**Speaker 2:** Yes, there's indeed been a significant amount of empirical pushback against those ideas. I think discussions have leaned more towards income inequality than wealth inequality figures. Most academics tend to find income inequality analyses more productive since fewer assumptions are required.

**Speaker 1:** In the U.S., theoretically, everyone reports their income on tax returns, so you can see what a person's actual income is. However, individuals do not report all their wealth, complicating the analysis for the very wealthy when trying to understand their financial situation. 

**Speaker 2:** I'm interested in both the ultra-high-net-worth and high-net-worth demographics. However, when I shared some figures on Twitter, my main goal was to capture the precarity experienced by the very poor. 

You often hear alarming statistics about how a certain percentage of Americans are just one paycheck away from homelessness. I was trying to determine if it's really one percent of the population facing that risk. 

**Speaker 1:** If that situation is due to something like mental health issues, it’s a different narrative than a single mother working hard who might end up living in her car with her kids if she loses her job. I definitely don't want to live in a country where that scenario is common.

**Speaker 2:** My posting of the Federal Reserve numbers was a flawed approach to address that question, but subsequent research indicates that anywhere from 10 to 20 percent of Americans might be living a precarious existence, possibly leaning closer to ten than twenty.

**Speaker 1:** That's what I was trying to convey. In discussing this with Twitter users, I was urging them to assess their comfort level with this statistic. Some might argue that such risks are a necessary part of innovation, like breakthroughs in AI.

**Speaker 2:** That’s a fascinating point. I think using wealth inequality data to understand economic precarity is challenging. Wealth accumulation strategies often reflect the welfare state’s influence.

**Speaker 1:** For instance, Sweden has high wealth inequality yet is seen as a welfare state paradise. This inconsistency arises because those at the bottom lack incentives to accumulate wealth, knowing the state will step in during financial hardships.

**Speaker 2:** Indeed, the expansion of the welfare state in the U.S. since the 1980s, 90s, and 2000s has contributed to a significant decline in the household savings rate. Many people interpret this reduced savings rate to indicate Americans are irresponsible with money, but it likely reflects the decreased necessity for private insurance due to public support.

**Speaker 1:** Can we delve deeper into that? Are you suggesting that when individuals risk eviction for unpaid rent, they subconsciously believe the government will rescue them? Or is it possible these scenarios are exaggerated, only appearing in media portrayals?

**Speaker 2:** That’s an essential question. It is unwise to assume that all economic decisions are made with conscious intentions. People make choices about spending and saving shaped by many factors, often outside of their awareness.

**Speaker 1:** However, it’s crucial to recall that the welfare state in the U.S. has seen considerable expansion. One in eight people or households in the U.S. is currently relying on food stamps. Medicaid has also expanded significantly in recent years. Just consider how during the pandemic, the federal government increased unemployment benefits, which had a noticeable effect on economic behavior.

**Speaker 2:** Exactly, this shift is likely what contributes to increased spending patterns compared to before. But again, the question remains of how best to capture the situation you’re interested in.

**Speaker 1:** Ideally, we should track the movements in and out of homelessness. While tricky, it’s an essential metric. Another commonly cited measure is a survey by the Fed that asks if individuals could come up with $600 or $800 in an emergency—responses often indicate a high percentage could not.

**Speaker 2:** Right, but there are concerns about how that survey is structured. Additionally, I take issue with the question about living paycheck to paycheck; a staggering number of households, including those earning over $100,000 a year, report they do.

**Speaker 1:** That raises the issue of whether this truly reflects economic precarity. I would assert it's not a meaningful measure. One of the significant successes of the U.S. economy and many others has been the relative ease of finding a job.

**Speaker 2:** True, the unemployment rate in the U.S. is around four percent, notably low. Most affluent countries have similarly low rates, and employment levels are at historic highs. If we consider the channels through which people can’t meet their bills, difficulty finding work has become less likely, not more so, in recent years.

**Speaker 1:** But about that four percent figure—it’s a basic question that might reveal my economics naivety—what about the fraction of working-age individuals actively participating in the workforce? Isn’t that figure alarmingly low, given the number of discouraged workers?

**Speaker 2:** It indeed was a significant issue following the financial crisis. Labor force participation for both men and women in the U.S. is quite low when compared internationally. Curiously, Japanese women’s labor force participation used to be higher than that of American women.

**Speaker 1:** That’s surprising! But it seems there have been trends towards improvement as the labor market strengthens. 

**Speaker 2:** Absolutely. It’s essential to recognize that the U.S. does stand out with its low labor force participation rate. When you look at other affluent countries, you typically don’t find similar circumstances. This U.S. phenomenon begs the question: why is that the case? 

**Speaker 1:** There are so many theories, from video games to the opioid epidemic making a strong case, but towns across the world have also experienced similar phenomenon without facing the same challenges. There’s definitely a puzzle here.

**Speaker 2:** It’s evident that the U.S. doesn't hold the title for the best economy regarding workforce participation. Improvements have been noted, yes, but when you consider your own experiences—if you visit a struggling town in the Midwest, you might encounter healthy young individuals, say a 27-year-old, who appears ready to work yet is stuck in his mother’s basement playing video games. 

**Speaker 1:** Is that a real issue or merely a sensationalized narrative from journalists? We just don’t know—what percentage of young individuals really find themselves in that situation?

**Speaker 2:** That’s a compelling question. It's also become a notable topic in the UK recently: the rise of workers taking substantial time off work for mental health concerns. 

**Speaker 1:** Indeed, there seems to be a surge in doctor’s notes justifying extended leave from work. I'm open to the idea that this could reflect broader societal issues, possibly exacerbated by social media or technology, yet we still lack clarity in this area.

**Speaker 2:** Exactly! For years, economic policy has prioritized getting people into work as a primary goal. Just a few years ago, during the early 2010s, the focus on unemployment was paramount. 

**Speaker 1:** But that narrative has changed; during his presidency, Trump frequently tweeted “jobs, jobs, jobs” in capital letters—now such statements have diminished, presumed to be a given that finding work is relatively easy.

**Speaker 2:** It’s indeed an interesting transition. I harbor a lingering feeling that many individuals remain unaccounted for in that four percent statistic; we’ve sidelined them, considering only the four percent as if their situation doesn’t warrant concern.

**Speaker 1:** That's certainly more applicable to the U.S. than other countries. Conversely, the U.S. has created a multitude of jobs that are likely not accurately reflected in statistics, particularly for those undocumented workers.

**Speaker 2:** It's a fascinating question: how many jobs actually exist in the U.S.? We practically have no clear answers. Speaking of which, I’d like to mention something personal—I've learned you reside near the marina in San Francisco.

**Speaker 1:** That's true.

**Speaker 2:** That area is known to be one of the wealthiest residential locations globally, yet it’s also notorious for its stark contrasts—one can hardly walk far without encountering homelessness and visible challenges. What are your thoughts on the polarization in society, where affluent individuals live near those facing severe hardships? Is this reality exaggerated or is it indeed problematic? 

**Speaker 1:** In terms of my experiences living in San Francisco, it’s not exaggerated at all. Many parts of the city are where the wealth creators seldom tread, avoiding areas like downtown and the Tenderloin, which are quite close. 

**Speaker 2:** The reasons behind the homelessness epidemic in San Francisco are undoubtedly complex. I've fluctuated in my interpretation of the cause—but I once attributed it primarily to housing costs.

**Speaker 1:** Those costs are indeed steep, often making it difficult for even well-compensated workers to afford housing. 

**Speaker 2:** However, I’ve come to appreciate that while housing is a factor, the critical influence seems to be related to substance abuse. Many individuals are in a dire state of mental and physical health, and a considerable portion are not from San Francisco itself. There’s an argument to be made that San Francisco's drug supply and a support network—albeit well-meaning nonprofits—encourage drug use and street living.

**Speaker 1:** It's clear that simply providing housing isn’t a universal solution to their struggles.

**Speaker 2:** Indeed. Efforts during the pandemic included converting hotels in the Tenderloin and downtown for temporary accommodations, yet this approach yielded little success, sometimes worsening the situation.

**Speaker 1:** Determining our next steps for addressing this issue is daunting. What’s happening in downtown San Francisco doesn’t stem from a broader notion of American precarity; rather, it reflects the surplus of resources present in the city.

**Speaker 2:** Let's shift gears. We have so much to cover, and we could easily spend hours on these topics alone! Another area to delve into is the divergence between the U.S. and Europe on various metrics, such as GDP per capita and overall wealth.

**Speaker 1:** Absolutely! By coincidence, my wife was a visiting professor in the Netherlands last fall, and during my travels in Europe, I was struck by conversations around net income—that is, income after taxes. 

**Speaker 2:** Yes, even in wealthy European countries, not to mention Greece or Italy, the typical net income considered comfortable seems surprisingly modest. It could amount to just a few thousand euros—what some might regard as a good salary for a professional in the U.S.

**Speaker 1:** It’s a stark contrast when viewed through the lens of American poverty, raising questions about what’s really at play. Could you shed light on the overarching divergence between the U.S. and Europe? 

**Speaker 2:** That's a compelling question. I would say, first, there are significant ways in which the U.S. has diverged from Europe—GDP being one example. It has seen robust growth, particularly following the pandemic, with asset prices skyrocketing. 

**Speaker 1:** Indeed, the stock market's performance has been remarkable!

**Speaker 2:** Conversely, European equities are often treated more like bonds—they offer some dividends but lack growth. Secondly, historically, the U.S. has enjoyed a wealth advantage over Europe since the 1920s or 30s.

**Speaker 1:** So, it’s not merely a World War II issue; rather a long-standing economic reality.

**Speaker 2:** Precisely. If you speak to someone who’s experienced traveling from the U.S. to Oxford in the 70s, they often describe it as encountering a radically different world. However, determining if the U.S. has become significantly wealthier than Europe recently—and how that fits with today’s economic narrative—is less straightforward.

**Speaker 1:** What metric truly reveals living standards?

**Speaker 2:** Indeed, it matters what bundle of goods and services people can afford. I believe the most relevant measure for that is actual individual consumption. This measure, generated by the OECD and others, assesses the market value of what individuals purchase with their income, alongside a calculated market value of publicly consumed services like healthcare, education, and infrastructure.
**Speaker 2:** It's measured accurately and at pretty high frequency. Over the past 10 to 50 years, Europe has actually kept up with America quite well, and in many cases, it has even improved compared to America. For instance, the individual consumption per person in the Netherlands is higher than in the U.S.

**Speaker 1:** That sounds surprising given the discussions happening over there. 

**Speaker 2:** Yes, it might seem odd, but the value of public education and healthcare is very high in the Netherlands. In the U.S., individuals need to allocate a large portion of their salary for health insurance, while that pressure isn't as significant in the Netherlands. This contributes to closing the gap considerably.

**Speaker 1:** What about the outlook for the European economy as a whole?

**Speaker 2:** Unfortunately, it isn't very positive. Despite the discussions about improvements, there are significant structural political barriers preventing the EU from functioning as a true single market. The U.S. operates as a single market, and this fact alone will likely lead to increasing divergence, with the U.S. continuing to grow while the EU finds itself in a low-growth environment. 

**Speaker 1:** So you're saying that your view on the future is somewhat pessimistic?

**Speaker 2:** Yes, historically, I see some optimistic trends, but for the future, I'm much less hopeful.

**Speaker 1:** That divergence seems so pronounced. I even noticed it during a dinner with a professor from the University of Amsterdam after giving a seminar. Many physicists there acknowledged that U.S. salaries are significantly higher. They even joked that a Nobel Prize winner at their university might earn less than I do.

**Speaker 2:** It's fascinating, and they seemed to deal with it in creative ways, like arguing that food is costlier in the U.S. I mentioned that while it's around 20 percent more expensive, it’s not something I consider a big deal in my monthly budget. Their reaction was intense—it's almost like there's more at play here.

**Speaker 1:** Could it be related to currency strength? 

**Speaker 2:** That's certainly part of it. The strength of the dollar compared to the euro can explain some of the disparities in GDP figures. It's worth noting that there was a significant migration of British academics to the U.S. in the 90s, especially when the U.K. economy was doing well.

**Speaker 1:** It seems like these differences have persisted for a long time.

**Speaker 2:** That’s correct. They haven’t materially worsened in recent years, although the dynamics of public universities in the Netherlands might differ from U.S. private institutions, which often face greater salary pressures.

**Speaker 1:** That makes sense. Being in San Francisco, it’s evident that salaries are notably higher compared to other places. However, there's also a common complaint that U.S. public services aren't very good, which I don’t necessarily believe to be true.

**Speaker 2:** I agree to some extent. Public transportation in San Francisco is decent. However, I do find that many cities in the EU tend to be more pleasant to live in. The safety factors and overall quality of life there often outweigh those in American cities.

**Speaker 1:** That’s an excellent perspective. It's interesting to see how culture influences lifestyle—like how in the U.K., even if my lifestyle doesn’t change, I tend to lose weight because the portion sizes differ and there's generally more walking involved.

**Speaker 2:** Exactly! There's definitely a sense of balance in European cities. I relish biking around in the Netherlands; everything just clicks, from the public transport to the ease of navigating the city.

**Speaker 1:** Having spent time in both regions, I feel dislocated sometimes, trying to reconcile the material well-being in each. The qualitative differences, alongside purchasing power, add layers of complexity.

**Speaker 2:** Definitely. One approach to understand this is by comparing the number of British nationals living in the U.S. to Americans living in the U.K. It might provide insights into life quality between the two countries.

**Speaker 1:** That’s an intriguing idea, although immigration barriers could skew the results. I find that many British individuals relocating to the U.S. suggests a perceived better quality of life here.

**Speaker 2:** There’s certainly a lot of movement from various countries to the U.S. during economic hardships. As you mentioned, the U.S. has deeper capital markets, which encourages growth and innovation compared to Europe.

**Speaker 1:** What other factors contribute to this divergence?

**Speaker 2:** The primary issue is that any European company looking to expand quickly needs capital and has difficulty obtaining it within the EU. The capital markets in the U.S. are much more developed, incentivizing companies to set up there.

**Speaker 1:** So the rigid regulations across Europe create bottlenecks for growth?

**Speaker 2:** Correct. Although goods flow freely within the EU, the barriers for services remain high. Legal and regulatory hurdles hinder innovative companies from expanding their reach.

**Speaker 1:** Language differences must complicate this as well.

**Speaker 2:** Absolutely. The EU is already balkanized in terms of languages, which complicates not just trade but collaboration across borders. 

**Speaker 1:** To what extent does the cultural perspective shape risk-taking and asset ownership in different countries?

**Speaker 2:** It plays a huge role. For example, many Germans are reluctant to invest in stocks, sticking primarily to government bonds. This cautious approach diminishes capital market depth and, as a result, economic growth.

**Speaker 1:** It appears that this fear of risk can create a barrier to economic advancement.

**Speaker 2:** Indeed, it's a circular issue. Funds not invested in equities often go to government bonds, which helps finance the welfare state at the expense of growth.

**Speaker 1:** It's noteworthy how motivated people are in Silicon Valley, constantly striving for more. Yet, I sometimes wonder about the trade-offs involved in that kind of mindset.

**Speaker 2:** That drive to accumulate can be both inspiring and corrupting, especially compared to the more relaxed attitudes toward life in places like Italy or France, where people seem satisfied with a simpler existence.

**Speaker 1:** Absolutely, that sense of 'enough' is something I’ve also felt in the Netherlands, where the lifestyle feels sustainable and fulfilling without excess.

**Speaker 2:** It’s a big contrast to the pressure felt here in the U.S. Especially when discussing societal ideals like Japan, where despite their mastery of living standards, GDP growth remains stagnant.

**Speaker 1:** It’s an interesting dynamic—whether the pursuit of growth is genuinely all that it’s cracked up to be.

**Speaker 2:** Precisely. Moreover, the political landscape in both Japan and the EU limits their ability to run balanced budgets, leading to accumulated debts.

**Speaker 1:** Countries like Greece are proving that reform can make a difference. Their recent reductions in debt-to-GDP ratios indicate a shift.

**Speaker 2:** Yes, Greece has made significant strides recently. Their proactive measures, coupled with positive economic conditions, demonstrate that recovery is possible, offering glimmers of hope in Europe’s outlook. 

**Speaker 1:** And with that context, it seems like we should transition to discussing AI and jobs, which is a focus for you, right? 

**Speaker 2:** Yes, indeed! In our work, we develop AIs for customer service that can handle tasks almost as well as a human—a potential cost-saving that’s hard to ignore. 

**Speaker 1:** Yet, the adoption rate seems low.

**Speaker 2:** Definitely. The back-end systems in many call centers are outdated, and managers are often risk-averse, unwilling to take a chance on significant changes that might alter their jobs. 

**Speaker 1:** It sounds like a classic case of human decision-maker friction.

**Speaker 2:** Exactly! Even though the technology could perform tasks at a fraction of the cost, the resistance to change is quite pronounced. 

**Speaker 1:** So even if you present a clear case for efficiency, the cultural reluctance to shift workflows holds back widespread adoption.

**Speaker 2:** Yes, the organization’s structure and the principal-agent problem can complicate implementation. 

**Speaker 1:** This dynamic is intriguing. You’d think that the potential increases in efficiency would encourage quicker adoption.

**Speaker 2:** You would assume so! However, the reality is that currently, even though an AI can take over many tasks, it’s going to take years to significantly see it integrated into working hours across the industry. 

**Speaker 1:** And that creates a contrast with the rapid consumer adoption of technology we see today.

**Speaker 2:** It does. Companies tend to lag behind household adoption of new technologies, and this discrepancy can cloud our understanding of AI's potential impact on productivity.

**Speaker 1:** That leads to the critical need for businesses to adopt innovative solutions and increase overall productivity. 

**Speaker 2:** Absolutely! Recognizing the delays in actual adoption can offer essential insights into larger economic trends and potential growth areas.
**Speaker 1:** It seems like people intuitively recognize there are numerous tail risks associated with AI technology that differ significantly from the risks of their current human staff. They might think, "Sure, this looks great, but what if it suddenly crashes, and I'm left in a tough spot?"

**Speaker 2:** Exactly! Someone who isn't technically savvy struggles to evaluate these tail risk scenarios. They have no way of knowing how common or likely these risks are—like getting hacked and having to shut down customer service altogether. All these uncertainties keep people from fully embracing AI. The ones who do tend to be founders of growth-stage companies. They think, "We're selling a lot, we need a customer experience function, and I’ll build it from scratch using cutting-edge technology with a mix of AIs and a few humans for complex cases."

**Speaker 1:** That sounds straightforward, but existing companies find it much more challenging to adapt.

**Speaker 2:** Right, and that indicates that if you’re optimistic about AI, you rely on a steady flow of new companies emerging in the market.

**Speaker 1:** But even that flow has slowed down, hasn't it?

**Speaker 2:** Yes! Even though entrepreneurship rose a bit during the pandemic, the overall rate is still significantly lower than in the 60s and 70s. This makes creative destruction—a potent agent of change—happen more slowly than we'd like.

**Speaker 1:** You mentioned fast food—how is Taco Bell handling AI integration?

**Speaker 2:** Actually, Taco Bell is leading the charge by rolling out AI in their drive-throughs nationwide. I found one in Michigan that has an AI system in place. Customers can talk to the AI to place their orders, which then directly pass into the kitchen. It works better than I expected!

**Speaker 1:** That's fascinating! But I imagine franchisees might hesitate. How is that dynamic affecting the rollout?

**Speaker 2:** It is complicated. Franchisees can be cautious about accepting new tech. Sometimes, they might want to adopt it, but the parent company might resist. Essentially, there's a lack of uniformity in food ordering as companies grapple with AI.

**Speaker 1:** And doesn’t customer expectation factor into this equation as well?

**Speaker 2:** Absolutely! There's a lot of uncertainty. Decision-makers at Taco Bell—both corporate and franchise owners—are grappling with fears about whether this AI will hurt or help sales. 

**Speaker 1:** It sounds like there's a cultural shift happening too. People seem more focused on avoiding losses than on seeking gains these days.

**Speaker 2:** Indeed! This massive loss aversion has worsened over the decades, possibly due to factors like social media amplification of failures.

**Speaker 1:** How does this relate to the valuations of these tech giants, often labeled as the "Magnificent Seven"?

**Speaker 2:** That's a great question! When evaluating these valuations, you'd wonder if there’s a bubble forming. Is it supported by future profit, like Taco Bell's adoption of AI? But even then, we could be looking at a long wait—five or ten years—for those earnings to materialize. 

**Speaker 1:** And investors might not tolerate that wait, right?

**Speaker 2:** Exactly! If revenues don’t rise as expected, maintaining high valuations will be challenging. Some argue that we might hit a breakthrough with superintelligence that rapidly transforms the landscape, but that’s speculative.

**Speaker 1:** Sure, and then there’s the Goldman's Sachs perspective, where they discuss the trillion-dollar investments in AI—what are they actually solving?

**Speaker 2:** Exactly! It often seems like there’s a deployment problem that isn’t fully being understood. 

**Speaker 1:** It sounds like the measurement of AI spending is complicated too.

**Speaker 2:** You're spot on! Certain expenditures may get labeled as AI spending—possibly inflating the numbers without a clear understanding of their effectiveness. 

**Speaker 1:** Meanwhile, the replacements of human tasks with AI are more evident, right?

**Speaker 2:** Precisely! We can track clear ROI when replacing human jobs with AI. However, many tasks—like transcribing a meeting—still lack demonstrable productivity gains despite their novelty. 

**Speaker 1:** That’s a good observation. There seems to be a lot of non-productive churn happening now.

**Speaker 2:** Yes, and history shows us that sometimes lower production costs can lead to inefficient outputs. For instance, consider the relationship between simplifying content creation and the growing complexity of regulatory compliance.

**Speaker 1:** Agreed. There’s an intriguing story about your experience with a proposal from the Saudi government—what happened?

**Speaker 2:** Well, during a meeting, a junior team member presented her findings on operating a business in Saudi Arabia. It was instantly clear to me that her research lacked depth—it was just AI-generated filler from ChatGPT. I was frustrated for wasting time on vague and unsubstantiated information.

**Speaker 1:** That’s so frustrating! It sounds like a classic example of not being aware of AI’s limitations. 

**Speaker 2:** Absolutely! There’s a real risk of generating shallow content. Then there’s the argument that relying on others to process information can stifle original thinking.

**Speaker 1:** Right! It becomes a different skillset when someone else does your legwork for you.

**Speaker 2:** Exactly! This can hinder the development of critical thoughts and ideas, especially if the output doesn't align with the actual needs of the business. 

**Speaker 1:** It sounds like the problem of consensus information being misinterpreted is a real concern.

**Speaker 2:** It truly is! Junior professionals may not realize they’re processing mediocre information and could present it to their superiors, leading to wasted efforts and dissonance.

**Speaker 1:** It seems like a cycle of frustration could easily continue.

**Speaker 2:** Yes, and it brings us to the broader discussion we've had about productivity stagnation and technological innovation. Tyler Cowen and Patrick Collison’s work on Progress Studies highlights crucial factors that drive economic growth.

**Speaker 1:** Tyler’s recent stance surprises me—he seems to believe progress is faster due to AI. What do you think?

**Speaker 2:** Personally, I find Tyler too optimistic about AI. It's essential to acknowledge there’s been a significant slowdown in tangible progress affecting quality of life, especially in real-world metrics.

**Speaker 1:** Like travel times or construction speeds?

**Speaker 2:** Exactly! We're not seeing the advancements we used to experience in those areas. Innovations in macro technology seem to have plateaued or even regressed despite amazing advances in microtechnology.

**Speaker 1:** The differential seems striking. Can we still appreciate the gains made at the nano level?

**Speaker 2:** Definitely! The progress we've achieved in semiconductor tech is remarkable—advancements that allow AI to thrive today. However, it underscores the divide between bits and atoms.

**Speaker 1:** And that regulatory environment plays a significant role too.

**Speaker 2:** For sure! Regulations affect how technology is adopted, like how airplane speeds haven’t significantly changed due to regulatory constraints. 

**Speaker 1:** It feels like there’s a delicate balance between technology and regulatory frameworks shaping our progress.

**Speaker 2:** Agreed! We’re at a crossroads with nuclear energy development and should reflect on the irrational fears that have stifled its growth. 

**Speaker 1:** It will be fascinating to see how future generations assess our hesitancy in shaping this frontier.

**Speaker 2:** For sure! It’s been a great discussion. I'd love to continue exploring these economic topics. 

**Speaker 1:** Sounds perfect! Thank you for your insights today. 
...
<script>window.tocIndex = {
  "index": [
    {
      "index_sentences": "return, well then you say that ten thousand dollars is worth two hundred thousand dollars.",
      "section_level": 1,
      "section_title": "Wealth Inequality vs. Income Inequality"
    },
    {
      "index_sentences": "Interest rate then multiplying by twenty thousand dollars, that two hundred thousand dollars is the wealth of which you get a five percent interest rate, you get ten thousand dollars a year.",
      "section_level": 1,
      "section_title": "Recap of Piketty's Book and Empirically Grounded Pushback"
    },
    {
      "index_sentences": "I have an interest in both; I'm interested in the ultra-high net worth world, high net worth world.",
      "section_level": 1,
      "section_title": "Wealth Data and Economic Precarity"
    },
    {
      "index_sentences": "So my posting of the Fed numbers was a very poor way of getting at that question for various reasons.",
      "section_level": 1,
      "section_title": "The Welfare State"
    },
    {
      "index_sentences": "Can I just drill down? Are you saying that these people who are in danger of being kicked out of their rental because they can't make the rent somehow know that they will be saved at the last minute by government?",
      "section_level": 1,
      "section_title": "Government's Role in Preventing Homelessness"
    },
    {
      "index_sentences": "Well, yeah, absolutely. And we can talk about why that may be.",
      "section_level": 1,
      "section_title": "Capturing Economic Precarity"
    },
    {
      "index_sentences": "The unemployment rate in the U.S. is like four percent or whatever; it's pretty low.",
      "section_level": 1,
      "section_title": "Unemployment Rate and Labor Force Participation"
    },
    {
      "index_sentences": "It's amazing how, obviously, you’re a professional following these kinds of issues. I'm just an amateur, but even between us, we don't have a real feel for like if I go to some rust belt town in Michigan and I meet some 27-year-old who should be working and he's vigorous and healthy, turns out he's living in his mother's basement playing video games all day.",
      "section_level": 1,
      "section_title": "The Puzzle of Labor Force Participation"
    },
    {
      "index_sentences": "I think it's weird, because for the longest time in economic policy getting people into work was like the number one goal.",
      "section_level": 1,
      "section_title": "Shifting Priorities in Economic Policy"
    },
    {
      "index_sentences": "Yes, that is true for the U.S. more than for other countries.",
      "section_level": 1,
      "section_title": "The Underground Economy in the U.S."
    },
    {
      "index_sentences": "Let me close this topic off by pointing out—I’m revealing a little bit of your personal information here—but I believe you live near the marina in San Francisco.",
      "section_level": 1,
      "section_title": "San Francisco: Polarization and Precarity"
    },
    {
      "index_sentences": "Well, obviously, in terms of one's lived experience in San Francisco, that definitely is not overblown, because there are large chunks of the city that the wealth generators of the city—I’m not one of them; I’m a journalist, so I don’t generate anything—don't go there.",
      "section_level": 1,
      "section_title": "Causes of Homelessness in San Francisco"
    },
    {
      "index_sentences": "Let's move on. Although we have two hours, there are so many interesting things for us to discuss that we could build a whole two hours with just any one of these topics.",
      "section_level": 1,
      "section_title": "Divergence Between U.S. and Europe"
    },
    {
      "index_sentences": "You hear people talking about their net income, which means the income they take home after taxes.",
      "section_level": 1,
      "section_title": "The Reality of Lower Net Incomes in Europe"
    },
    {
      "index_sentences": "It's such an interesting question. I guess I would say two things by way of context.",
      "section_level": 1,
      "section_title": "Living Standards and Actual Individual Consumption"
    },
    {
      "index_sentences": "Got it. You know, this divergence has reached a point where even when I was with other professors, a professor at the University of Amsterdam having dinner with me after I gave a seminar—there were a bunch of physicists there and they were aware that U.S. salaries are way higher, that the Nobel Prize winner at the University of Amsterdam is paid less than maybe paid less than me.",
      "section_level": 1,
      "section_title": "Coping Mechanisms in Europe Regarding Income Disparities"
    },
    {
      "index_sentences": "I mean, that definitely explains the different GDP per capita or GDP measured in dollar terms for sure.",
      "section_level": 1,
      "section_title": "Mobility of Academics and the Public Services in the U.S."
    },
    {
      "index_sentences": "By the way, I always lose weight whenever I go to the U.K. There’s something in the food here that is very weird.",
      "section_level": 1,
      "section_title": "Lifestyle and Environment of Europe"
    },
    {
      "index_sentences": "Totally. I think one way of thinking about answering this question is, the cleanest way of measuring it is looking at the number of—if you're considering two countries, like the U.K. or the U.S.—how many Britons live in the U.S. versus how many Americans live in the U.K.",
      "section_level": 1,
      "section_title": "Migration and Future Advantages in Growth Terms for the U.S. Economy"
    },
    {
      "index_sentences": "I think that's the thing that ultimately matters. If you're a company that is in the EU that wants to grow quickly and needs to get a lot of capital, you just can't get it.",
      "section_level": 1,
      "section_title": "Innovation in the EU and its Downfalls"
    },
    {
      "index_sentences": "Oh yeah, when I mentioned balkanization, language is one of the big factors too.",
      "section_level": 1,
      "section_title": "Cultural Aspects Driving Divergence Between the U.S. and Europe"
    },
    {
      "index_sentences": "Some of this is just like a cultural storytelling to yourself or maybe a realization that markets deliver excess returns or something.",
      "section_level": 1,
      "section_title": "Sociological Part of the Story and the Motivation of Individuals"
    },
    {
      "index_sentences": "Totally agree with you. I mean, in the Netherlands, as long as the sun was shining—okay, the pitch darkness during winter, that’s a whole different thing—but just kidding.",
      "section_level": 1,
      "section_title": "Japan and the EU"
    },
    {
      "index_sentences": "Absolutely. I mean, what about the question of does what the customers expect or what the people think the customers will want come into it as well?",
      "section_level": 1,
      "section_title": "Greece’s Debt-to-GDP Ratio"
    },
    {
      "index_sentences": "Good excellent okay our next big topic AI and jobs, which yes, I believe you actually covered this.",
      "section_level": 1,
      "section_title": "AI and Jobs: Adoption Rate and Human Decision-Maker Friction"
    },
    {
      "index_sentences": "So let me tell you something that struck me recently as you know, an entrepreneur that's actually working in this space.",
      "section_level": 1,
      "section_title": "Principal-Agent Problem in AI Deployment"
    },
    {
      "index_sentences": "Yeah, it's super interesting. I think the way you outlined it was theoretically really interesting because there's a kind of principal-agent problem, isn't there?",
      "section_level": 1,
      "section_title": "Deployment of AI"
    },
    {
      "index_sentences": "I told you, just to give you an anecdote, we were talking to the guy who owns the entire customer support function for one of the major food delivery functions—I don't want to say the name of the actual company, but you know, Uber Eats, DoorDash, that kind of thing.",
      "section_level": 1,
      "section_title": "Consumer Adoption vs. Business Productivity"
    },
    {
      "index_sentences": "So I feel like people who theorize about the deployment of AI in the economy just don’t have a granular picture of what it really looks like to the guy trying to sell the system to you.",
      "section_level": 1,
      "section_title": "Slowdown in Productivity Growth at the Business Level"
    },
    {
      "index_sentences": "The stuff that I’ve written about has definitely been on the more bearish side of things.",
      "section_level": 1,
      "section_title": "OECD Data"
    },
    {
      "index_sentences": "It’s seen a higher increase when you weight by employment.",
      "section_level": 1,
      "section_title": "Higher Increase"
    },
    {
      "index_sentences": "The big companies that have more staff are more likely to take on AI.",
      "section_level": 1,
      "section_title": "Weight By Employment"
    },
    {
      "index_sentences": "Even I have been surprised by how slow it’s been, and it’s a bit like the Russia-Ukraine thing where what happened in March 2023 when GPT-4 came out was like people would say adoption is going to be slow but just wait until 2024 and then it’s really going to take off.",
      "section_level": 1,
      "section_title": "Impact on Jobs"
    },
    {
      "index_sentences": "Of course, you know—I mean this is even before going to the question of like is there an impact on jobs, is there an impact on productivity growth?",
      "section_level": 1,
      "section_title": "Technology Diffusion"
    },
    {
      "index_sentences": "People don’t want to think AI is going to be like that, but my experience is that it’s not going to be that long, but it is longer than people expect.",
      "section_level": 1,
      "section_title": "Complexities of Firms Adopting Technology"
    },
    {
      "index_sentences": "I really like your characterization of okay in our daily lives if we see something that’s good, we adopt it right away.",
      "section_level": 1,
      "section_title": "Diffusion"
    },
    {
      "index_sentences": "But in a company setting, you typically have more of a principal-agent problem or a kind of bigger organizational problem in trying to deploy something.",
      "section_level": 1,
      "section_title": "GPT Model"
    },
    {
      "index_sentences": "Eventually, because you've kind of got two variables, kind of axes, and on one axis is the complexity of the technology, which I would think compared to something like the tractor on a farm or electricity or the factory system, a sort of GPT model doesn’t strike me as—you don’t have to make that many changes to adopt it in some way.",
      "section_level": 1,
      "section_title": "Headset and Incoming Calls"
    },
    {
      "index_sentences": "Yeah, I think definitely the complexity of the firm because the number of people have to get their heads around it and agree to it.",
      "section_level": 1,
      "section_title": "Plugging in the AI"
    },
    {
      "index_sentences": "One interesting thing is like the call center business is very good because it’s a little bit like you said.",
      "section_level": 1,
      "section_title": "Customer Acceptance"
    },
    {
      "index_sentences": "I guess that means that, again thinking out loud here, if you're bullish on AI, then what you’re reliant on to a degree is the flow of new companies coming onto the market?",
      "section_level": 1,
      "section_title": "Entrepreneurship"
    },
    {
      "index_sentences": "In fast food, we actually operate in the space.",
      "section_level": 1,
      "section_title": "Uncertainty"
    },
    {
      "index_sentences": "Absolutely! It’s uncertainty, right?",
      "section_level": 1,
      "section_title": "Magnificent Seven and Loss Aversion"
    },
    {
      "index_sentences": "I think this also gets to, and this is quite speculative as well, but I think there’s been this shift in the West, and you can see this in some parts of the data, where people are much more interested in avoiding big losses than in making big gains—loss aversion.",
      "section_level": 1,
      "section_title": "Investors"
    },
    {
      "index_sentences": "You know, I’m right in the trenches on this because I’m one of the guys who’s trying to generate the revenue that on the back end—at least before DeepSeek came along, that back-end revenue would go back to OpenAI or whatever.",
      "section_level": 1,
      "section_title": "AI Spending"
    },
    {
      "index_sentences": "Is it because eventually there’s so much utility generated by AI that the earnings of the Magnificent Seven—you know, Microsoft starts making tons of money because Taco Bell is using their AI on the back end and all these agents are replacing people and stuff.",
      "section_level": 1,
      "section_title": "Microsoft Business"
    },
    {
      "index_sentences": "But I don’t know. I mean, as you say, the market is still expecting massive revenue growth at these companies over four years and years and years.",
      "section_level": 1,
      "section_title": "Replacing Human Labor"
    },
    {
      "index_sentences": "But yeah, that's interesting. One of the interesting things is like the call center business is very good because it’s a little bit like you said.",
      "section_level": 1,
      "section_title": "Revenue"
    },
    {
      "index_sentences": "Yes, I mean, there is that sort of joke about, \"Hey, either person one gets notes and asks to turn it into a PowerPoint presentation, or person two takes a PowerPoint presentation and asks us to turn it into notes.\"",
      "section_level": 1,
      "section_title": "AI Content"
    },
    {
      "index_sentences": "But in a company setting, you typically have more of a principal-agent problem or a kind of bigger organizational problem in trying to deploy something.",
      "section_level": 1,
      "section_title": "Junior People at Ordinary Firms"
    },
    {
      "index_sentences": "There is this kind of thing that you get that is explored again by some historians and I think may also apply to AI, which is this idea that it’s sort of a bad thing for productivity when the costs of producing content go down a lot.",
      "section_level": 1,
      "section_title": "Slop Answers"
    },
    {
      "index_sentences": "I will tell you a story which you might enjoy that was a shocking experience to me.",
      "section_level": 1,
      "section_title": "Research"
    },
    {
      "index_sentences": "You know, she’s really not saying very much, is she?",
      "section_level": 1,
      "section_title": "Superficial Answer"
    },
    {
      "index_sentences": "Another startup that I’m involved in, which is in genomics and it uses AI but a different kind of AI than Gen AI.",
      "section_level": 1,
      "section_title": "Senior Person"
    },
    {
      "index_sentences": "The insights you can get from that, I think the value of kind of taste, I suppose, will go up quite a lot when there’s so much consensus information that’s so easy to find.",
      "section_level": 1,
    ...
    },
    {
      "index_sentences": "Another startup that I’m involved in, which is in genomics and it uses AI but a different kind of AI than Gen AI.",
      "section_level": 1,
      "section_title": "Paul Graham Argument"
    },
    {
      "index_sentences": "What’s something interesting I think that you and I talked about last time we saw each other?",
      "section_level": 1,
      "section_title": "Stagnation and Productivity Growth: Tyler Cowen's Perspective"
    },
    {
      "index_sentences": "Well, my personal view would be that Tyler is way too bullish on AI, but that’s sort of one thing.",
      "section_level": 1,
      "section_title": "Atoms vs. Bits"
    },
    {
      "index_sentences": "It was interesting because, you know, when PCTO was on Joe Rogan’s podcast a few months ago, I think Rogan put to him what I think is the typical objection to his ideas, which is like, \"Aren’t we surrounded by amazing technology all the time?\"",
      "section_level": 1,
      "section_title": "Average Trip"
    },
    {
      "index_sentences": "My view on this is that the basic observations about average velocities of travel have not changed, and the time taken to put up a building has increased a lot.",
      "section_level": 1,
      "section_title": "Physics Limitations"
    },
    {
      "index_sentences": "That’s integral to like, \"Wow, this AI thing is passing the Turing test!\" right?",
      "section_level": 1,
      "section_title": "Semiconductor Physics"
    },
    {
      "index_sentences": "I guess my only counter to that I suppose would be to say that I think the regulatory system in which technology operates is as important as the tech itself in a sort of all else equal sense.",
      "section_level": 1,
      "section_title": "Regulatory System and Nuclear Energy"
    },
    {
      "index_sentences": "I think one of the big stories which I think people are slowly coming around to because of the big data centers' power story is we basically left this whole nuclear thing on the table.",
      "section_level": 1,
      "section_title": "Space Ships"
    },
    {
      "index_sentences": "Yeah, so Callum, it’s been great chatting with you. You know, maybe we could do a regular series where we just come in, and you enlighten us on specifically economic topics.",
      "section_level": 1,
